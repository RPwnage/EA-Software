...
define([
    ...
    function executeWhenClientObjectInitialized(clientObjectWrapper) {
        ...
        if (clientVoiceWrapper.clientObject) {
    ...
    return /** @lends module:Origin.module:client.module:voice */ {
        ...
        audioInputDevices: function() {
            return clientVoiceWrapper.propertyFromOriginClient('audioInputDevices');
        },
        /**
        ...
        audioOutputDevices: function() {
            return clientVoiceWrapper.propertyFromOriginClient('audioOutputDevices');
        },
        /**
        ...
        selectedAudioInputDevice: function() {
            return clientVoiceWrapper.propertyFromOriginClient('selectedAudioInputDevice');
        },
        /**
        ...
        selectedAudioOutputDevice: function() {
            return clientVoiceWrapper.propertyFromOriginClient('selectedAudioOutputDevice');
        },
        /**
        ...
        networkQuality: function() {
            return clientVoiceWrapper.propertyFromOriginClient('networkQuality');
        },
        /**
         ...
         */
        isInVoice: function() {
            return clientVoiceWrapper.propertyFromOriginClient('isInVoice');
        }
    };
});