...
module.exports = function(grunt) {
    ...
    grunt.registerTask('buildJSConfigFile', [
        'merge-json',
        'createConfigModule'
    ]);
    ...
    grunt.registerTask('createConfigModule', 'Generates the JS constant file', function() {
        var config = configReader.readConfig({id:'jsconfig', filename:'tmp/jssdk-config.json'}),
