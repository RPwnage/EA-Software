...
(function() {
    ...
    var CONTEXT_NAMESPACE = 'game-tile-progress';

    function OriginGameProgressCtrl($scope, GamesDataFactory, UtilFactory) {
            //constants
            var MAX_PERCENT = 100,
                MAX_DEGREES = 360,
                COMPLETE_STR = UtilFactory.getLocalizedStr(COMPLETE_STR, CONTEXT_NAMESPACE, 'completeStr'),
                PLAYABLE_NOW_STR = UtilFactory.getLocalizedStr(PLAYABLE_NOW_STR, CONTEXT_NAMESPACE, 'playableNowStr'),
                PLAYABLE_AT_STR = UtilFactory.getLocalizedStr(PLAYABLE_AT_STR, CONTEXT_NAMESPACE, 'playableAtStr'),
                ERROR_RETRY_STR = UtilFactory.getLocalizedStr(ERROR_RETRY_STR, CONTEXT_NAMESPACE, 'errorRetryStr');
