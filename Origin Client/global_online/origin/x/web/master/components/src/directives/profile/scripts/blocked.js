(function () {
    ...
    */
    ...
    angular.module('origin-components')
        ...
        .directive('originProfileBlocked', function (ComponentsConfigFactory, NavigationFactory, ComponentsUrlsFactory) {
            ...
            return {
				...
				link: function(scope, element) {
					...
					scope.$element.on('click', '.blocked-link', function () {
					    NavigationFactory.externalUrl(ComponentsUrlsFactory.getUrl('accountPrivacySettings'), true);
					});				
				}
			};
