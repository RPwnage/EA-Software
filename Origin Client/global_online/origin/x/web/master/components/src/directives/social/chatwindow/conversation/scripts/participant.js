(function () {
    ...
    */
    function OriginSocialChatwindowConversationParticipantCtrl($scope, ConversationFactory, RosterDataFactory, SocialDataFactory, UtilFactory) {
        ...
        function onDestroy() {
            RosterDataFactory.events.off('socialPresenceChanged:' + $scope.participant, handlePresenceChange);
        ...
        $scope.$watch('participant', function(newValue, oldValue) {
            ...
            RosterDataFactory.events.on('socialPresenceChanged:' + $scope.participant, handlePresenceChange);
            checkIsUserAFriend();
            getParticipantUsername();
        });
