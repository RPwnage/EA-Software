...
(function() {
    ...
    function GamesContextActionsFactory(GamesDataFactory) {
        ...
        function initActions(offerId) {
            ...
            addAction(actions, 'showgamedetailscta', GamesDataFactory.showGameDetailsPageForOffer.bind(this, offerId));
            ...
            addAction(actions, 'gamepropertiescta', GamesDataFactory.modifyGameProperties.bind(this, offerId));
            addDivider();
        ...
        function initPrimaryActions(offerId) {
            ...
            addAction(ctaPrimaryActions, 'primarypreordercta', GamesDataFactory.buyNow.bind(this, offerId));
            addAction(ctaPrimaryActions, 'primarybuynowcta', GamesDataFactory.buyNow.bind(this, offerId));

            addAction(ctaPrimaryActions, 'getitwithorigincta', GamesDataFactory.getItWithOrigin.bind(this, offerId));
            ...
            addAction(ctaPrimaryActions, 'primarypausepreloadcta', Origin.client.games.pauseDownload.bind(this, offerId));
            addAction(ctaPrimaryActions, 'primaryresumepreloadcta', Origin.client.games.resumeDownload.bind(this, offerId));
            ...
            addAction(ctaPrimaryActions, 'primaryuninstallcta', Origin.client.games.uninstall.bind(this, offerId));

            addAction(ctaPrimaryActions, 'primaryphasedisplaycta', null);

            addAction(ctaPrimaryActions, 'moredetailscta', GamesDataFactory.showGameDetailsPageForOffer.bind(this, offerId));
        }
