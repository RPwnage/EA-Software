(function () {
    ...
    * The controller
    */
    function OriginSocialChatwindowConversationHistoryitemMonologueCtrl($scope, $window, $sce, RosterDataFactory, UserDataFactory, ConversationFactory, NavigationFactory, ComponentsLogFactory) {
