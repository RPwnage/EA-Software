...
(function() {
    ...
    function SettingsFactory(ObjectSerializerFactory, ArraySerializerFactory, ComponentsLogFactory, AuthFactory) {
        ...
        function handleAuthReadyError(error) {
            ComponentsLogFactory.error('SETTINGSFACTORY - authReady error:', error.message);
        }
     ...
     */
    function SettingsFactorySingleton(ObjectSerializerFactory, ArraySerializerFactory, ComponentsLogFactory, AuthFactory, SingletonRegistryFactory) {
