...
(function() {
    ...
    function originHomeDiscoveryTileConfigOgfriendsplaying(DiscoveryStoryFactory) {

        function originHomeDiscoveryTileConfigOgfriendsplayingLink(scope, element, attrs, parentCtrl) {
            var attributes = {
             priority: scope.priority,
             diminish: scope.diminish,
             limit: scope.limit
            };
            DiscoveryStoryFactory.updateAutoStoryTypeConfig(parentCtrl.bucketId(), 'HT_01', attributes);
        }
        ...
        return {
            ...
            link: originHomeDiscoveryTileConfigOgfriendsplayingLink
        };
    }
