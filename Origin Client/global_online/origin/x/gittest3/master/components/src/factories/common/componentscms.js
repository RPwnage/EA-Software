...
(function() {
    ...
    function ComponentsCMSFactory($http, ComponentsUrlsFactory, ComponentsLogFactory, UtilFactory) {
        ...
        function processEndPointData(feedType, sectionType, offerId, locale) {
        ...
        function retrieveStoryData(feedType, sectionType, offerId, locale) {
            return ComponentsUrlsFactory.getUrl('homeStory')
                .then(processEndPointData(feedType, sectionType, offerId, locale))
                .then(UtilFactory.getJsonFromUrl)
        ...
        return {
            ...
            retrieveRecommendedStoryData: function(selectedStory, locale) {
                return retrieveStoryData(selectedStory.feedType, 'actions', selectedStory.offerId, locale);
            }
        };
    }
