(function() {
    ...
    function SocialDataFactory($filter, DialogFactory) {
...
*/
        ...
        */
            ...
            Origin.groups.groupListByUserId(Origin.user.userPid()).then(function(groupsListArray) {
                ...
                function getInviteGroups() {
                    ...
                    function(error) {
                        ...
                        groupListLoaded = true;
                        myEvents.fire('socialGroupListLoadError');
                        Origin.log.exception(error, 'socialData - groupListByUserId');
                        console.log('SocialDataFactory: groupListByUserId error:', error);
                    }); 
                }
            }, 
        ...
        function onXmppPresenceChanged(newPresence) {
			updateGroupMemberPresence(newPresence);             
        }
     ...
     */
    function SocialDataFactorySingleton($filter, DialogFactory, UserDataFactory, AppCommFactory, SingletonRegistryFactory) {
