...
(function(){
    ...
    * The directive
    */
    function originStoreCarouselHeroCarousel(ComponentsConfigFactory, $compile, $timeout) {
        /**
        * The directive link
        */
        function originStoreCarouselHeroCarouselLink(scope, elem) {
            ...
            function initialize() {
                ...
                scope.carouselState.timers = elem.find('.origin-store-carousel-banner[goal-date]');
                scope.carouselState.hiddenSlides = elem.find('.origin-store-carousel-banner');
                scope.carouselState.hiddenSlides.find('.origin-store-carousel-banner-caption-wrapper').each(function(index, element) {
                    $(element).addClass(alignmentEnumeration[scope.alignment]);
                });
            ...
            function addSocialMedia() {
                var socialmedia = $compile('<origin-socialmedia></origin-socialmedia>')(scope);
     ...
     * @param {number} stationaryPeriod - The number of milliseconds to sit on a slide without changing to the next slide
     * @param {autoRotateEnumeration} autoRotate - boolean as to if auto rotation should be on or off.
