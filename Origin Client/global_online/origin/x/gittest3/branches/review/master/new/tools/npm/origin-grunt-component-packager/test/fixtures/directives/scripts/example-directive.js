...
(function() {
    ...
    function originHomeRecommendedActionTrialCtrl($scope, ClientDataFactory, GamesDataFactory, LocFactory, UtilFactory) {
        function onInitialEntitlementUpdateCompleted() {
            ...
            GamesDataFactory.getCatalogInfo([$scope.offerId])
                ...
                .catch(function(error) {
                    Origin.log.exception(error, 'origin-components - getCatalogInfo');
                });
        }
     ...
     * @param {ExpiredDateTime} expireddatetime the combined expired datetime
