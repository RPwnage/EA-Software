...
(function() {
    ...
    function CPPAppDialogFactory(DialogFactory, AppCommFactory) {
        ...
        */
        function handleDialogSystemReady() {
            ...
            Origin.client.dialogs.show({context:'cppappdialog:handleDialogSystemReady'});
        }
     ...
     */
    function CPPAppDialogFactorySingleton(DialogFactory, AppCommFactory, SingletonRegistryFactory) {
        return SingletonRegistryFactory.get('CPPAppDialogFactory', CPPAppDialogFactory, this, arguments);
    }
    /**
     * @ngdoc service
     ...
     *
     */
    angular.module('originApp').factory('CPPAppDialogFactory', CPPAppDialogFactorySingleton);
