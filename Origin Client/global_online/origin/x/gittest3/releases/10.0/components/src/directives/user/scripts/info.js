...
(function() {
    ...
    function OriginUserInfoCtrl($scope, $timeout, RosterDataFactory, UtilFactory) {
        $scope.originId = '';
        ...
        this.getUserInfo = function() {
            var friendInfo = RosterDataFactory.getFriendInfo($scope.nucleusId);
            $scope.originId = friendInfo.originId;
            $scope.isPlayingGame = !!friendInfo.presence.gameActivity;
