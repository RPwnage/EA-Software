How to run jssdk API test using mockup data
  ...
  3. >bower install
  4. >grunt
  5. >grunt start-mockup functional-test terminate-mockup --force
  ...
  1. Initialize jssdk with override URL, ex.
    var config = {
        ...
        overrideUrls : {
            ...
            baseGameEntitlements : 'http://127.0.0.1:1400/data/{userId}/entitlements?',
            catalogInfo : 'http://127.0.0.1:1400/data/offer/{productId}/{locale}?',
            extraContentEntitlements : 'http://127.0.0.1:1400/data/{userId}/masterTitleId/{masterTitleId}?',
