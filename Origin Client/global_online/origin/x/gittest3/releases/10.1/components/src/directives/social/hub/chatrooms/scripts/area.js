        ...
        .directive('originSocialHubChatroomsArea', function (ComponentsConfigFactory) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    // Filter
                    $(element).on('keyup', '.origin-social-hub-chatrooms-area-filter-group-input', function () {
                        var text = $(element).find('.origin-social-hub-chatrooms-area-filter-group-input').val();
