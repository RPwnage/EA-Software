...
(function() {
    ...
    function SettingsFactory(ObjectSerializerFactory, ArraySerializerFactory, ComponentsLogFactory) {
        ...
        Origin.events.on(Origin.events.AUTH_SUCCESSRETRY, readSettingsFromServer);
        Origin.events.on(Origin.events.AUTH_LOGGEDOUT, clearCache);
        ...
        return {
             ...
             * @param {string[]} list an array of hidden offerIds
             */
            updateHiddenGames: updateCategory('HIDDENGAMES'),
            /**
             * gets the hidden games settings
     ...
     */
    function SettingsFactorySingleton(ObjectSerializerFactory, ArraySerializerFactory, ComponentsLogFactory, SingletonRegistryFactory) {
