...
(function() {
     ...
     * @param {object} modelObject parent scope object that will hold the filter's state.
     * @param {string} modelFieldName property of the model object to bind the filter string to.
     ...
     * @param {function} onChange function to call when the filter string has changed
     * @description
     *
     * Input field for filtering by a text string
     *
     *
     * @example
