    ...
    $.fn.originUxElements = function( options ) {
        ...
        var methods = {
            ...
            init : function() {
				...
				$(".origin-ux-tooltip a").on("mouseover.originUxElements", methods.events.uxTooltipMouseOver );
				$(".origin-ux-tooltip a").on("mouseout.originUxElements", methods.events.uxTooltipMouseOut );
				$(".origin-ux-tooltip span").on("mouseover.originUxElements", methods.events.uxTooltipContentMouseOver );
				$(".origin-ux-tooltip span").on("mouseout.originUxElements", methods.events.uxTooltipContentMouseOut );
				$(".origin-ux-tooltip span").on("mousewheel.originUxElements", methods.events.uxTooltipContentMouseWheel );
            ...
            events : {
                ...
                uxTooltipMouseOut : function ( event ) {
		    		event.preventDefault();	
		    		var $this = $(this);
				...
				uxTooltipMouseOver : function ( event ) {
		    		event.preventDefault();	
		    		clearInterval(settings.timeoutId);
		    		$(this).siblings("span").show();				
				},
				
				uxTooltipContentMouseOut : function ( event ) {
		    		event.preventDefault();	
		    		var $this = $(this);
		    		settings.timeoutId = setTimeout(function () {
			           $this.hide();
				...
				uxTooltipContentMouseWheel : function ( event ) {
		    		$(this).hide();
				},
				
				uxTooltipContentMouseOver : function ( event ) {
		    		event.preventDefault();	
		    		clearInterval(settings.timeoutId);
		    		$(this).show();				
				}
