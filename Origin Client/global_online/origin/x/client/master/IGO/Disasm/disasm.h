...
#pragma warning(disable: 4214 4115 4245 4201 4324)
...
/* ORIGIN ADDITIONS */
typedef void(*disasmLogInfo)(const char* file, int line, int alwaysLogMessage, const char* fmt, va_list arglist);
typedef void(*disasmLogError)(const char* file, int line, const char* fmt, va_list arglist);
