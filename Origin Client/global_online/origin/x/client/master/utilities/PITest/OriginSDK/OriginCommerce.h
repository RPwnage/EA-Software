...
/// \sa XShowMarketplaceUI(DWORD dwUserIndex, DWORD dwEntryPoint, ULONGLONG qwOfferID, DWORD dwContentCategories);
OriginErrorT ORIGIN_SDK_API OriginShowStoreUI(OriginUserT user, const OriginCharT *pCategoryList[], OriginSizeT categoryCount, const OriginCharT *pOfferList[], OriginSizeT offerCount);
...
///	\param[in] offerCount A count of offer identifiers (0=dont filter).
/// \sa XShowMarketplaceUI(DWORD dwUserIndex, DWORD dwEntryPoint, ULONGLONG qwOfferID, DWORD dwContentCategories);
OriginErrorT ORIGIN_SDK_API OriginShowStoreUIEX(OriginUserT user, const OriginCharT *pCategoryList[], OriginSizeT categoryCount, const OriginCharT *pMasterTitleIdList[], OriginSizeT MasterTitleIdCount, const OriginCharT *pOfferList[], OriginSizeT offerCount);

/// \ingroup ecommerce
/// \brief Shows the Code Redemption UI.
///
...
///	\param[in] user The local user.
/// \sa XShowTokenRedemptionUI(DWORD dwUserIndex)
OriginErrorT ORIGIN_SDK_API OriginShowCodeRedemptionUI(OriginUserT user);
...
/// \ingroup ecommerce
/// \brief Shows the lockbox checkout UI.
///
...
OriginErrorT ORIGIN_SDK_API OriginShowCheckoutUI(OriginUserT user, const OriginCharT *pOfferList[], OriginSizeT offerCount);
