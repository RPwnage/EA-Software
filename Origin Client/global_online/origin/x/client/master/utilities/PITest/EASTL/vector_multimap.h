///////////////////////////////////////////////////////////////////////////////
// EASTL/vector_multimap.h
//
// Copyright (c) 2005, Electronic Arts. All rights reserved.
// Written by Colin Andrews, updated for EASTL Paul Pedriana.
//////////////////////////////////////////////////////////////////////////////
...
namespace eastl
{
    ...
    public:
        ...
        vector_multimap(const vector_multimap& x);
        ...
        vector_multimap& operator=(const vector_multimap& x);
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline vector_multimap<K, T, C, A, RAC>::vector_multimap(const vector_multimap& x)
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline vector_multimap<K, T, C, A, RAC>&
    vector_multimap<K, T, C, A, RAC>::operator=(const vector_multimap& x)
    {
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline eastl::pair<typename vector_multimap<K, T, C, A, RAC>::iterator, bool>
    ...
    vector_multimap<K, T, C, A, RAC>::insert(iterator position, const value_type& value)
    {
        ...
        // In this case we have an incorrect position.
        // We fall back to the regular insert function.
        const eastl::pair<typename vector_multimap<K, T, C, A, RAC>::iterator, bool> result = insert(value);
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline typename vector_multimap<K, T, C, A, RAC>::iterator
    vector_multimap<K, T, C, A, RAC>::erase(iterator position)           
    {
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline typename vector_multimap<K, T, C, A, RAC>::iterator
    vector_multimap<K, T, C, A, RAC>::erase(iterator first, iterator last)
    {
    ...
    vector_multimap<K, T, C, A, RAC>::erase(reverse_iterator position)           
    {
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline typename vector_multimap<K, T, C, A, RAC>::reverse_iterator
    vector_multimap<K, T, C, A, RAC>::erase(reverse_iterator first, reverse_iterator last)
    {
