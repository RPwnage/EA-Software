...
namespace eastl
{
    ...
    public:
        ...
        void splice_after(iterator position, iterator previous);
    ...
    protected:
        ...
        template <typename InputIterator>
        void DoInsert(SListNodeBase* pNode, InputIterator first, InputIterator last);

        template <typename Integer>
        void DoInsert(SListNodeBase* pNode, Integer n, Integer value, true_type);

        template <typename InputIterator>
        void DoInsert(SListNodeBase* pNode, InputIterator first, InputIterator last, false_type);

        node_type* DoInsertValue(SListNodeBase* pNode);
        node_type* DoInsertValue(SListNodeBase* pNode, const value_type& value);
        void       DoInsertValues(SListNodeBase* pNode, size_type n, const value_type& value);
    ...
    SListBase<T, Allocator>::get_allocator()
    {
        return mAllocator;
    }
    ...
    inline slist<T, Allocator>::slist(size_type n, const allocator_type& allocator)
        : base_type(allocator)
    {
        DoInsertValues((SListNodeBase*)&mNode, n, value_type());
    }
    ...
    inline slist<T, Allocator>::slist(size_type n, const value_type& value, const allocator_type& allocator)
        : base_type(allocator)
    {
        DoInsertValues((SListNodeBase*)&mNode, n, value);
    }
    ...
    {
        //DoInsert(&mNode, const_iterator(static_cast<node_type*>(x.mNode.mpNext)), const_iterator(static_cast<node_type*>(NULL)), false_type());
        DoInsert((SListNodeBase*)&mNode, const_iterator((SListNodeBase*)x.mNode.mpNext), const_iterator(NULL), false_type());
    }
    ...
    {
        DoInsert((SListNodeBase*)&mNode, first, last);
    }
    ...
    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::iterator
    slist<T, Allocator>::before_begin()
    {
    ...
    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::const_iterator
    slist<T, Allocator>::before_begin() const
    {
    ...
    typename slist<T, Allocator>::this_type& slist<T, Allocator>::operator=(const this_type& x)
    {
        if(&x != this)
        {
            ...
            SListNodeBase*   pNodePrev = (SListNodeBase*)&mNode;
            node_type*       pNode     = static_cast<node_type*>(mNode.mpNext);
            const node_type* pNodeSrc  = static_cast<const node_type*>(x.mNode.mpNext);

            while(pNode && pNodeSrc)
            {
                pNode->mValue = pNodeSrc->mValue;
                pNodePrev     = (SListNodeBase*)pNode;
                pNode         = static_cast<node_type*>(pNode->mpNext);
                pNodeSrc      = static_cast<const node_type*>(pNodeSrc->mpNext);
            }

            if(pNodeSrc) // If there is any more to copy...
                DoInsert(pNodePrev, const_iterator((SListNodeBase*)pNodeSrc), const_iterator(NULL), false_type());
            else
    ...
    template <typename T, typename Allocator>
    inline bool slist<T, Allocator>::empty() const
    {
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::clear()
    {
        DoEraseAfter((SListNodeBase*)&mNode, NULL);
    }
        ...
        template <typename T, typename Allocator>
        inline void slist<T, Allocator>::reset()
        {
            reset_lose_memory();
        }
    #endif
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::reset_lose_memory()
    {
    ...
    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::iterator
    slist<T, Allocator>::insert(iterator position)
    {
        return iterator((SListNodeBase*)DoInsertValue(SListNodeGetPrevious((SListNodeBase*)&mNode, (SListNodeBase*)position.mpNode), value_type()));
    }


    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::iterator
    slist<T, Allocator>::insert(iterator position, const value_type& value)
    {
        return iterator((SListNodeBase*)DoInsertValue(SListNodeGetPrevious((SListNodeBase*)&mNode, (SListNodeBase*)position.mpNode), value));
    }


    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::insert(iterator position, size_type n, const value_type& value)
    {
        // To do: get rid of DoAssignValues and put its implementation directly here.
        DoInsertValues(SListNodeGetPrevious((SListNodeBase*)&mNode, (SListNodeBase*)position.mpNode), n, value);
    }


    template <typename T, typename Allocator>
    template <typename InputIterator>
    inline void slist<T, Allocator>::insert(iterator position, InputIterator first, InputIterator last)
    {
        DoInsert(SListNodeGetPrevious((SListNodeBase*)&mNode, (SListNodeBase*)position.mpNode), first, last);
    }


    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::iterator
    slist<T, Allocator>::insert_after(iterator position)
    {
    ...
    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::iterator
    slist<T, Allocator>::insert_after(iterator position, const value_type& value)
    {
        return iterator((SListNodeBase*)DoInsertValue((SListNodeBase*)position.mpNode, value));
    }


    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::insert_after(iterator position, size_type n, const value_type& value)
    {
        DoInsertValues((SListNodeBase*)position.mpNode, n, value);
    }


    template <typename T, typename Allocator>
    template <typename InputIterator>
    inline void slist<T, Allocator>::insert_after(iterator position, InputIterator first, InputIterator last)
    {
        DoInsert((SListNodeBase*)position.mpNode, first, last);
    }
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::splice(iterator position, this_type& x)
    {
        if(x.mNode.mpNext)
        {
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::splice(iterator position, this_type& x, iterator i)
    {
        SListNodeSpliceAfter(SListNodeGetPrevious((SListNodeBase*)&mNode, (SListNodeBase*)position.mpNode), 
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::splice(iterator position, this_type& x, iterator first, iterator last)
    {
        if(first != last)
        {
            #if EASTL_SLIST_SIZE_CACHE
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::splice_after(iterator position, iterator before_first, iterator before_last)
    {
        if(before_first != before_last)
        {
                ...
                if(i == iEnd) // If the input came from an external range...
                    mSize += (size_type)eastl::distance(before_first, before_last);
            #endif
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::splice_after(iterator position, iterator previous)
    {
        #if EASTL_SLIST_SIZE_CACHE
            // We have a problem here because the inserted range may come from *this or 
            // it may come from some other list. We have no choice but to implement an O(n)
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::splice_after(iterator position, this_type& x)
    {
    ...
    template <typename T, typename Allocator>
    inline void slist<T, Allocator>::reverse()
    {
        if(mNode.mpNext)
    ...
    void slist<T, Allocator>::DoAssign(InputIterator first, InputIterator last, false_type)
    {
        ...
        if(first == last)
            ...
            DoInsert((SListNodeBase*)pNodePrev, first, last);
    }
    ...
    void slist<T, Allocator>::DoAssignValues(size_type n, const value_type& value)
    {
        ...
        if(n)
            DoInsertValues((SListNodeBase*)pNodePrev, n, value);
        else
            DoEraseAfter((SListNodeBase*)pNodePrev, NULL);
    }
    ...
    template <typename T, typename Allocator>
    template <typename InputIterator>
    void slist<T, Allocator>::DoInsert(SListNodeBase* pNode, InputIterator first, InputIterator last)
    {
        DoInsert(pNode, first, last, is_integral<InputIterator>());
    }


    template <typename T, typename Allocator>
    template <typename Integer>
    void slist<T, Allocator>::DoInsert(SListNodeBase* pNode, Integer n, Integer value, true_type)
    {
        DoInsertValues(pNode, n, value);
    }
    ...
    template <typename T, typename Allocator>
    template <typename InputIterator>
    void slist<T, Allocator>::DoInsert(SListNodeBase* pNode, InputIterator first, InputIterator last, false_type)
    {
    ...
    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::node_type*
    slist<T, Allocator>::DoInsertValue(SListNodeBase* pNode)
    {
        #if EASTL_SLIST_SIZE_CACHE
    ...
    template <typename T, typename Allocator>
    inline typename slist<T, Allocator>::node_type*
    slist<T, Allocator>::DoInsertValue(SListNodeBase* pNode, const value_type& value)
    {
        #if EASTL_SLIST_SIZE_CACHE
            ...
            return static_cast<node_type*>((base_node_type*)pNode);
        #else
            return static_cast<node_type*>((base_node_type*)SListNodeInsertAfter((SListNodeBase*)pNode, (SListNodeBase*)DoCreateNode(value)));
        #endif
    }


    template <typename T, typename Allocator>
    void slist<T, Allocator>::DoInsertValues(SListNodeBase* pNode, size_type n, const value_type& value)
    {
