...
///////////////////////////////////////////////////////////////////////////////
    ...
    #define EASTL_VERSION   "1.15.04"
    #define EASTL_VERSION_N  11504
#endif
...
///////////////////////////////////////////////////////////////////////////////
        ...
        #include <libdbg.h>
        #define EASTL_DEBUG_BREAK() SCE_BREAK()
    #elif defined(__SNC__)
        #define EASTL_DEBUG_BREAK() __builtin_snpause()
        ...
        #define EASTL_DEBUG_BREAK() spu_stop(STOP_BREAK)
    #elif defined(EA_PLATFORM_REVOLUTION)
        #include <revolution/os.h>
        #define EASTL_DEBUG_BREAK() OSHalt("EA_DEBUG_BREAK")
    #elif defined(EA_PLATFORM_CTR)
        #include <nn/dbg.h>
        #define EASTL_DEBUG_BREAK() ::nn::dbg::Break(::nn::dbg::BREAK_REASON_ASSERT)
...
//
        ...
        #endif
    #elif defined(EA_PLATFORM_PS3_SPU)
        #define EASTL_BITSET_WORD_TYPE_DEFAULT uint64_t     // Match the PS3 PPU word size, as users may want to DMA between the two CPUs, and 8 is efficient on SPU.
        #define EASTL_BITSET_WORD_SIZE_DEFAULT 8
...
//    value_type value;
//
#if defined(__GNUC__) && (((__GNUC__ * 100) + __GNUC_MINOR__) >= 303) && !defined(EA_PLATFORM_PSP) && !defined(EA_COMPILER_RVCT)
...
//
    ...
    #if defined(_MSC_VER) && (_MSC_VER >= 1500) && !defined(EA_PLATFORM_AIRPLAY) // VS2008 or later, and not Airplay, which pretends it's VC++ when it's not.
        #pragma warning(push, 0)
            #include <yvals.h>
        #pragma warning(pop)
