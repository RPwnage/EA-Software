...
namespace eastl
{
    ...
    public:
        ...
        vector_multiset(const vector_multiset& x);
        ...
        vector_multiset& operator=(const vector_multiset& x);
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline vector_multiset<K, C, A, RAC>::vector_multiset(const vector_multiset& x)
    ...
    vector_multiset<K, C, A, RAC>::operator=(const vector_multiset& x)
    {
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline eastl::pair<typename vector_multiset<K, C, A, RAC>::iterator, bool>
    ...
    vector_multiset<K, C, A, RAC>::insert(iterator position, const value_type& value)
    {
        ...
        const eastl::pair<typename vector_multiset<K, C, A, RAC>::iterator, bool> result = insert(value);
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline typename vector_multiset<K, C, A, RAC>::iterator 
    vector_multiset<K, C, A, RAC>::erase(iterator position)
    {
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline typename vector_multiset<K, C, A, RAC>::iterator
    vector_multiset<K, C, A, RAC>::erase(iterator first, iterator last)
    {
    ...
    vector_multiset<K, C, A, RAC>::erase(reverse_iterator position)
    {
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline typename vector_multiset<K, C, A, RAC>::reverse_iterator
    vector_multiset<K, C, A, RAC>::erase(reverse_iterator first, reverse_iterator last)
    {
