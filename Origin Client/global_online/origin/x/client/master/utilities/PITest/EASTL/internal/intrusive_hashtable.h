///////////////////////////////////////////////////////////////////////////////
// EASTL/internal/intrusive_hashtable.h
//
...
namespace eastl
{
    ...
    public:
        ...
        size_type bucket_count() const // This function is unnecessary, as the user can directly reference
    ...
    template <typename K, typename V, typename H, typename Eq, size_t bC, bool bM, bool bU>
    typename intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::iterator
    intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::erase(iterator i)
    {
        iterator iNext(i);
        ++iNext;
    ...
    template <typename K, typename V, typename H, typename Eq, size_t bC, bool bM, bool bU>
    inline typename intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::iterator
    intrusive_hashtable<K, V, H, Eq, bC, bM, bU>::erase(iterator first, iterator last)
    {
        while(first != last)
            first = erase(first);
        return first;
