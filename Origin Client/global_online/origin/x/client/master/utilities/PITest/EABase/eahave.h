...
/* EA_HAVE_XXX_FEATURE */
    ...
    #else
        #define EA_NO_HAVE_EXTENSIONS_FEATURE 1
    #endif
#endif
...
// Clang libc++
            ...
            #define EA_HAVE_LIBCPP_LIBRARY 1 // We could also check the value of _LIBCPP_VERSION
        #endif
    #endif 
...
// #include <unistd.h>
    ...
    #if defined(EA_PLATFORM_UNIX) || defined(EA_PLATFORM_PS3) || defined(EA_PLATFORM_AIRPLAY)
...
// #include <array>, <forward_list>, <ununordered_set>, <unordered_map>
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4004) // Actually GCC 4.3 supports array and unordered_
        #define EA_HAVE_CPP11_CONTAINERS 1
...
// #include <atomic>
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4007)
        #define EA_HAVE_CPP11_ATOMIC 1
    #elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
        #define EA_HAVE_CPP11_ATOMIC 1
    #else
...
// #include <future>
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4005)
        #define EA_HAVE_CPP11_FUTURE 1
    #elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
        #define EA_HAVE_CPP11_FUTURE 1
    #else
...
// #include <type_traits>
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4003)
        #define EA_HAVE_CPP11_TYPE_TRAITS 1
    #elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
        #define EA_HAVE_CPP11_TYPE_TRAITS 1
    #else
...
// #include <chrono> 
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4007) // chrono was broken in glibc prior to 4.7.
        #define EA_HAVE_CPP11_CHRONO 1
    #elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
        #define EA_HAVE_CPP11_CHRONO 1
    #else
...
// #include <initializer_list> 
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4004) && !defined(EA_COMPILER_NO_INITIALIZER_LISTS)
        #define EA_HAVE_CPP11_INITIALIZER_LIST 1
...
// #include <system_error> 
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4004)
        #define EA_HAVE_CPP11_SYSTEM_ERROR 1
    #elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
        #define EA_HAVE_CPP11_SYSTEM_ERROR 1
    #else
...
// #include <codecvt> 
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4008)
        #define EA_HAVE_CPP11_CODECVT 1
    #elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
        #define EA_HAVE_CPP11_CODECVT 1
    #else
...
// #include <typeindex> 
    ...
    #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(EA_HAVE_LIBSTDCPP_LIBRARY) && (EA_COMPILER_VERSION >= 4006)
        #define EA_HAVE_CPP11_TYPEINDEX 1
    #elif defined(EA_HAVE_LIBCPP_LIBRARY) && (_LIBCPP_VERSION >= 1)
        #define EA_HAVE_CPP11_TYPEINDEX 1
    #else
...
/* EA_HAVE_XXX_DECL */
        ...
        #define EA_HAVE_ISINF(x)  !finite(x)
    ...
    #if (defined(EA_PLATFORM_UNIX) && !defined(EA_PLATFORM_SONY)) || defined(EA_PLATFORM_PLAYBOOK) || defined(EA_PLATFORM_IPHONE) || defined(EA_PLATFORM_OSX) || defined(EA_PLATFORM_KETTLE)
    ...
    #if !defined(EA_PLATFORM_BADA) && !defined(__MINGW32__)
...
// <time.h> clock_gettime()
    ...
    #if defined(EA_PLATFORM_LINUX) || defined(__CYGWIN__) || (_POSIX_TIMERS > 0) || (defined(EA_PLATFORM_POSIX) && defined(_YVALS) /*Dinkumware*/)
...
// <cstddef> std::nullptr, nullptr_t, etc.
#if !defined(EA_HAVE_nullptr_IMPL) && !defined(EA_NO_HAVE_nullptr_IMPL)
    #if (defined(_MSC_VER) && (_MSC_VER >= 1600)) ||                    \
        (defined(EA_COMPILER_GNUC) && (EA_COMPILER_VERSION >= 4006)) || \
         defined(__clang__) ||                                          \
         defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 403) && defined(EA_COMPILER_CPP11_ENABLED)
