...
#if defined(__SNC__) && defined(EA_COMPILER_CPP11_ENABLED)
    // SNC's C++11 compiler supports nullptr, but doesn't implement a declaration for std::nullptr_t. So we provide one.
