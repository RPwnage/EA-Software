...
namespace eastl
{
    ...
    //
    ///////////////////////////////////////////////////////////////////////
    template <typename T> struct is_const_value                   { static const bool value = false; };
    template <typename T> struct is_const_value<const T*>         { static const bool value = true;  };
    template <typename T> struct is_const_value<const volatile T*>{ static const bool value = true;  };

    template <typename T> struct is_const : public integral_constant<bool, is_const_value<T*>::value>{};
    ...
    template <typename T> struct is_volatile_value                   { static const bool value = false; };
    template <typename T> struct is_volatile_value<volatile T*>      { static const bool value = true;  };
    template <typename T> struct is_volatile_value<const volatile T*>{ static const bool value = true;  };

    template <typename T> struct is_volatile : public integral_constant<bool, is_volatile_value<T*>::value>{};
