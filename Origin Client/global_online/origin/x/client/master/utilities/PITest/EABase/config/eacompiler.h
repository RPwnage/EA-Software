...
#define INCLUDED_eacompiler_H
    ...
    ///////////////////////////////////////////////////////////////////////////////
        ...
        #if defined(EA_COMPILER_GREEN_HILLS) || defined(__MWERKS__)
            #define EA_COMPILER_VA_COPY_REQUIRED 1
        #elif ((defined(__GNUC__) && (__GNUC__ >= 3)) || defined(__clang__)) && (!defined(__i386__) || defined(__x86_64__)) && !defined(__ppc__) && !defined(__PPC__) && !defined(__PPC64__)
            #define EA_COMPILER_VA_COPY_REQUIRED 1
        #endif
    #endif
    ...
    //      void  operator delete[](void*, const std::nothrow_t&) EA_THROW_SPEC_DELETE_NONE();
    //
    #if defined(EA_COMPILER_NO_EXCEPTIONS) && (!defined(__MWERKS__) || defined(_MSL_NO_THROW_SPECS)) && !defined(EA_COMPILER_RVCT) && !defined(EA_PLATFORM_LINUX)
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(_MSC_VER) && (_MSC_VER >= 1700)                 // VC++ >= VS2012...
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && (defined(_MSC_VER) && (EA_COMPILER_VERSION >= 1700))  // VC++ >= VS2012...
            // supported.
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(_MSC_VER) && (EA_COMPILER_VERSION >= 1400)  // VC++ >= VS2005, even without C++11 support.
            // supported.
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(_MSC_VER) && (EA_COMPILER_VERSION >= 1500)  // VC++ >= VS2008, even without C++11 support.
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(_MSC_VER) && (EA_COMPILER_VERSION >= 1600)     // VC++ >= VS2010
            // supported.
        #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 401) // EDG 4.1+.
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 401) // EDG 4.1+.
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(_MSC_VER) && (_MSC_FULL_VER == 170051025) && !defined(EA_PLATFORM_CONSOLE)       // VC++ >= VS2012, November Preview, for Windows (and not console).
            // supported.
        #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 403) // EDG 4.3+.
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(__clang__) && (EA_COMPILER_VERSION >= 401) && defined(__APPLE__)
            // supported.
        #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 402) // EDG 4.2+.
            // supported, though 4.1 has partial support for variadic templates.
    ...
    //
            ...
            // supported via __declspec(noreturn). You need to use that or EA_NORETURN.
        #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(__EDG_VERSION__) && (__EDG_VERSION__ >= 402) // EDG 4.2+.
            // supported.
        #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(__clang__) && (EA_COMPILER_VERSION >= 401) && defined(__APPLE__)
            // supported.
    ...
    //
        ...
        #if defined(EA_COMPILER_CPP11_ENABLED) && defined(__clang__) && EA_COMPILER_HAS_FEATURE(cxx_inheriting_constructors)
            // supported.
        #elif defined(EA_COMPILER_CPP11_ENABLED) && defined(__GNUC__) && (EA_COMPILER_VERSION >= 4008)   // GCC 4.8+
            // supported.
        #else
    ...
    //
        ...
        // VC++ up till at least VS2012 supports \u and \U but supports them wrong with respect to the C++11 Standard.
