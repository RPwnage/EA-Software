...
namespace eastl
{
    ...
    public:
        ...
        explicit vector_set(const key_compare& comp, const allocator_type& allocator = EASTL_VECTOR_SET_DEFAULT_ALLOCATOR);
        ...
        vector_set& operator=(const vector_set& x);
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline vector_set<K, C, A, RAC>::vector_set(const key_compare& comp, const allocator_type& allocator)
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline vector_set<K, C, A, RAC>::vector_set(const vector_set& x)
    ...
    vector_set<K, C, A, RAC>::operator=(const vector_set& x)
    {
    ...
    vector_set<K, C, A, RAC>::insert(iterator position, const value_type& value)
    {
        ...
        const eastl::pair<typename vector_set<K, C, A, RAC>::iterator, bool> result = insert(value);
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline typename vector_set<K, C, A, RAC>::iterator 
    vector_set<K, C, A, RAC>::erase(iterator position)
    {
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline typename vector_set<K, C, A, RAC>::iterator
    vector_set<K, C, A, RAC>::erase(iterator first, iterator last)
    {
    ...
    vector_set<K, C, A, RAC>::erase(reverse_iterator position)
    {
    ...
    template <typename K, typename C, typename A, typename RAC>
    inline typename vector_set<K, C, A, RAC>::reverse_iterator
    vector_set<K, C, A, RAC>::erase(reverse_iterator first, reverse_iterator last)
    {
