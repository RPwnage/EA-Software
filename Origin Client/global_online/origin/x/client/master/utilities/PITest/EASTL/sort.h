...
#if defined(__ghs__)            // Green Hills compiler
    #if defined(__ppc__)        // PowerPC processor
        #include <ppc/ppc.h>    // PowerPC intrinsics.
    #endif
#endif
...
namespace eastl
{
    ...
    namespace Internal
    {
        ...
        //
                    ...
                    // Disabled until we can verify that it exists:
                    //#define EASTL_COUNT_LEADING_ZEROES(x) (int)__CLZ64(x) // unsigned long long __CLZ64(unsigned long long a);
                #else
                    #define EASTL_COUNT_LEADING_ZEROES(x) (int)__CLZ32(x)   // unsigned int __CLZ32(unsigned int a);
                #endif
