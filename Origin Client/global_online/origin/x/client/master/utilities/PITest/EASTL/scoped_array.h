...
//
// This class implements a scoped_array template. This is a class which is 
// similar to the C++ scoped_ptr template, except that it works with arrays
// instead of individual objects.
//
// The design of this class is largely based on the design of the Boost
// scoped_array template. This design (along with Boost's shared_ptr) is also 
// being considered for the next C++ standard (as of 2003). The C++ standard
// update proposal is currently available at:
//     http://std.dkuug.dk/jtc1/sc22/wg21/docs/papers/2003/n1450.html
// Boost smart pointers, including scoped_array are documented at:
