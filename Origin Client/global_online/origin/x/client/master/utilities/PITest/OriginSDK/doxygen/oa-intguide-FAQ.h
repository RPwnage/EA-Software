...
/// 
/// <hr>
/// <b>Q:</b> How do I get my nucleus auth token?
/// 
/// <b>A:</b> Use \ref OriginRequestTicket or \ref OriginRequestTicketSync to get the users nucleus authentication token.
/// 
/// <hr>
/// 
