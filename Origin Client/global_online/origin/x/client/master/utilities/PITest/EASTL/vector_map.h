...
namespace eastl
{
    ...
    public:
        ...
        vector_map& operator=(const vector_map& x);
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline vector_map<K, T, C, A, RAC>::vector_map(const vector_map& x)
    ...
    vector_map<K, T, C, A, RAC>::operator=(const vector_map& x)
    {
    ...
    vector_map<K, T, C, A, RAC>::insert(iterator position, const value_type& value)
    {
    ...
    vector_map<K, T, C, A, RAC>::erase(iterator position)
    {
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline typename vector_map<K, T, C, A, RAC>::iterator
    vector_map<K, T, C, A, RAC>::erase(iterator first, iterator last)
    {
    ...
    vector_map<K, T, C, A, RAC>::erase(reverse_iterator position)
    {
    ...
    template <typename K, typename T, typename C, typename A, typename RAC>
    inline typename vector_map<K, T, C, A, RAC>::reverse_iterator
    vector_map<K, T, C, A, RAC>::erase(reverse_iterator first, reverse_iterator last)
    {
