...
#define INCLUDED_eacompilertraits_H
    ...
    #if defined(__SNC__) || defined(EA_PLATFORM_PS3) || defined(__S3E__) // S3E refers to the Airplay platform, which is a mobile middleware platform that uses a crippled version of GCC but also masquerades as VC++.
        #ifndef __STDC_LIMIT_MACROS
            #define __STDC_LIMIT_MACROS 1
        #endif
    ...
    //
        ...
        #if defined(_MSC_VER) && (_MSC_VER >= 1300)  && !defined(EA_PLATFORM_AIRPLAY) // If VC7.0 and later (including XBox, and XBox 360)...
