...
//{
	...
	public:
		...
		int		ClearStartingWith(const QString& sKeyPrefix);
		...
		bool	Get64BitInt(const QString& sKey, __int64& nValue) const;
		__int64 Get64BitInt(const QString& sKey) const;	// return 0 if no key was found
		bool	Set64BitInt(const QString& sKey, __int64 nValue);
