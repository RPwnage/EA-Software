...
public class JacksonJsonProviderWithString
        implements
        ...
        MessageBodyWriter<Object>
{
     ...
     */
    public JacksonJsonProviderWithString()
    {
        this(null);
    }
     ...
     * is to be used.
     */
    public JacksonJsonProviderWithString(ObjectMapper mapper)
    {
    ...
    protected ObjectMapper locateMapper(Class<?> type, MediaType mediaType)
    {
        ...
        // If not, maybe we can getInstance one configured via context?
