//
//  IGOSocialConversationViewController.h
//  originClient
//
...
#ifndef __originClient__IGOSocialConversationViewController__
#define __originClient__IGOSocialConversationViewController__
...
namespace Client
{
    ...
    class ORIGIN_PLUGIN_API IGOSocialConversationViewController : public QObject, public Origin::Engine::ISocialConversationViewController, public Origin::Engine::IASPViewController, public Origin::Engine::IIGOWindowManager::IScreenListener
    {
        Q_OBJECT
        
    public:
        IGOSocialConversationViewController();
        ~IGOSocialConversationViewController();
        
        // ISocialConversationViewController impl
...
#endif /* defined(__originClient__IGOSocialConversationViewController__) */
