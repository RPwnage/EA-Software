#ifndef _ONTHEHOUSEQUERYOPERATIONPROXY_H
#define _ONTHEHOUSEQUERYOPERATIONPROXY_H
...
class ORIGIN_PLUGIN_API OnTheHouseQueryOperationProxy : public QObject
{
    Q_OBJECT
public: 
    OnTheHouseQueryOperationProxy(QObject *parent);
    ~OnTheHouseQueryOperationProxy();
