...
class EADPGENERATED_API Player : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit Player(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    const ::eadp::foundation::String& getPlayerId() const;
    void setPlayerId(const ::eadp::foundation::String& value);
    void setPlayerId(const char8_t* value);
    /**@}*/
...
private:
    ...
    ::eadp::foundation::String m_playerId;
