 ...
 * Requests
 */
class EADPGENERATED_API ChatInitiateV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatInitiateV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    EADP_FOUNDATION_PROTOBUF_DEPRECATED_ATTR ::eadp::foundation::Vector< ::eadp::foundation::String>& getPersonaIds();
    EADP_FOUNDATION_PROTOBUF_DEPRECATED_ATTR void setPersonaIds(int index, const char8_t* value);
    EADP_FOUNDATION_PROTOBUF_DEPRECATED_ATTR void addPersonaIds(const char8_t* value);
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::String> m_personaIds;
