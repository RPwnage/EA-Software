...
class EADPGENERATED_API ChatTypingEventRequestErrorV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatTypingEventRequestErrorV1(const ::eadp::foundation::Allocator& allocator);
