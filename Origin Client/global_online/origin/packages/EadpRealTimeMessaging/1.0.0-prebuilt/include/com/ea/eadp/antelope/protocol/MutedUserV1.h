...
#include <com/ea/eadp/antelope/rtm/protocol/MutedByV1.h>
 ...
 * Mute List V1
 */
class EADPGENERATED_API MutedUserV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit MutedUserV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< com::ea::eadp::antelope::rtm::protocol::MutedByV1>& getMutedBy();
    /**@}*/

    /**@{
     */
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::Player> getPlayer();
    void setPlayer(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::Player>);
    bool hasPlayer();
    void releasePlayer();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< com::ea::eadp::antelope::rtm::protocol::MutedByV1> m_mutedBy;
    int32_t m_mutedBy__cachedByteSize;
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::Player> m_player;
