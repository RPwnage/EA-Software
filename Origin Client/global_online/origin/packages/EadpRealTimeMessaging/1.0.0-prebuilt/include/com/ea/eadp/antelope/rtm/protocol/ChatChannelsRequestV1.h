 ...
 */
class EADPGENERATED_API ChatChannelsRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatChannelsRequestV1(const ::eadp::foundation::Allocator& allocator);
     ...
     */
    bool getIncludeUnreadMessageCount() const;
    void setIncludeUnreadMessageCount(bool value);
    /**@}*/
...
private:
    ...
    bool m_includeUnreadMessageCount;
