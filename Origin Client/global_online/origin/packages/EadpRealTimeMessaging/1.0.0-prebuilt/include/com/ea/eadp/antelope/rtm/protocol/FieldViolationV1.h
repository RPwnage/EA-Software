...
class EADPGENERATED_API FieldViolationV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit FieldViolationV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    const ::eadp::foundation::String& getFieldName() const;
    void setFieldName(const ::eadp::foundation::String& value);
    void setFieldName(const char8_t* value);
    /**@}*/

    /**@{
     */
    const ::eadp::foundation::String& getViolationMessage() const;
    void setViolationMessage(const ::eadp::foundation::String& value);
    void setViolationMessage(const char8_t* value);
    /**@}*/
...
private:
    ...
    ::eadp::foundation::String m_fieldName;
    ::eadp::foundation::String m_violationMessage;
