...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace rtm { namespace protocol { class WorldChatShard;  } } } } } }
...
class EADPGENERATED_API WorldChatChannelsResponseV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit WorldChatChannelsResponseV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::WorldChatShard>>& getShard();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::WorldChatShard>> m_shard;
    int32_t m_totalShardCount;
