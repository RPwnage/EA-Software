...
class EADPGENERATED_API ChatDisconnectedV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatDisconnectedV1(const ::eadp::foundation::Allocator& allocator);
