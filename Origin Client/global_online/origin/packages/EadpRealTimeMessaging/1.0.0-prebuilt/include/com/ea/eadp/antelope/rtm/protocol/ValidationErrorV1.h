...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace rtm { namespace protocol { class FieldViolationV1;  } } } } } }
...
class EADPGENERATED_API ValidationErrorV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ValidationErrorV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::FieldViolationV1>>& getFieldViolation();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::FieldViolationV1>> m_fieldViolation;
