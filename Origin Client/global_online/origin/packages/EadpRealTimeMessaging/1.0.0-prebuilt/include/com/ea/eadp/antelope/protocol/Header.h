...
#include <com/ea/eadp/antelope/protocol/CommunicationType.h>
...
class EADPGENERATED_API Header : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit Header(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    com::ea::eadp::antelope::protocol::CommunicationType getType() const;
    void setType(com::ea::eadp::antelope::protocol::CommunicationType value);
    /**@}*/
