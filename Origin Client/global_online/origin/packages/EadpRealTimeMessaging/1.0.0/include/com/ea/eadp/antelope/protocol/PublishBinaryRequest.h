...
class EADPGENERATED_API PublishBinaryRequest : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit PublishBinaryRequest(const ::eadp::foundation::Allocator& allocator);
