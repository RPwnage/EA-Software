...
class EADPGENERATED_API GetPreferenceResponseV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit GetPreferenceResponseV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::TranslationPreferenceV1> getTranslationPreference();
    void setTranslationPreference(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::TranslationPreferenceV1>);
    bool hasTranslationPreference();
    void releaseTranslationPreference();
    /**@}*/
