...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace rtm { namespace protocol { class CommunicationV1;  } } } } } }
...
public:
    ...
    /**@{
     */
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::CommunicationV1> getV1();
    void setV1(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::CommunicationV1>);
    bool hasV1() const;
    void releaseV1();
    /**@}*/
...
private:
    ...
    union BodyUnion
    {
        ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::CommunicationV1> m_v1;
