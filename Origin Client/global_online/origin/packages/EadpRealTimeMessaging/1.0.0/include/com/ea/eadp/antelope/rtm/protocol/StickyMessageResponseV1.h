...
class EADPGENERATED_API StickyMessageResponseV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit StickyMessageResponseV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::StickyMessageV1>>& getMessage();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::StickyMessageV1>> m_message;
