...
class EADPGENERATED_API NotificationV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit NotificationV1(const ::eadp::foundation::Allocator& allocator);
