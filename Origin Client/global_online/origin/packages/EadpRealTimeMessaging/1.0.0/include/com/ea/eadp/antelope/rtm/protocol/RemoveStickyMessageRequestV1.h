...
class EADPGENERATED_API RemoveStickyMessageRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit RemoveStickyMessageRequestV1(const ::eadp::foundation::Allocator& allocator);
