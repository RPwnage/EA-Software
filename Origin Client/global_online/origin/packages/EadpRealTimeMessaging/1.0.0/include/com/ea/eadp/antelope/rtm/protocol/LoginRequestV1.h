...
class EADPGENERATED_API LoginRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit LoginRequestV1(const ::eadp::foundation::Allocator& allocator);
