...
class EADPGENERATED_API ChatMembersRequestErrorV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatMembersRequestErrorV1(const ::eadp::foundation::Allocator& allocator);
