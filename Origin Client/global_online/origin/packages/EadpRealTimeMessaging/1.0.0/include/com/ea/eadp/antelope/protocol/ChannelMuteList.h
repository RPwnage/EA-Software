...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace protocol { class MutedUser;  } } } } }
...
class EADPGENERATED_API ChannelMuteList : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChannelMuteList(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::MutedUser>>& getMutedUsers();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::MutedUser>> m_mutedUsers;
