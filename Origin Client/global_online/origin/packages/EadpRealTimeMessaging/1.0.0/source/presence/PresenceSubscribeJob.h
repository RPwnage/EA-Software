...
{
class PresenceSubscribeJob : public RTMCommunicationJob
{
public:
    PresenceSubscribeJob(eadp::foundation::IHub* hub,
        eadp::foundation::SharedPtr<Internal::RTMService> rtmService,
        const eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::PresenceSubscribeV1> request,
...
private:
    ...
    const eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::PresenceSubscribeV1> m_request;
};
}
}