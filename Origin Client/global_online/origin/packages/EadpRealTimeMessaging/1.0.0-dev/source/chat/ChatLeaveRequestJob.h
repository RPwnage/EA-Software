...
{
class ChatLeaveRequestJob : public RTMRequestJob
{
public:
    ChatLeaveRequestJob(eadp::foundation::IHub* hub,
        eadp::foundation::SharedPtr<Internal::RTMService> rtmService,
        const eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::ChatLeaveV1> chatLeaveRequest,
...
private:
    const eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::ChatLeaveV1> m_chatLeaveRequest;
