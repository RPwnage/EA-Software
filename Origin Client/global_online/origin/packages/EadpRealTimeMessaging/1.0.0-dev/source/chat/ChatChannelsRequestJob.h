...
{
class ChatChannelsRequestJob : public RTMRequestJob
{
public:
    ChatChannelsRequestJob(eadp::foundation::IHub* hub, eadp::foundation::SharedPtr<Internal::RTMService> rtmService, ChatService::ChatChannelsCallback channelsCallback);
...
private:
    ChatService::ChatChannelsCallback m_callback;
};
}
}
