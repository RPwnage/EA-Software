...
#include <com/ea/eadp/antelope/rtm/protocol/MessageType.h>
...
class EADPGENERATED_API PublishTextRequest : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit PublishTextRequest(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    com::ea::eadp::antelope::rtm::protocol::MessageType getMessageType() const;
    void setMessageType(com::ea::eadp::antelope::rtm::protocol::MessageType value);
    /**@}*/
