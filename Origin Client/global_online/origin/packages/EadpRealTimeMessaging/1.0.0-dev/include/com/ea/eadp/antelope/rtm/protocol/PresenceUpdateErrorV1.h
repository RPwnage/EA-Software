...
class EADPGENERATED_API PresenceUpdateErrorV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit PresenceUpdateErrorV1(const ::eadp::foundation::Allocator& allocator);
