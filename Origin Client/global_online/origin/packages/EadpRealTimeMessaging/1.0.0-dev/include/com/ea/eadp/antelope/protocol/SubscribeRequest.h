...
class EADPGENERATED_API SubscribeRequest : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit SubscribeRequest(const ::eadp::foundation::Allocator& allocator);
