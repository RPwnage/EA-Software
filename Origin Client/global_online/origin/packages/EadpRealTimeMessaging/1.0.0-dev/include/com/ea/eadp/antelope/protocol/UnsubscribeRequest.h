...
class EADPGENERATED_API UnsubscribeRequest : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit UnsubscribeRequest(const ::eadp::foundation::Allocator& allocator);
