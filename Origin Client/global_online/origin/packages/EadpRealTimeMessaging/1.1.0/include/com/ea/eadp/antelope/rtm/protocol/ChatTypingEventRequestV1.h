...
class EADPGENERATED_API ChatTypingEventRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatTypingEventRequestV1(const ::eadp::foundation::Allocator& allocator);
