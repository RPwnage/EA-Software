...
class EADPGENERATED_API PublishResponse : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit PublishResponse(const ::eadp::foundation::Allocator& allocator);
