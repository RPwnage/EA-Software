...
class EADPGENERATED_API LoginV3Response : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit LoginV3Response(const ::eadp::foundation::Allocator& allocator);
