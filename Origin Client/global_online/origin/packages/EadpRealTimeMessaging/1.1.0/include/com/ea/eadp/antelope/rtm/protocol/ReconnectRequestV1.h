...
class EADPGENERATED_API ReconnectRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ReconnectRequestV1(const ::eadp::foundation::Allocator& allocator);
