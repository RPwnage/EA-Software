...
#include <com/ea/eadp/antelope/rtm/protocol/StickyMessageChangeType.h>
#include <com/ea/eadp/antelope/rtm/protocol/StickyMessageV1.h>

namespace com { namespace ea { namespace eadp { namespace antelope { namespace rtm { namespace protocol { class StickyMessageV1;  } } } } } }
...
class EADPGENERATED_API StickyMessageChangedV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit StickyMessageChangedV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    com::ea::eadp::antelope::rtm::protocol::StickyMessageChangeType getStickyMessageChangeType() const;
    void setStickyMessageChangeType(com::ea::eadp::antelope::rtm::protocol::StickyMessageChangeType value);
    /**@}*/

    /**@{
     */
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::StickyMessageV1> getStickyMessage();
    void setStickyMessage(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::StickyMessageV1>);
    bool hasStickyMessage();
    void releaseStickyMessage();
    /**@}*/
...
private:
    ...
    int m_stickyMessageChangeType;
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::StickyMessageV1> m_stickyMessage;
    int32_t m_index;
