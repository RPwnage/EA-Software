...
class EADPGENERATED_API WorldChatAssignV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit WorldChatAssignV1(const ::eadp::foundation::Allocator& allocator);
