...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace protocol { class MutedUserV1;  } } } } }
...
class EADPGENERATED_API SubscribeResponse : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit SubscribeResponse(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::MutedUserV1>>& getMutedUsers();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::MutedUserV1>> m_mutedUsers;
