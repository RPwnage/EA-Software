...
class EADPGENERATED_API LoginV2Success : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit LoginV2Success(const ::eadp::foundation::Allocator& allocator);
