...
public:
    ...
    /**@{
     */
    const ::eadp::foundation::String& getTargetNickName() const;
    void setTargetNickName(const ::eadp::foundation::String& value);
    void setTargetNickName(const char8_t* value);
    /**@}*/

    /**@{
     */
    const ::eadp::foundation::String& getInitiatorNickName() const;
    void setInitiatorNickName(const ::eadp::foundation::String& value);
    void setInitiatorNickName(const char8_t* value);
    /**@}*/
...
private:
    ...
    ::eadp::foundation::String m_targetNickName;
    ::eadp::foundation::String m_initiatorNickName;
