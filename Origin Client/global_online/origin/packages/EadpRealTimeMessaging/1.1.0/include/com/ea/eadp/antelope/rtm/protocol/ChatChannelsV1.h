...
class EADPGENERATED_API ChatChannelsV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatChannelsV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::ChannelV1>>& getChannels();
    /**@}*/
     ...
     */
    const ::eadp::foundation::String& getLastOnlineTimestamp() const;
    void setLastOnlineTimestamp(const ::eadp::foundation::String& value);
    void setLastOnlineTimestamp(const char8_t* value);
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::ChannelV1>> m_channels;
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::ChannelMuteListV1>> m_muteList;
    ::eadp::foundation::String m_lastOnlineTimestamp;
