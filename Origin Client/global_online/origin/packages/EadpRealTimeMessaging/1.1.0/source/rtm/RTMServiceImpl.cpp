...
using RTMConnectResponseV2 = ResponseT<SharedPtr<com::ea::eadp::antelope::rtm::protocol::LoginV2Success>, const ErrorPtr&>;
 ...
 * Connection Service
 *************************************************************************/
void RTMServiceImpl::connect(String accessToken, String clientVersion, eadp::realtimemessaging::ConnectionService::ConnectCallback connectCb, eadp::realtimemessaging::ConnectionService::DisconnectCallback disconnectCb, bool forceDisconnect)
{
    connectHelper(false, accessToken, clientVersion, connectCb, nullptr, disconnectCb, nullptr, forceDisconnect, false, "", "");
}
void RTMServiceImpl::reconnect(String accessToken, String clientVersion, eadp::realtimemessaging::ConnectionService::ConnectCallback connectCb, eadp::realtimemessaging::ConnectionService::DisconnectCallback disconnectCb, bool forceDisconnect)
{
    connectHelper(false, accessToken, clientVersion, connectCb, nullptr, disconnectCb, nullptr, forceDisconnect, true, "", "");
}

void RTMServiceImpl::connect(String accessToken, String clientVersion, eadp::realtimemessaging::ConnectionService::MultiConnectCallback multiConnectCb, eadp::realtimemessaging::ConnectionService::DisconnectCallback disconnectCb, eadp::realtimemessaging::ConnectionService::UserSessionChangeCallback userSessionChangeCb, bool forceDisconnect, String forceDisconnectSessionKey)
{
    connectHelper(true, accessToken, clientVersion, nullptr, multiConnectCb, disconnectCb, userSessionChangeCb, forceDisconnect, false, forceDisconnectSessionKey, "");
}
...
{
    connectHelper(true, accessToken, clientVersion, nullptr, multiConnectCb, disconnectCb, userSessionChangeCb, forceDisconnect, true, forceDisconnectSessionKey, reconnectSessionKey);
}

void RTMServiceImpl::connectHelper(bool isMultiSession, String accessToken, String clientVersion, eadp::realtimemessaging::ConnectionService::ConnectCallback connectCb, eadp::realtimemessaging::ConnectionService::MultiConnectCallback multiConnectCb, eadp::realtimemessaging::ConnectionService::DisconnectCallback disconnectCb, eadp::realtimemessaging::ConnectionService::UserSessionChangeCallback userSessionChangeCb, bool forceDisconnect, bool isReconnect, String forceDisconnectSessionKey, String reconnectSessionKey)
{
    ...
    {
        isMultiSession ? notifyServiceConnectedV3(nullptr, nullptr, nullptr) : notifyServiceConnectedV2(nullptr, nullptr);
        break;
    }
    ...
    default:
    {
        ...
        isMultiSession ? notifyServiceConnectedV3(nullptr, nullptr, error) : notifyServiceConnectedV2(nullptr, error);
        break;
    }
    }
}
...
void RTMServiceImpl::disconnect()
{
    ...
    auto logoutCallback = [&]()
    {
        RTMDisconnectResponse::post(m_hub, kRTMDisconnectRequestJobName, m_disconnectCallback, ConnectionService::DisconnectSource::Reason::MANUAL_DISCONNECT, nullptr);
        m_disconnectCallback = nullptr;
        m_connectCallback = nullptr;
...
void RTMServiceImpl::sendLoginRequestV3()
{
    ...
    {
        onLoginResponseV3(EADPSDK_MOVE(loginResponse), EADPSDK_MOVE(loginError), error, isReconnect);
    };
    ...
    auto loginRequestJob = m_hub->getAllocator().makeUnique<eadp::realtimemessaging::LoginRequestV3Job>(m_hub,
        ...
        isReconnect,
        m_forceDisconnect,
        m_forceDisconnectSessionKey,
        m_reconnectSessionKey,
...
void RTMServiceImpl::onLoginResponseV3(SharedPtr<rtm::protocol::LoginV3Response> loginResponse, SharedPtr<rtm::protocol::LoginErrorV1> loginError, const ErrorPtr& error, bool isReconnect)
{
    if (error)
    {
        closeSocketConnection();
        setState(ConnectionState::DISCONNECTED);
        notifyServiceConnectedV3(nullptr, loginError, error);
        m_queueReconnectionData.clear();
    }
    else
    {
        setState(ConnectionState::CONNECTED);
        notifyServiceConnectedV3(loginResponse, nullptr, nullptr);
        if (isReconnect)
        {
            completeReconnection();
        }
...
void RTMServiceImpl::notifyServiceConnectedV3(SharedPtr<rtm::protocol::LoginV3Response> loginResponse, SharedPtr<rtm::protocol::LoginErrorV1> loginError, const ErrorPtr& error)
{
    RTMConnectResponseV3::post(m_hub, kRTMConnectRequestJobName, m_multiConnectCallback, loginResponse, loginError, error);
    m_multiConnectCallback = nullptr;
}
