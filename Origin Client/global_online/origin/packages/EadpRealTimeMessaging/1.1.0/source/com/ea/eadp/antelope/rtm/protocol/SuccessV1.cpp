...
size_t SuccessV1::getByteSize()
{
    ...
    if (hasLoginV3Response() && m_body.m_loginV3Response)
    {
        total_size += 1 + ::eadp::foundation::Internal::ProtobufWireFormat::getMessageSize(*m_body.m_loginV3Response);
    }
...
uint8_t* SuccessV1::onSerialize(uint8_t* target) const
{
    ...
    if (hasLoginV3Response() && m_body.m_loginV3Response)
    {
        target = ::eadp::foundation::Internal::ProtobufWireFormat::writeMessage(3, *m_body.m_loginV3Response, target);
    }
    return target;
}
    ...
    for (;;)
    {
        ...
        switch (::eadp::foundation::Internal::ProtobufWireFormat::getTagFieldNumber(tag))
        {
            ...
            case 2:
            {
                ...
                if (input->expectTag(26)) goto parse_loginV3Response;
                break;
            }
            ...
            case 3:
            {
                if (tag == 26)
                {
                    parse_loginV3Response:
                    clearBody();
                    if (!input->readMessage(getLoginV3Response().get()))
                    {
                        return false;
                    }
                } else {
...
::eadp::foundation::String SuccessV1::toString(const ::eadp::foundation::String& indent) const
{
    ...
    if (hasLoginV3Response() && m_body.m_loginV3Response)
    {
        ::eadp::foundation::Internal::Utils::appendSprintf(result, "%s  loginV3Response: %s,\n", indent.c_str(), m_body.m_loginV3Response->toString(indent + "  ").c_str());
    }
    result.append(indent);
    result.append("}");
    return result;
...
::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::LoginV3Response> SuccessV1::getLoginV3Response()
{
    if (!hasLoginV3Response())
    {
        setLoginV3Response(m_allocator_.makeShared<com::ea::eadp::antelope::rtm::protocol::LoginV3Response>(m_allocator_));
    }
    return m_body.m_loginV3Response;
}

bool SuccessV1::hasLoginV3Response() const
{
    return m_bodyCase == BodyCase::kLoginV3Response;
}

void SuccessV1::setLoginV3Response(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::LoginV3Response> value)
{
    clearBody();
    new(&m_body.m_loginV3Response) ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::LoginV3Response>(value);
    m_bodyCase = BodyCase::kLoginV3Response;
}

void SuccessV1::releaseLoginV3Response()
{
    if (hasLoginV3Response())
    {
        m_body.m_loginV3Response.reset();
        m_bodyCase = BodyCase::kNotSet;
    }
}
...
void SuccessV1::clearBody()
{
    switch(getBodyCase())
    {
        ...
        case BodyCase::kChatInitiateSuccess:
            m_body.m_chatInitiateSuccess.reset();
            break;
        case BodyCase::kLoginV3Response:
            m_body.m_loginV3Response.reset();
            break;
