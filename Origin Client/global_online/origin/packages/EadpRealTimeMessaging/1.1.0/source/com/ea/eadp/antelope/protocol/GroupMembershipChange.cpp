...
, m_targetNickName(m_allocator_.emptyString())
, m_initiatorNickName(m_allocator_.emptyString())
{
}
...
void GroupMembershipChange::clear()
{
    ...
    m_targetNickName.clear();
    m_initiatorNickName.clear();
}
...
size_t GroupMembershipChange::getByteSize()
{
    ...
    {
        total_size += 1 + ::eadp::foundation::Internal::ProtobufWireFormat::getStringSize(m_targetNickName);
    }
    if (!m_initiatorNickName.empty())
    {
        total_size += 1 + ::eadp::foundation::Internal::ProtobufWireFormat::getStringSize(m_initiatorNickName);
    }
...
uint8_t* GroupMembershipChange::onSerialize(uint8_t* target) const
{
    ...
    if (!getTargetNickName().empty())
    {
        target = ::eadp::foundation::Internal::ProtobufWireFormat::writeString(8, getTargetNickName(), target);
    }
    if (!getInitiatorNickName().empty())
    {
        target = ::eadp::foundation::Internal::ProtobufWireFormat::writeString(9, getInitiatorNickName(), target);
    }
    return target;
}
    ...
    for (;;)
    {
        ...
        switch (::eadp::foundation::Internal::ProtobufWireFormat::getTagFieldNumber(tag))
        {
            ...
            case 7:
            {
                ...
                if (input->expectTag(66)) goto parse_targetNickName;
                break;
            }
            ...
            case 8:
            {
                if (tag == 66)
                {
                    parse_targetNickName:
                    if (!input->readString(&m_targetNickName))
                    {
                        return false;
                    }
                } else {
                ...
                if (input->expectTag(74)) goto parse_initiatorNickName;
                break;
            }
            ...
            case 9:
            {
                if (tag == 74)
                {
                    parse_initiatorNickName:
                    if (!input->readString(&m_initiatorNickName))
                    {
                        return false;
                    }
                } else {
...
::eadp::foundation::String GroupMembershipChange::toString(const ::eadp::foundation::String& indent) const
{
    ...
    if (!m_targetNickName.empty())
    {
        ::eadp::foundation::Internal::Utils::appendSprintf(result, "%s  targetNickName: \"%s\",\n", indent.c_str(), m_targetNickName.c_str());
    }
    if (!m_initiatorNickName.empty())
    {
        ::eadp::foundation::Internal::Utils::appendSprintf(result, "%s  initiatorNickName: \"%s\",\n", indent.c_str(), m_initiatorNickName.c_str());
    }
    result.append(indent);
    result.append("}");
    return result;
...
const ::eadp::foundation::String& GroupMembershipChange::getTargetNickName() const
{
    return m_targetNickName;
}

void GroupMembershipChange::setTargetNickName(const ::eadp::foundation::String& value)
{
    m_targetNickName = value;
}

void GroupMembershipChange::setTargetNickName(const char8_t* value)
{
    m_targetNickName = m_allocator_.make<::eadp::foundation::String>(value);
}


const ::eadp::foundation::String& GroupMembershipChange::getInitiatorNickName() const
{
    return m_initiatorNickName;
}

void GroupMembershipChange::setInitiatorNickName(const ::eadp::foundation::String& value)
{
    m_initiatorNickName = value;
}

void GroupMembershipChange::setInitiatorNickName(const char8_t* value)
{
    m_initiatorNickName = m_allocator_.make<::eadp::foundation::String>(value);
}
