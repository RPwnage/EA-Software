...
LoginErrorV1::LoginErrorV1(const ::eadp::foundation::Allocator& allocator)
: ::eadp::foundation::Internal::ProtobufMessage(allocator.make<::eadp::foundation::String>("com.ea.eadp.antelope.rtm.protocol.LoginErrorV1"))
...
void LoginErrorV1::clear()
{
    m_cachedByteSize_ = 0;
    m_connectedSessions.clear();
}

size_t LoginErrorV1::getByteSize()
{
    size_t total_size = 0;
...
uint8_t* LoginErrorV1::onSerialize(uint8_t* target) const
{
    for (EADPSDK_SIZE_T i = 0; i < m_connectedSessions.size(); i++)
    {
...
bool LoginErrorV1::onDeserialize(::eadp::foundation::Internal::ProtobufInputStream* input)
{
    clear();
    uint32_t tag;
    for (;;)
...
::eadp::foundation::String LoginErrorV1::toString(const ::eadp::foundation::String& indent) const
{
...
::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::SessionV1>>& LoginErrorV1::getConnectedSessions()
{
