...
const ::eadp::foundation::String& PlayerInfo::getNickName() const
{
    return m_nickName;
}

void PlayerInfo::setNickName(const ::eadp::foundation::String& value)
{
    m_nickName = value;
}

void PlayerInfo::setNickName(const char8_t* value)
{
