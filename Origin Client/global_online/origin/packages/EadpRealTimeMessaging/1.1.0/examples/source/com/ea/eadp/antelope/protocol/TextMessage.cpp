...
uint8_t* TextMessage::onSerialize(uint8_t* target) const
{
    ...
    {
        target = ::eadp::foundation::Internal::ProtobufWireFormat::writeString(6, getFromNickName(), target);
    }
    return target;
}
    ...
    for (;;)
    {
        ...
        switch (::eadp::foundation::Internal::ProtobufWireFormat::getTagFieldNumber(tag))
        {
            ...
            case 5:
            {
                ...
                if (input->expectTag(50)) goto parse_fromNickName;
                break;
            }
...
const ::eadp::foundation::String& TextMessage::getFromNickName() const
{
    return m_fromNickName;
}

void TextMessage::setFromNickName(const ::eadp::foundation::String& value)
{
    m_fromNickName = value;
}

void TextMessage::setFromNickName(const char8_t* value)
{
