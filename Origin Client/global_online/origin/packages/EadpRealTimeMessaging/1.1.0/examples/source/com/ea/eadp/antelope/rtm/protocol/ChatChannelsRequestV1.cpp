...
uint8_t* ChatChannelsRequestV1::onSerialize(uint8_t* target) const
{
    ...
    {
        target = ::eadp::foundation::Internal::ProtobufWireFormat::writeBool(2, getIncludeLastMessageInfo(), target);
    }
    return target;
}
    ...
    for (;;)
    {
        ...
        switch (::eadp::foundation::Internal::ProtobufWireFormat::getTagFieldNumber(tag))
        {
            case 1:
            {
                ...
                if (input->expectTag(16)) goto parse_includeLastMessageInfo;
                break;
            }
...
bool ChatChannelsRequestV1::getIncludeLastMessageInfo() const
{
    return m_includeLastMessageInfo;
}

void ChatChannelsRequestV1::setIncludeLastMessageInfo(bool value)
{
