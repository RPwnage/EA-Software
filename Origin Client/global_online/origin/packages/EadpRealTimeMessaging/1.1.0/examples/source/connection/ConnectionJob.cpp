...
, m_sessionKey(EADPSDK_MOVE(sessionKey))
{
}
...
void ConnectionJob::execute()
{
    ...
    {
        rtmService->connect(m_accessToken, m_clientVersion, m_multiConnectCallback, m_disconnectCallback, m_userSessionChangeCallback, m_forceDisconnect, m_sessionKey);
        break;
    }
    case Type::MULTIRECONNECT:
    {
        rtmService->reconnect(m_accessToken, m_clientVersion, m_multiConnectCallback, m_disconnectCallback, m_userSessionChangeCallback, m_forceDisconnect, m_sessionKey);
        break;
    }
