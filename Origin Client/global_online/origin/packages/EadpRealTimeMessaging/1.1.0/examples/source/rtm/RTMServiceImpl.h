...
public:
    ...
    void connect(eadp::foundation::String accessToken, eadp::foundation::String clientVersion, ConnectionService::MultiConnectCallback multiConnectCb, ConnectionService::DisconnectCallback disconnectCb, ConnectionService::UserSessionChangeCallback userSessionChangeCb, bool forceDisconnect, eadp::foundation::String sessionKey = "") override;
...
private:
    ...
    void connectHelper(bool isMultiSession, eadp::foundation::String accessToken, eadp::foundation::String clientVersion, ConnectionService::ConnectCallback connectCb, ConnectionService::MultiConnectCallback multiConnectCb, ConnectionService::DisconnectCallback disconnectCb, ConnectionService::UserSessionChangeCallback userSessionChangeCb, bool forceDisconnect, bool isReconnect, eadp::foundation::String sessionKey = "");
    ...
    void notifyServiceConnectedV3(eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::LoginV3Response> loginResponse, const eadp::foundation::ErrorPtr& error);
    ...
    void onLoginResponseV3(eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::LoginV3Response> loginResponse, const eadp::foundation::ErrorPtr& error, bool isReconnect);
