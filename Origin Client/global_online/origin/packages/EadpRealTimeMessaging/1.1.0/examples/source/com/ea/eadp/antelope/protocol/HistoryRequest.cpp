...
, m_recordCount(0)
, m_primaryFilterType(m_allocator_.emptyString())
, m_secondaryFilterType(m_allocator_.emptyString())
{
}
...
void HistoryRequest::clear()
{
    ...
    m_timestamp.clear();
    m_recordCount = 0;
    m_primaryFilterType.clear();
    m_secondaryFilterType.clear();
}
...
size_t HistoryRequest::getByteSize()
{
    ...
    {
        total_size += 1 + ::eadp::foundation::Internal::ProtobufWireFormat::getStringSize(m_primaryFilterType);
    }
    if (!m_secondaryFilterType.empty())
    {
        total_size += 1 + ::eadp::foundation::Internal::ProtobufWireFormat::getStringSize(m_secondaryFilterType);
    }
...
uint8_t* HistoryRequest::onSerialize(uint8_t* target) const
{
    ...
    if (!getPrimaryFilterType().empty())
    {
        target = ::eadp::foundation::Internal::ProtobufWireFormat::writeString(4, getPrimaryFilterType(), target);
    }
    if (!getSecondaryFilterType().empty())
    {
        target = ::eadp::foundation::Internal::ProtobufWireFormat::writeString(5, getSecondaryFilterType(), target);
    }
    return target;
}
    ...
    for (;;)
    {
        ...
        switch (::eadp::foundation::Internal::ProtobufWireFormat::getTagFieldNumber(tag))
        {
            ...
            case 3:
            {
                ...
                if (input->expectTag(34)) goto parse_primaryFilterType;
                break;
            }
            ...
            case 4:
            {
                if (tag == 34)
                {
                    parse_primaryFilterType:
                    if (!input->readString(&m_primaryFilterType))
                    {
                        return false;
                    }
                } else {
                ...
                if (input->expectTag(42)) goto parse_secondaryFilterType;
                break;
            }
            ...
            case 5:
            {
                if (tag == 42)
                {
                    parse_secondaryFilterType:
                    if (!input->readString(&m_secondaryFilterType))
                    {
                        return false;
                    }
                } else {
...
::eadp::foundation::String HistoryRequest::toString(const ::eadp::foundation::String& indent) const
{
    ...
    if (!m_primaryFilterType.empty())
    {
        ::eadp::foundation::Internal::Utils::appendSprintf(result, "%s  primaryFilterType: \"%s\",\n", indent.c_str(), m_primaryFilterType.c_str());
    }
    if (!m_secondaryFilterType.empty())
    {
        ::eadp::foundation::Internal::Utils::appendSprintf(result, "%s  secondaryFilterType: \"%s\",\n", indent.c_str(), m_secondaryFilterType.c_str());
    }
    result.append(indent);
    result.append("}");
    return result;
...
const ::eadp::foundation::String& HistoryRequest::getPrimaryFilterType() const
{
    return m_primaryFilterType;
}

void HistoryRequest::setPrimaryFilterType(const ::eadp::foundation::String& value)
{
    m_primaryFilterType = value;
}

void HistoryRequest::setPrimaryFilterType(const char8_t* value)
{
    m_primaryFilterType = m_allocator_.make<::eadp::foundation::String>(value);
}


const ::eadp::foundation::String& HistoryRequest::getSecondaryFilterType() const
{
    return m_secondaryFilterType;
}

void HistoryRequest::setSecondaryFilterType(const ::eadp::foundation::String& value)
{
    m_secondaryFilterType = value;
}

void HistoryRequest::setSecondaryFilterType(const char8_t* value)
{
    m_secondaryFilterType = m_allocator_.make<::eadp::foundation::String>(value);
}
