...
public:
    ...
    // LoginRequestV2 connection
    virtual void connect(eadp::foundation::String accessToken, eadp::foundation::String clientVersion, ConnectionService::ConnectCallback connectCb, ConnectionService::DisconnectCallback disconnectCb, bool forceDisconnect) = 0;
    virtual void reconnect(eadp::foundation::String accessToken, eadp::foundation::String clientVersion, ConnectionService::ConnectCallback connectCb, ConnectionService::DisconnectCallback disconnectCb, bool forceDisconnect) = 0;

    // LoginRequestV3 connection (multi-session)
    virtual void connect(eadp::foundation::String accessToken, eadp::foundation::String clientVersion, ConnectionService::MultiConnectCallback connectCb, ConnectionService::DisconnectCallback disconnectCb, ConnectionService::UserSessionChangeCallback userSessionChangeCb, bool forceDisconnect, eadp::foundation::String sessionKey) = 0;
    virtual void reconnect(eadp::foundation::String accessToken, eadp::foundation::String clientVersion, ConnectionService::MultiConnectCallback connectCb, ConnectionService::DisconnectCallback disconnectCb, ConnectionService::UserSessionChangeCallback userSessionChangeCb, bool forceDisconnect, eadp::foundation::String sessionKey) = 0;
