...
{
class ChannelUnsubscribeRequestJob : public RTMRequestJob
{
public:
    ChannelUnsubscribeRequestJob(eadp::foundation::IHub* hub,
        eadp::foundation::SharedPtr<Internal::RTMService> rtmService,
        const eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::UnsubscribeRequest> unsubscribeRequest,
...
private:
    ...
    const eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::UnsubscribeRequest> m_unsubscribeRequest;
};
}
}
