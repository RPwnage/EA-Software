...
class EADPGENERATED_API SessionRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit SessionRequestV1(const ::eadp::foundation::Allocator& allocator);
