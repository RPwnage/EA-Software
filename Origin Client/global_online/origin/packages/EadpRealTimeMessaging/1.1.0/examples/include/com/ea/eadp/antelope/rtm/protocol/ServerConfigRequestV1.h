...
class EADPGENERATED_API ServerConfigRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ServerConfigRequestV1(const ::eadp::foundation::Allocator& allocator);
