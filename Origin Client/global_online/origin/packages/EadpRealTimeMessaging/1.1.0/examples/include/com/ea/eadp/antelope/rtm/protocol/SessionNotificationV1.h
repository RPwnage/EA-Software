...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace rtm { namespace protocol { class SessionV1;  } } } } } }
...
public:
    ...
    /**@{
     */
    int32_t getSessionLimitRemaining() const;
    void setSessionLimitRemaining(int32_t value);
    /**@}*/

    /**@{
     */
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::SessionV1> getConnectedSessions();
    void setConnectedSessions(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::SessionV1>);
    bool hasConnectedSessions();
    void releaseConnectedSessions();
    /**@}*/
...
private:
    ...
    int m_platform;
    int32_t m_sessionLimitRemaining;
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::SessionV1> m_connectedSessions;
