...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace rtm { namespace protocol { class RateLimitConfigV1;  } } } } } }
...
class EADPGENERATED_API ServerConfigV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ServerConfigV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::RateLimitConfigV1> getRateLimitConfig();
    void setRateLimitConfig(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::RateLimitConfigV1>);
    bool hasRateLimitConfig();
    void releaseRateLimitConfig();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::RateLimitConfigV1> m_rateLimitConfig;
