...
class EADPGENERATED_API UnsubscribeResponse : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit UnsubscribeResponse(const ::eadp::foundation::Allocator& allocator);
