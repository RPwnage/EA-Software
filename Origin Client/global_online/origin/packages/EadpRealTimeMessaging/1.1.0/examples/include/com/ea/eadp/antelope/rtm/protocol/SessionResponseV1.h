...
class EADPGENERATED_API SessionResponseV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit SessionResponseV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::SessionV1>>& getConnectedSessions();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::SessionV1>> m_connectedSessions;
