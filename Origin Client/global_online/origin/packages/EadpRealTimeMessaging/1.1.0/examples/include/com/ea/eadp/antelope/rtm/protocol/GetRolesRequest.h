...
class EADPGENERATED_API GetRolesRequest : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit GetRolesRequest(const ::eadp::foundation::Allocator& allocator);
