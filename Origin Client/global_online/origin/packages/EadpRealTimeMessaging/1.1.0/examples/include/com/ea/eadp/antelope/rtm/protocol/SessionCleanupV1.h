 ...
 */
class EADPGENERATED_API SessionCleanupV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit SessionCleanupV1(const ::eadp::foundation::Allocator& allocator);
