...
class EADPGENERATED_API LoginRequestV3 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit LoginRequestV3(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     *  when doing reconnect, need to send session key along with it
     */
     ...
     */
    const ::eadp::foundation::String& getForceDisconnectSessionKey() const;
    void setForceDisconnectSessionKey(const ::eadp::foundation::String& value);
    void setForceDisconnectSessionKey(const char8_t* value);
    /**@}*/
