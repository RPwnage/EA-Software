...
class EADPGENERATED_API WorldChatShard : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit WorldChatShard(const ::eadp::foundation::Allocator& allocator);
