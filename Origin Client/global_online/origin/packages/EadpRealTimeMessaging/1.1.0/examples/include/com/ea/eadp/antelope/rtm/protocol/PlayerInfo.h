...
class EADPGENERATED_API PlayerInfo : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit PlayerInfo(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    const ::eadp::foundation::String& getDisplayName() const;
    void setDisplayName(const ::eadp::foundation::String& value);
    void setDisplayName(const char8_t* value);
    /**@}*/

    /**@{
     */
    const ::eadp::foundation::String& getNickName() const;
    void setNickName(const ::eadp::foundation::String& value);
    void setNickName(const char8_t* value);
    /**@}*/
...
private:
    ...
    ::eadp::foundation::String m_displayName;
    ::eadp::foundation::String m_nickName;
