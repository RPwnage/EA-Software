...
MuteUserV1::MuteUserV1(const ::eadp::foundation::Allocator& allocator)
: ::eadp::foundation::Internal::ProtobufMessage(allocator.make<::eadp::foundation::String>("com.ea.eadp.antelope.rtm.protocol.MuteUserV1"))
...
uint8_t* MuteUserV1::onSerialize(uint8_t* target) const
{
...
bool MuteUserV1::onDeserialize(::eadp::foundation::Internal::ProtobufInputStream* input)
{
    clear();
    uint32_t tag;
    for (;;)
...
::eadp::foundation::String MuteUserV1::toString(const ::eadp::foundation::String& indent) const
{
...
const ::eadp::foundation::String& MuteUserV1::getChannelId() const
{
    return m_channelId;
}

void MuteUserV1::setChannelId(const ::eadp::foundation::String& value)
{
    m_channelId = value;
}

void MuteUserV1::setChannelId(const char8_t* value)
{
    m_channelId = m_allocator_.make<::eadp::foundation::String>(value);
}


const ::eadp::foundation::String& MuteUserV1::getPersonaId() const
{
    return m_personaId;
}

void MuteUserV1::setPersonaId(const ::eadp::foundation::String& value)
{
    m_personaId = value;
}

void MuteUserV1::setPersonaId(const char8_t* value)
{
    m_personaId = m_allocator_.make<::eadp::foundation::String>(value);
}


::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::Player> MuteUserV1::getPlayer()
{
    if (m_player == nullptr)
    {
...
void MuteUserV1::setPlayer(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::Player> val)
{
    m_player = val;
}

bool MuteUserV1::hasPlayer()
{
    return m_player != nullptr;
}

void MuteUserV1::releasePlayer()
{
    m_player.reset();
}
