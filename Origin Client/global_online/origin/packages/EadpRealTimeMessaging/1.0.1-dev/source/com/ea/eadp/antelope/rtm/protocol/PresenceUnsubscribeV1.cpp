...
PresenceUnsubscribeV1::PresenceUnsubscribeV1(const ::eadp::foundation::Allocator& allocator)
: ::eadp::foundation::Internal::ProtobufMessage(allocator.make<::eadp::foundation::String>("com.ea.eadp.antelope.rtm.protocol.PresenceUnsubscribeV1"))
...
void PresenceUnsubscribeV1::clear()
{
    m_cachedByteSize_ = 0;
    m_personaId.clear();
    m_players.clear();
...
size_t PresenceUnsubscribeV1::getByteSize()
{
    size_t total_size = 0;
...
uint8_t* PresenceUnsubscribeV1::onSerialize(uint8_t* target) const
{
    for (EADPSDK_SIZE_T i = 0; i < m_personaId.size(); i++)
    {
...
bool PresenceUnsubscribeV1::onDeserialize(::eadp::foundation::Internal::ProtobufInputStream* input)
{
    clear();
    uint32_t tag;
    for (;;)
...
::eadp::foundation::String PresenceUnsubscribeV1::toString(const ::eadp::foundation::String& indent) const
{
...
::eadp::foundation::Vector< ::eadp::foundation::String>& PresenceUnsubscribeV1::getPersonaId()
{
    return m_personaId;
}
void PresenceUnsubscribeV1::setPersonaId(int index, const char8_t* value)
{
    m_personaId[index] = m_allocator_.make<::eadp::foundation::String>(value);
}
void PresenceUnsubscribeV1::addPersonaId(const char8_t* value)
{
    m_personaId.push_back(m_allocator_.make<::eadp::foundation::String>(value));
}

::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::Player>>& PresenceUnsubscribeV1::getPlayers()
{
    return m_players;
}
