...
ChatLeftV1::ChatLeftV1(const ::eadp::foundation::Allocator& allocator)
: ::eadp::foundation::Internal::ProtobufMessage(allocator.make<::eadp::foundation::String>("com.ea.eadp.antelope.rtm.protocol.ChatLeftV1"))
...
uint8_t* ChatLeftV1::onSerialize(uint8_t* target) const
{
    if (m_user != nullptr)
    {
...
bool ChatLeftV1::onDeserialize(::eadp::foundation::Internal::ProtobufInputStream* input)
{
    clear();
    uint32_t tag;
    for (;;)
...
::eadp::foundation::String ChatLeftV1::toString(const ::eadp::foundation::String& indent) const
{
...
::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::PersonaV1> ChatLeftV1::getUser()
{
    if (m_user == nullptr)
    {
...
void ChatLeftV1::setUser(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::PersonaV1> val)
{
    m_user = val;
}

bool ChatLeftV1::hasUser()
{
    return m_user != nullptr;
}

void ChatLeftV1::releaseUser()
{
    m_user.reset();
}


::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::PlayerInfo> ChatLeftV1::getPlayers()
{
    if (m_players == nullptr)
    {
...
void ChatLeftV1::setPlayers(::eadp::foundation::SharedPtr<com::ea::eadp::antelope::rtm::protocol::PlayerInfo> val)
{
    m_players = val;
}

bool ChatLeftV1::hasPlayers()
{
    return m_players != nullptr;
}

void ChatLeftV1::releasePlayers()
{
    m_players.reset();
}
