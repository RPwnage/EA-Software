...
class EADPGENERATED_API PromoteStickyMessageRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit PromoteStickyMessageRequestV1(const ::eadp::foundation::Allocator& allocator);
