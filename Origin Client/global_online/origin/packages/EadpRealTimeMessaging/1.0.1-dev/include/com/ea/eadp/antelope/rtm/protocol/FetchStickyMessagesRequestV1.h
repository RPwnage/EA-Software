...
class EADPGENERATED_API FetchStickyMessagesRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit FetchStickyMessagesRequestV1(const ::eadp::foundation::Allocator& allocator);
