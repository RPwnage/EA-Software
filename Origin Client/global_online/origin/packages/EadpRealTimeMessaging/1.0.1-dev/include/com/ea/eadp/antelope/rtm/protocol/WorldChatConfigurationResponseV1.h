...
class EADPGENERATED_API WorldChatConfigurationResponseV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit WorldChatConfigurationResponseV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    int32_t getMaxShards() const;
    void setMaxShards(int32_t value);
    /**@}*/

    /**@{
     */
    int32_t getMaxShardSize() const;
    void setMaxShardSize(int32_t value);
    /**@}*/

    /**@{
     */
    int32_t getMaxWorldNamesPerGame() const;
    void setMaxWorldNamesPerGame(int32_t value);
    /**@}*/

    /**@{
     */
    int32_t getMaxDailyShardSwitchCount() const;
    void setMaxDailyShardSwitchCount(int32_t value);
    /**@}*/
...
private:
    ...
    int32_t m_maxShards;
    int32_t m_maxShardSize;
    int32_t m_maxWorldNamesPerGame;
    int32_t m_maxDailyShardSwitchCount;
