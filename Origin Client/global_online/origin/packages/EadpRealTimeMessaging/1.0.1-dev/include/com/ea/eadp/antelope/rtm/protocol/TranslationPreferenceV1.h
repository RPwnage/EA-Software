...
/**
 *  Translation related preferences
 */
class EADPGENERATED_API TranslationPreferenceV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit TranslationPreferenceV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    const ::eadp::foundation::String& getLanguage() const;
    void setLanguage(const ::eadp::foundation::String& value);
    void setLanguage(const char8_t* value);
    /**@}*/
...
private:
    ...
    ::eadp::foundation::String m_language;
