...
class EADPGENERATED_API WorldChatConfigurationRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit WorldChatConfigurationRequestV1(const ::eadp::foundation::Allocator& allocator);
