...
class EADPGENERATED_API GetPreferenceRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit GetPreferenceRequestV1(const ::eadp::foundation::Allocator& allocator);
