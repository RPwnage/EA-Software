...
AssignErrorV1::AssignErrorV1(const ::eadp::foundation::Allocator& allocator)
: ::eadp::foundation::Internal::ProtobufMessage(allocator.make<::eadp::foundation::String>("com.ea.eadp.antelope.rtm.protocol.AssignErrorV1"))
...
size_t AssignErrorV1::getByteSize()
{
    size_t total_size = 0;
...
uint8_t* AssignErrorV1::onSerialize(uint8_t* target) const
{
...
bool AssignErrorV1::onDeserialize(::eadp::foundation::Internal::ProtobufInputStream* input)
{
    clear();
    uint32_t tag;
    for (;;)
...
::eadp::foundation::String AssignErrorV1::toString(const ::eadp::foundation::String& indent) const
{
...
const ::eadp::foundation::String& AssignErrorV1::getWorldName() const
{
    return m_worldName;
}

void AssignErrorV1::setWorldName(const ::eadp::foundation::String& value)
{
    m_worldName = value;
}

void AssignErrorV1::setWorldName(const char8_t* value)
{
    m_worldName = m_allocator_.make<::eadp::foundation::String>(value);
}


int32_t AssignErrorV1::getShardIndex() const
{
    return m_shardIndex;
}

void AssignErrorV1::setShardIndex(int32_t value)
{
    m_shardIndex = value;
}
