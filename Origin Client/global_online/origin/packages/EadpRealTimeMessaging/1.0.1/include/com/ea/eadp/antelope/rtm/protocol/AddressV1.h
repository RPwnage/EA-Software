...
#include <com/ea/eadp/antelope/rtm/protocol/Domain.h>
...
class EADPGENERATED_API AddressV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit AddressV1(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    com::ea::eadp::antelope::rtm::protocol::Domain getDomain() const;
    void setDomain(com::ea::eadp::antelope::rtm::protocol::Domain value);
    /**@}*/

    /**@{
     */
    EADP_FOUNDATION_PROTOBUF_DEPRECATED_ATTR const ::eadp::foundation::String& getId() const;
    EADP_FOUNDATION_PROTOBUF_DEPRECATED_ATTR void setId(const ::eadp::foundation::String& value);
    EADP_FOUNDATION_PROTOBUF_DEPRECATED_ATTR void setId(const char8_t* value);
    /**@}*/
