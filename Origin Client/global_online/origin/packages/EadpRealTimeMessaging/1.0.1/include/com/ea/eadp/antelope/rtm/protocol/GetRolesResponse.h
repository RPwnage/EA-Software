...
#include <com/ea/eadp/antelope/rtm/protocol/ModerationRoleType.h>
...
class EADPGENERATED_API GetRolesResponse : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit GetRolesResponse(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< com::ea::eadp::antelope::rtm::protocol::ModerationRoleType>& getRoles();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< com::ea::eadp::antelope::rtm::protocol::ModerationRoleType> m_roles;
    int32_t m_roles__cachedByteSize;
