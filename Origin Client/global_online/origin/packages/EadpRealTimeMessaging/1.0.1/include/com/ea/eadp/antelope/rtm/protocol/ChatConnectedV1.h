 ...
 * Channel Messages
 */
class EADPGENERATED_API ChatConnectedV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatConnectedV1(const ::eadp::foundation::Allocator& allocator);
