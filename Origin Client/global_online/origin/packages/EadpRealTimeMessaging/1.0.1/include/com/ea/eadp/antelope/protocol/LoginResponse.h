...
namespace com { namespace ea { namespace eadp { namespace antelope { namespace protocol { class Channel;  } } } } }
namespace com { namespace ea { namespace eadp { namespace antelope { namespace protocol { class ChannelMuteList;  } } } } }
 ...
 * Responses
 */
class EADPGENERATED_API LoginResponse : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit LoginResponse(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::Channel>>& getChannels();
    /**@}*/

    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::ChannelMuteList>>& getMuteList();
    /**@}*/
...
private:
    ...
    bool m_success;
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::Channel>> m_channels;
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::ChannelMuteList>> m_muteList;
