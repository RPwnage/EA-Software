...
class EADPGENERATED_API HistoryResponse : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit HistoryResponse(const ::eadp::foundation::Allocator& allocator);
    ...
    /**@{
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::ChannelMessage>>& getMessages();
    /**@}*/
...
private:
    ...
    bool m_success;
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<com::ea::eadp::antelope::protocol::ChannelMessage>> m_messages;
