...
class EADPGENERATED_API WorldChatChannelsRequestV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit WorldChatChannelsRequestV1(const ::eadp::foundation::Allocator& allocator);
