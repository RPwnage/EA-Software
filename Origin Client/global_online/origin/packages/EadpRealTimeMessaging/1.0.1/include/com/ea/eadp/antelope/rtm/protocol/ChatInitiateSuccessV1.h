...
class EADPGENERATED_API ChatInitiateSuccessV1 : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit ChatInitiateSuccessV1(const ::eadp::foundation::Allocator& allocator);
