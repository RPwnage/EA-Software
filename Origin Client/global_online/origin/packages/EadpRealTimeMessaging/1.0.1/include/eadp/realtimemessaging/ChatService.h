 ...
 */
class EADPREALTIMEMESSAGING_API ChatService
{
public:

    /*!
     * @brief This callback is triggered whenever a ChannelMessage is received.
     */
    ...
    /*!
     * @brief This callback is triggered in response to ChatMembersRequestV1 with the list of members for the Channel specified in the request or error object if the request failed.
     *
    ...
    /*!
     * @brief This callback is triggered in response to fetchMessageHistory() call with the list of messages in the channel or error if the request failed.
     *
    ...
    /*!
     * @brief Called when the user receives a Chat Invite.
     */
    ...
    /*!
    * @brief Generic callback used multiple places.
    * 
    ...
    */
    ...
    /*!
     * @brief Get the Chat service instance.
     *
    ...
    */
    ...
    /*!
    * @brief Fetches historical messages before current time(pass nullptr as timestamp) or a specified time from a channel.
    *
    ...
    */
    virtual void fetchMessageHistory(const eadp::foundation::String& channelId, uint32_t count, FetchMessagesCallback callback, eadp::foundation::UniquePtr<eadp::foundation::Timestamp> timestamp = nullptr) = 0;
    ...
    */
     ...
     */
    virtual uint32_t getComposingTimeInterval() = 0;

    /*!
     * @brief Set how frequently the typing indicator is sent (X).
     *
     * The value may not be lower than 3 seconds.
     * The value is clamped to 3 seconds if `interval` is less than 3. 
     *
     * @param interval how often to send new composing events in seconds.
     */
    virtual void setComposingTimeInterval(uint32_t interval) = 0;
