...
#define VERIFY_STR_EQ(a, b) EATEST_VERIFY(!Strcmp(a, b))
...
int TestEAStreamCpp()
{
    ...
    { // Tests on an un-open file
        ...
        #if !defined(EA_PLATFORM_AIRPLAY)               // As of XBox 360 XDK 9328 and VS2008, the C++ Standard Library sets bSetPositionResult true unless you manually call clear.
        ...
        #if !defined(EA_PLATFORM_REVOLUTION) && !defined(EA_PLATFORM_GAMECUBE) // These platforms don't have writable standard file systems. The Wii does have a writable Nand flash drive though.
