...
namespace EA
{
    namespace IO
    {
        ...
        #if !defined(EA_PLATFORM_MICROSOFT) && !defined(EA_PLATFORM_PS3) && !defined(EA_PLATFORM_PSP2)
            enum IOResultCode
            {
        ...
        /// On some platforms, such as the PS3, the application is required to infinitely
        ...
        /// as it must be due to platform specific requirements such as those for the PS3.
    ...
    #include <EAIO/PS3/EAFileStreamPS3.h>
#elif defined(EA_PLATFORM_PLAYSTATION2) || defined(EA_PLATFORM_PSP)
    #include <EAIO/PS2/EAFileStreamPS2.h>
#elif defined(EA_PLATFORM_GAMECUBE)
    #include <EAIO/GameCube/EAFileStreamGameCube.h>
#elif defined(EA_PLATFORM_REVOLUTION)
    #include <EAIO/Wii/EAFileStreamWii.h>
    ...
    #include <EAIO/PSP2/EAFileStreamPSP2.h>
#else
