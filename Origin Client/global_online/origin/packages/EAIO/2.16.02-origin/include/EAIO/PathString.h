...
namespace EA
{
    namespace IO
    {
        ...
        namespace Path
        {
            ...
            ///
            //////////////////////////////////////////////////////////////////////////
            EAIO_API PathString8& Canonicalize(PathString8& path, char8_t separator = EA_FILE_PATH_SEPARATOR_8);
    ...
    namespace IO
    {
        namespace Path
        {
            ...
            PathString32& PathString32::operator+=(const char32_t c)
            {
                ...
                {
                    const size_t nCharsNeeded = EA::StdC::Strlcpy((wchar_t*)NULL, &pSrcPath16[0], 0);
                    resize(nCharsNeeded);
                    EA::StdC::Strlcpy(&this->operator[](0), &pSrcPath16[0], nCharsNeeded + 1);
                }

                inline
                PathStringW::PathStringW(const PathString32& pSrcPath32)
                {
                    const size_t nCharsNeeded = EA::StdC::Strlcpy((wchar_t*)NULL, &pSrcPath32[0], 0);
                    resize(nCharsNeeded);
                    EA::StdC::Strlcpy(&this->operator[](0), &pSrcPath32[0], nCharsNeeded + 1);
                }
