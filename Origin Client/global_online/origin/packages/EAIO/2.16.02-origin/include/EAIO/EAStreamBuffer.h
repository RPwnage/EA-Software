...
namespace EA
{
    ...
    namespace IO
    {
        ...
        public:
            ...
            static const size_type kBufferSizeReadDefault  = (size_type)2048;   /// This is the default read buffer size.
            static const size_type kBufferSizeWriteDefault = (size_type)2048;   /// This is the default write buffer size.
