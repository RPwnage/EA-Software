...
RwfilesysStream::RwfilesysStream(const char8_t* pPath8)
  : mFileStream(),
    mnRefCount(0),
    mnAccessFlags(0),
    mnCD(0),
...
void RwfilesysStream::SetPath(const char8_t* pPath8)
{
...
size_t RwfilesysStream::GetPath(char8_t* pPath8, size_t nPathLength)
{
