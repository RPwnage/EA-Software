...
///////////////8-bit
FilePath::FilePath(const char8_t* pPath)
{
	mPath[0] = 0;
	SetPath(pPath);
}
...
FilePath::FilePath(const char8_t* pDrive, const char8_t* pDirectory, const char8_t* pFileName, const char8_t* pExtension)
{
	mPath[0] = 0;
	SetPath(pDrive, pDirectory, pFileName, pExtension);
}

size_t FilePath::GetDrive(char8_t* dst, size_t capacity) const
{
...
size_t FilePath::GetDirectory(char8_t* dst, size_t capacity) const
{
	const char16_t* pDir, *pFile, *pExt;
	SplitPathPtrs(mPath, pDir, pFile, pExt);
...
size_t FilePath::GetFileName(char8_t* dst, size_t capacity) const
{
	const char16_t* pDir, *pFile, *pExt;
	SplitPathPtrs(mPath, pDir, pFile, pExt);
...
size_t FilePath::GetExtension(char8_t* dst, size_t capacity) const
{
	const char16_t* pDir, *pFile, *pExt;
	SplitPathPtrs(mPath, pDir, pFile, pExt);
...
size_t FilePath::GetPath(char8_t* dst, size_t capacity) const
{
	return EA::StdC::Strlcpy(dst, mPath, capacity);
}


size_t FilePath::GetFileNameAndExtension(char8_t* dst, size_t capacity) const
{
	const char16_t* pDir, *pFile, *pExt;
	SplitPathPtrs(mPath, pDir, pFile, pExt);
...
size_t FilePath::GetDriveAndDirectory(char8_t* dst, size_t capacity) const
{
	const char16_t* pDir, *pFile, *pExt;
	SplitPathPtrs(mPath, pDir, pFile, pExt);
...
bool FilePath::AppendDirectory(const char8_t* dir8)
{
...
bool FilePath::SetDrive(const char8_t* pDrive, bool bInputIsPath)
{
	return ReplacePathComponent(kPosDriveStart, kPosDirectoryStart, pDrive, bInputIsPath);
}


bool FilePath::SetDirectory(const char8_t* pDirectory, bool bInputIsPath)
{
	return ReplacePathComponent(kPosDirectoryStart, kPosFileNameStart, pDirectory, bInputIsPath);
}


bool FilePath::SetFileName(const char8_t* pFileName, bool bInputIsPath)
{
	return ReplacePathComponent(kPosFileNameStart, kPosExtensionStart, pFileName, bInputIsPath);
}


bool FilePath::SetExtension(const char8_t* pExtension, bool bInputIsPath)
{
	return ReplacePathComponent(kPosExtensionStart, kPosEnd, pExtension, bInputIsPath);
}


bool FilePath::SetDriveAndDirectory(const char8_t* pDriveAndDirectory, bool bInputIsPath)
{
	return ReplacePathComponent(kPosDriveStart, kPosFileNameStart, pDriveAndDirectory, bInputIsPath);
}


bool FilePath::SetFileNameAndExtension(const char8_t* pFileNameAndExtension, bool bInputIsPath)
{
	return ReplacePathComponent(kPosFileNameStart, kPosEnd, pFileNameAndExtension, bInputIsPath);
}


bool FilePath::SetPath(const char8_t* pPath8)
{
...
bool FilePath::SetPath(const char8_t* pDrive, const char8_t* pDirectoryOnly, const char8_t* pFileNameOnly, const char8_t* pExtension)
{
	if (!SetDrive(pDrive)             ||
		!SetDirectory(pDirectoryOnly) ||
		!SetFileName(pFileNameOnly)   ||
...
bool FilePath::ReplacePathComponent(PathPos start, PathPos end, const char8_t* pSrc8, bool bInputIsPath)
{
...
{
	const char8_t* dir, *file, *ext;

	SplitPathPtrs(pPath, dir, file, ext);

	pDirStart  = const_cast<char8_t* >(dir);
	pFileStart = const_cast<char8_t* >(file);
	pExtStart  = const_cast<char8_t* >(ext);
}
...
EAIO_API void SplitPathPtrs(const char8_t* pPath, const char8_t*& pDirStart, const char8_t*& pFileStart, const char8_t*& pExtStart)
{
	// Scan path for first and last separators and last period after last
	// separator.
	const char8_t* pFirstSeparator = NULL;
	const char8_t* pLastSeparator  = NULL;
	const char8_t* pLastPeriod      = NULL;
	const char8_t* s = pPath;
...
EAIO_API char16_t* ResolvePath(char16_t* pPathResult, const char16_t* pPath, const char16_t* pBaseDirectory, FileSystem fileSystemType)
{
	...
	return FullPath(pPathResult, pPath, isRooted ? EA_CHAR16("") : pBaseDirectory, fileSystemType); // OK if pBaseDirectory is NULL.
}
