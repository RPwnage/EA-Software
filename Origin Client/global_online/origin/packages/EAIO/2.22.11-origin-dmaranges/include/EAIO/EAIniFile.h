...
namespace EA
{
	namespace IO
	{
		...
		public:
			...
			#endif
			IniFile(const char8_t* pPath,        int optionFlags = kOptionLeaveFileOpen, EA::Allocator::ICoreAllocator* pCoreAllocator = NULL);
			...
			#endif
			virtual bool SetPath(const char8_t* pPath);
			...
			#endif
			virtual int ReadEntry(const char8_t* pSection, const char8_t* pKey, String8& sValue);
			...
			#endif
			virtual int ReadEntryFormatted(const char8_t* pSection, const char8_t* pKey, const char8_t* pValueFormat, ...);
			...
			#endif
			virtual bool WriteEntry(const char8_t* pSection, const char8_t* pKey, const char8_t* pValue);
			...
			#endif
			virtual bool WriteEntryFormatted(const char8_t* pSection, const char8_t* pKey, const char8_t* pValueFormat, ...);
