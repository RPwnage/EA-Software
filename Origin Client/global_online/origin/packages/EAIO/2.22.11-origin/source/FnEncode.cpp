...
namespace EA
{
	namespace IO
	{
		...
		{
			const uint32_t nCharsNeeded = (uint32_t)EA::StdC::Strlcpy((char8_t*)NULL, pSrcPath16, 0);
		...
		{
			const uint32_t nCharsNeeded = (uint32_t)EA::StdC::Strlcpy((char8_t*)NULL, pSrcPath32, 0);
			dstPath8.resize(nCharsNeeded);
		...
		EAIO_API uint32_t ConvertPath(Path::PathString32& dstPath32, const char16_t* pSrcPath16)
		{
			...
			{
				const uint32_t nCharsNeeded = (uint32_t)EA::StdC::Strlcpy((char8_t*)NULL, pSrcPathW, 0);
				dstPath8.resize(nCharsNeeded);
			...
			EAIO_API uint32_t ConvertPath(Path::PathStringW& dstPathW, const char8_t* pSrcPath8)
			{
