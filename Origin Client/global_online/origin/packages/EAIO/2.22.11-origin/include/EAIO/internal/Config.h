...
#ifndef EAIO_VERSION
	#define EAIO_VERSION   "2.22.11"
	#define EAIO_VERSION_N  22211
#endif
...
//
	...
	#if defined(EA_PLATFORM_UNIX) || defined(__APPLE__) || defined(EA_PLATFORM_ANDROID)
...
//
	...
	#if defined(EA_PLATFORM_UNIX) && defined(EA_PLATFORM_CONSOLE) // Add other systems as needed.
...
//
	...
	#if defined(EA_PLATFORM_SONY) && defined(EA_PLATFORM_CONSOLE) && !defined(EA_PLATFORM_KETTLE)
...
//
	...
	#elif defined(EA_PLATFORM_PS3) || defined(EA_PLATFORM_XENON)   // Enabled for backward compatibility.
		#define EAIO_CPP_STREAM_ENABLED 1
	#else
