...
namespace EA
{
	...
	namespace IO
	{
		...
		public:
			...
			EAIO_CORESTREAM_VIRTUAL size_t ReadString8(char8_t* string, uint32_t capacity);

			template <typename String8>
			void ReadString8(String8& string);

			EAIO_CORESTREAM_VIRTUAL void WriteString8(const char8_t* string, uint32_t length);
		...
		///         ; // do something
		///
		EAIO_API size_type ReadLine(IStream* pIS, char8_t*  pLine, size_type nLineCapacity, Endian /*unused*/   = kEndianBig);
