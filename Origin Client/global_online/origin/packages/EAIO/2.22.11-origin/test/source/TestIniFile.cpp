...
int TestIniFile()
{
		...
		String16 sIniFileData16 = EA::StdC::Strlcpy<String16, char8_t>(pIniFileData8);
		String32 sIniFileData32 = EA::StdC::Strlcpy<String32, char8_t>(pIniFileData8);
		StringW  sIniFileDataW  = EA::StdC::Strlcpy<StringW,  char8_t>(pIniFileData8);

		{
			...
			for(size_t i = 0; i < 5; i++)
			{
				...
				if(i == 0)
					stream.SetData(&sIniFileData8[0], sIniFileData8.size() * sizeof(char8_t), false, true);
				else if(i == 1)
