// GENERATED CODE (Source: grpc/status.proto) - DO NOT EDIT DIRECTLY.
...
#include <eadp/foundation/protobuf/Any.h>
 ...
 */
class EADPSDK_API Status : public ::eadp::foundation::Internal::ProtobufMessage
{
public:
     ...
     */
    explicit Status(const ::eadp::foundation::Allocator& allocator);
     ...
     */
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<eadp::foundation::protobuf::Any>>& getDetails();
    /**@}*/
...
private:
    ...
    ::eadp::foundation::Vector< ::eadp::foundation::SharedPtr<eadp::foundation::protobuf::Any>> m_details;
