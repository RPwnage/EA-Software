...
namespace EA.Eaconfig
{
    ...
    public class DeployTask : Task
    {
        ...
        [TaskAttribute("configsystem", Required = true)]
        ...
        public DeployTask(string groupName, string buildModule, string configSystem)
        {
            GroupName = groupName;
        ...
        {
            string[] completeFilesetNames = new string[]
            {
                GroupName + "." + DEFAULT_FILESET_NAME,
                GroupName + "." + DEFAULT_FILESET_NAME + "." + ConfigSystem
            };

            foreach (string completeFilesetName in completeFilesetNames)
            {
                if (!FileSetUtil.FileSetExists(Project, completeFilesetName)) continue;
