...
namespace EA.Eaconfig.Structured
{
    ...
    [ElementName("BuildTarget", StrictAttributeCheck = true)]
    public class BuildTargetElement : Element
    {
        ...
        [NAnt.Core.Attributes.Description("Sets the taget name")]
        ...
        [NAnt.Core.Attributes.Description("Sets the target")]
    ...
    [NAnt.Core.Attributes.Description("Create a dynamic target. This task is a Framework 2 feature")]
    [NAnt.Core.Attributes.XmlSchema]
    [ElementName("target")]
    public class TargetElement : Element {
        ...
        [NAnt.Core.Attributes.Description("A space seperated list of target names that this target depends on")]
        ...
        [NAnt.Core.Attributes.Description("The Target description.")]
        ...
        [NAnt.Core.Attributes.Description("If true then the target will be executed; otherwise skipped. Default is \"true\"")]
        [TaskAttribute("if")]
        ...
        [NAnt.Core.Attributes.Description("Prevents the target from being listed in the projecthelp. Default is true")]
        ...
        [NAnt.Core.Attributes.Description("Style can be 'use', 'build', or 'clean'.   See 'Auto Build Clean'")]
        [TaskAttribute("style")]
        public string Style 
        {
            get { return _style; }
        ...
        [NAnt.Core.Attributes.Description("Opposite of if.  If false then the target will be executed; otherwise skipped. Default is \"false\".")]
