...
namespace EA.Eaconfig
{
    ...
    public class GenerateOptions : EAConfigTask
    {
        ...
        private void Options_SN()
        {
            ...
            switch (ConfigSystem)
            {
                case "ps3":
                    ...
                    // exceptions is off by default for ps3, and the ps3 proxy/non-proxy use this link.librarydirs:
                    // ${package.${ps3sdk}.appdir}/target/ppu/lib/fno-exceptions/fno-rtti
                    // ${package.${ps3sdk}.appdir}/target/ppu/lib
        ...
        private void Options_VC()
        {
            ...
            PrependOptionIf("warnings", "on", OptionType.cc_Options, "-W4");    // Set maximum warning level
            ...
            switch (ConfigSystem)
            {
                ...
                case "xbox":
                    ...
                    // ----- GENERAL OPTIONS ----- 
                    AddOptionIf("misc", "on", OptionType.cc_Options, "-arch:SSE");        // Enable Streaming SIMD Extensions (7.1 feature)                        
