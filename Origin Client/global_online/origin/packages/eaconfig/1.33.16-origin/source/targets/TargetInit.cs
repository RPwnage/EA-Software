...
namespace EA.Eaconfig
{
    ...
    public class TargetInit : EAConfigTask
    {
        ...
        static TargetInit()
        {
            ...
            TargetDefaults.Options["eaconfig-build"]    = "include" ;
            TargetDefaults.Options["buildall"]          = "include" ;
            TargetDefaults.Options["build-common-createbuilddependencies"] = "include" ;
            ...
            TargetDefaults.Options["build-res"]         = "include" ;
            ...
            TargetDefaults.Options["deploy"]            = "exclude" ;
            TargetDefaults.Options["run"]               = "exclude" ;
            TargetDefaults.Options["runall"]            = "exclude" ;
            TargetDefaults.Options["run-fast"]          = "exclude" ;
            ...
            TargetDefaults.Options["dobby-reports"]             = "exclude" ;
            ...
            TargetDefaults.Options["example-runall"]            = "exclude" ;
            TargetDefaults.Options["example-run-fast"]          = "exclude" ;
            TargetDefaults.Options["example-deploy"]            = "include" ;
            ...
            TargetDefaults.Options["test-run-fast"]             = "exclude" ;
            TargetDefaults.Options["test-runall-fast"]          = "exclude" ;
            TargetDefaults.Options["test-deploy"]               = "include" ;
            ...
            TargetDefaults.Options["tool-run-fast"]             = "exclude" ;
            TargetDefaults.Options["tool-deploy"]               = "exclude" ;
        ...
        protected override void ExecuteTask()
        {
            ...
            OptionSet targetoverrides = Project.NamedOptionSets["config.targetoverrides"];
            if(targetoverrides !=  null)
            {
                foreach(DictionaryEntry entry in targetoverrides.Options)
                {
                    ...
                    if(!String.IsNullOrEmpty(name))
                    {
                        if(targets.Options.Contains(name))
                        {
                            if(targets.Options[name] == value)
                            {
                              Log.WriteLineIf(Verbose,
                                  "Warning[{0}-{1}: The value for '{2}' in 'config.targetoverrides' is the same as the eaconfig default and thus can be removed!", 
                        ...
                        {
                              Log.WriteLine("Warning[{0}-{1}: Invalid target name '{2}' in 'config.targetoverrides'!", PackageName, PackageVersion, name);
                        }
                    }
                }
            }
