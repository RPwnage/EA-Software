...
namespace EA.Eaconfig
{
    ...
    [TaskName("unix-clang-generate-options")]
    public class Unix_Clang_GenerateOptions : Unix_Common_Options
    {
    }

    [TaskName("unix64-clang-generate-options")]
    public class Unix64_Clang_GenerateOptions : Unix_Common_Options
    {
    }
    ...
    public class Unix_Common_Options : GeneratePlatformOptions
    {
        ...
        {
            // Even though this is the clang configuration file we still set common GCC options. This includes
            // warning settings (ie: -Wextra, -Wno-deprecated-declarations) that clang and GCC have in common.
            Common_GCC_Options();
