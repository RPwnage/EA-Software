...
@REM =====================================================================================================================================================================
cd %CODESTRIPPER%
call %NANT_EXE% -masterconfigfile:%MASTERCONFIG% -D:codestripper_packages=EABase,EATest,EASTL -D:codestripper_platforms=pc,android,iphone,osx -D:codestripper_includesource=true -D:codestripper_outputdir=%STRIPPED%
