...
@SET EASTL_DIR=%OPENSOURCE%\eastl_ps4
...
@REM =====================================================================================================================================================================
cd %CODESTRIPPER%
call %NANT_EXE% -masterconfigfile:%MASTERCONFIG% -D:codestripper_packages=EABase,EATest,EASTL -D:codestripper_platforms=pc,android,iphone,osx,kettle -D:codestripper_includesource=true -D:codestripper_outputdir=%STRIPPED%
...
dir /s/b | grep -irn "xenon" * 
dir /s/b | grep -irn "xboxone" *
REM  dir /s/b | grep -irn "kettle" *
dir /s/b | grep -irn "capilano" *
dir /s/b | grep -irn "durango" *
...
@REM =====================================================================================================================================================================
"C:\Program Files\7-Zip\7z.exe" a -tzip ../eastl_sony.zip .
