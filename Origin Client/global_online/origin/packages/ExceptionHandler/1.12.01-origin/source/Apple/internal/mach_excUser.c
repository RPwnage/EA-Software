...
mig_external kern_return_t mach_exception_raise_ea
(
...
#pragma pack()
	...
	__DeclareSendRpc(2405, "mach_exception_raise_ea")
	...
	__BeforeSendRpc(2405, "mach_exception_raise_ea")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(2405, "mach_exception_raise_ea")
...
mig_external kern_return_t mach_exception_raise_state_ea
(
	mach_port_t exception_port,
	exception_type_t exception,
...
#pragma pack()
	...
	__DeclareSendRpc(2406, "mach_exception_raise_state_ea")
	...
	__BeforeSendRpc(2406, "mach_exception_raise_state_ea")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(2406, "mach_exception_raise_state_ea")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
...
mig_external kern_return_t mach_exception_raise_state_identity_ea
(
	mach_port_t exception_port,
	mach_port_t thread,
	mach_port_t task,
...
#pragma pack()
	...
	__DeclareSendRpc(2407, "mach_exception_raise_state_identity_ea")
	...
	__BeforeSendRpc(2407, "mach_exception_raise_state_identity_ea")
	msg_result = mach_msg(&InP->Head, MACH_SEND_MSG|MACH_RCV_MSG|MACH_MSG_OPTION_NONE, msgh_size, (mach_msg_size_t)sizeof(Reply), InP->Head.msgh_reply_port, MACH_MSG_TIMEOUT_NONE, MACH_PORT_NULL);
	__AfterSendRpc(2407, "mach_exception_raise_state_identity_ea")
	if (msg_result != MACH_MSG_SUCCESS) {
		__MachMsgErrorWithoutTimeout(msg_result);
		{ return msg_result; }
	}
