...
extern
#endif	/* mig_external */
kern_return_t mach_exception_raise_ea
(
...
extern
#endif	/* mig_external */
kern_return_t mach_exception_raise_state_ea
(
	mach_port_t exception_port,
	exception_type_t exception,
...
extern
#endif	/* mig_external */
kern_return_t mach_exception_raise_state_identity_ea
(
	mach_port_t exception_port,
	mach_port_t thread,
	mach_port_t task,
...
#define subsystem_to_name_map_mach_exc \
    { "mach_exception_raise_ea", 2405 },\
    { "mach_exception_raise_state_ea", 2406 },\
    { "mach_exception_raise_state_identity_ea", 2407 }
#endif
...
/* Copied by Paul Pedriana from mach_excServer.c */
#ifdef	mig_external
mig_external
#else
extern
