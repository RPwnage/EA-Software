/*
 * IDENTIFICATION:
 * stub generated Sat Apr 28 18:39:49 2012
...
/* Routine mach_exception_raise_ea */
#ifdef	mig_external
mig_external
#else
extern
#endif	/* mig_external */
kern_return_t catch_mach_exception_raise_ea
(
...
#pragma pack()
	...
	__DeclareRcvRpc(2405, "mach_exception_raise_ea")
	__BeforeRcvRpc(2405, "mach_exception_raise_ea")
	...
	OutP->RetCode = catch_mach_exception_raise_ea(In0P->Head.msgh_request_port, In0P->thread.name, In0P->task.name, In0P->exception, In0P->code, In0P->codeCnt);

	OutP->NDR = NDR_record;


	__AfterRcvRpc(2405, "mach_exception_raise_ea")
}
...
/* Routine mach_exception_raise_state_ea */
#ifdef	mig_external
mig_external
#else
extern
#endif	/* mig_external */
kern_return_t catch_mach_exception_raise_state_ea
(
	mach_port_t exception_port,
	exception_type_t exception,
...
#pragma pack()
	...
	__DeclareRcvRpc(2406, "mach_exception_raise_state_ea")
	__BeforeRcvRpc(2406, "mach_exception_raise_state_ea")
	...
	OutP->RetCode = catch_mach_exception_raise_state_ea(In0P->Head.msgh_request_port, In0P->exception, In0P->code, In0P->codeCnt, &In1P->flavor, In1P->old_state, In1P->old_stateCnt, OutP->new_state, &OutP->new_stateCnt);
	...
	__AfterRcvRpc(2406, "mach_exception_raise_state_ea")
}
...
/* Routine mach_exception_raise_state_identity_ea */
#ifdef	mig_external
mig_external
#else
extern
#endif	/* mig_external */
kern_return_t catch_mach_exception_raise_state_identity_ea
(
	mach_port_t exception_port,
	mach_port_t thread,
	mach_port_t task,
...
#pragma pack()
	...
	__DeclareRcvRpc(2407, "mach_exception_raise_state_identity_ea")
	__BeforeRcvRpc(2407, "mach_exception_raise_state_identity_ea")
	...
	OutP->RetCode = catch_mach_exception_raise_state_identity_ea(In0P->Head.msgh_request_port, In0P->thread.name, In0P->task.name, In0P->exception, In0P->code, In0P->codeCnt, &In1P->flavor, In1P->old_state, In1P->old_stateCnt, OutP->new_state, &OutP->new_stateCnt);
	if (OutP->RetCode != KERN_SUCCESS) {
		MIG_RETURN_ERROR(OutP, OutP->RetCode);
	}
	...
	__AfterRcvRpc(2407, "mach_exception_raise_state_identity_ea")
}
...
mig_external boolean_t mach_exc_server_ea
	(mach_msg_header_t *InHeadP, mach_msg_header_t *OutHeadP)
{
	/*
	 * typedef struct {
