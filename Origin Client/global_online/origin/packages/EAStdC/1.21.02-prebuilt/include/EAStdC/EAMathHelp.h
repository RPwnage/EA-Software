...
// Written by Avery Lee and Alec Miller
//
...
namespace StdC
{
	...
	inline bool IsNormal(float32_t fValue) {
		...
		return !(converter.i & ~kFloat32SignMask) || ((converter.i - kFloat32LowestExponentBit) & kFloat32ExponentMask) < (kFloat32ExponentMask - kFloat32LowestExponentBit);
	}
	...
	inline bool IsNormal(float64_t fValue) {
		...
		return !(converter.i & ~kFloat64SignMask) || ((converter.i - kFloat64LowestExponentBit) & kFloat64ExponentMask) < (kFloat64ExponentMask - kFloat64LowestExponentBit);
	}
	...
	#include <EAStdC/Xenon/EAMathHelpXenon.inl>
#elif defined(EA_PLATFORM_MICROSOFT)
	#include <EAStdC/Win32/EAMathHelpWin32.inl>
#elif defined(EA_PLATFORM_PS3)
	#include <EAStdC/PS3/EAMathHelpPS3.inl>
#else
