...
///////////////////////////////////////////////////////////////////////////////
	...
	#define EASTDC_VERSION   "1.21.02"
	#define EASTDC_VERSION_N  12102
#endif
...
//
	...
	#if defined(EA_PLATFORM_PS3_SPU) // Defines platforms that can't create threads.
...
//
	...
	#if defined(EA_PLATFORM_POSIX) || defined(__APPLE__) || defined(EA_PLATFORM_PS3)
