...
#ifndef EAJSON_BSONDOMWRITER_H
#define EAJSON_BSONDOMWRITER_H


#include <EAJson/internal/Config.h>
#include <EAJson/BsonDomReader.h>
#include <EAJson/BsonWriter.h>
...
namespace EA
{
    namespace Json
    {
        ...
        class EAJSON_API BsonDomWriter : public IJsonDomReaderCallback
        {
        public:
            BsonDomWriter();
