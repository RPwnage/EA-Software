...
namespace NAnt.DotNetTasks {
    ...
    public class AlTask : ExternalProgramBase {
        ...
        protected virtual bool NeedsCompiling() {
            ...
            if (fileName != null) {
                Log.Info.WriteLine(LogPrefix + "{0} is out of date.", fileName);
                return true;
            }
        ...
        protected override void ExecuteTask() {
            if (NeedsCompiling()) {
                ...
                try {
                    ...
                    Log.Status.WriteLine(LogPrefix + "Compiling {0} files to {1}", Sources.FileItems.Count, GetOutputPath());
                    ...
                    foreach (FileItem fileItem in Sources.FileItems) {
                        writer.Write (" /embed:\"{0}\"", fileItem.FileName);
                    }
