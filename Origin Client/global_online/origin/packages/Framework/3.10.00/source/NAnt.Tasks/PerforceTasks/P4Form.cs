...
namespace NAnt.PerforceTasks	//	TODO: Replace 'PerforceTasks' with your namespace. 
{
    ...
    public class P4Form
    {
        ...
        private string form = String.Empty;	//	Holds the form to operate on.
        private int timeOut = Int32.MaxValue;
        private string workDir = String.Empty;
        private string progName = "p4.exe";
        ...
        private void DoP4Command(string commandLine, bool redirect)
        {
            ...
            try
            {
                ...
                //	Start the stdout and stderr capture threads.
                ThreadStart myStdOutDelegate = new ThreadStart(StdOut);
                ThreadStart myStdErrDelegate = new ThreadStart(StdErr);
                Thread stdOutThread = new Thread(myStdOutDelegate);
                Thread stdErrThread = new Thread(myStdErrDelegate);
                ...
                ThreadRunner.Instance.ThreadDispose(stdOutThread);
                ThreadRunner.Instance.ThreadDispose(stdErrThread);
