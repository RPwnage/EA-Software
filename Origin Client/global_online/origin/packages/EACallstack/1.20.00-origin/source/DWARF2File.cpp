...
// GetBaseAddress
//
uint64_t DWARF2File::GetBaseAddress() const
{
    return mBaseAddress;
}
...
int DWARF2File::GetAddressRepSpawn(int addressRepTypeFlags, uint64_t nAddress, FixedString* pRepArray, int* pIntValueArray)
{
    int returnFlags = 0;
        ...
        if(pPS4RootPath)
        {
            ...
            EA::StdC::Strlcat(elfReaderFilePath[kAddr2LineTypePS4], L"host_tools\\bin\\orbis-addr2line.exe", EA::IO::kMaxPathLength);
        }

        // See if the user has PS3 tools installed on their system. Nearly all PS3 programmers do.
        //    SCE_PS3_ROOT=C:/packages/ps3sdk/440.001/installed/cell
        //    C:\packages\ps3sdk\440.001\installed\cell\host-win32\ppu\bin\ppu-lv2-addr2line.exe
        ...
        if(pPS3RootPath)
        {
            ...
            if(elfReaderFilePath[kAddr2LineTypePPU][length] != '\\')
            {
                ...
                elfReaderFilePath[kAddr2LineTypePPU][length]   = '\0';
            }
            ...
            if(elfReaderFilePath[kAddr2LineTypeSPU][length] != '\\')
            {
                ...
                elfReaderFilePath[kAddr2LineTypeSPU][length]   = '\0';
            }
