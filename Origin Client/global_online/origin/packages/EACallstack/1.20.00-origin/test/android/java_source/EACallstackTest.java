...
package com.ea.EACallstackTest;
...
public class EACallstackTest extends Activity {
    @Override
    public void onCreate(Bundle savedInstanceState) {
        ...
        int ret = runEntryPoint(fileRoot.getAbsolutePath(), externalRoot.getAbsolutePath() + "/com.ea.EACallstackTest");
        setResult(ret);
    ...
    static {
        System.loadLibrary("EACallstackTest");
    }
}
