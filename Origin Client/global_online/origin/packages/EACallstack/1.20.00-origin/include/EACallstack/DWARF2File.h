...
#ifndef EACALLSTACK_DWARF2FILE_H
#define EACALLSTACK_DWARF2FILE_H
...
namespace EA
{
    namespace Callstack
    {
        ...
        /// DwarfForm
        /// See the DWARF2 Standard, section 7.5.4
        enum DwarfForm
        {
            DW_FORM_NONE      = 0x00,
            DW_FORM_ADDR      = 0x01,
        ...
        // DwarfAttribute
        // See the DWARF2 Standard, section 7.5.4 for a table of each of these.
        // See the DWARF2 Standard, section 3.1.1 for a further description of some of these.
        //
        ...
        ///
        class EACALLSTACK_API DWARF2SectionReader : public IO::MemoryStream
        {
        public:
            DWARF2SectionReader();
        ...
        ///
        /// See the DWARF2 Standard, section 7.5.1 and 7.20.
        ///
        class CompUnitReader : public DWARF2SectionReader
        {
        public:
            static const int kHeaderSize = 12;

            bool Init(DWARF2File*);
        ...
        /// ".debug_info" section.
        ///
        /// See the DWARF2 Standard, section 6.1.2 and 7.5.4.
        ///
        class InfoSectionReader : public DWARF2SectionReader
        {
        public:
            bool Init             (DWARF2File*);
        ...
        ///
        /// See the DWARF2 Standard, sec 7.5.3.
        ///
        class EACALLSTACK_API AbbrevSectionReader : public DWARF2SectionReader
        {
        public:
            bool Init(DWARF2File*, InfoSectionReader*, bool bCacheEntries, EA::Allocator::ICoreAllocator* pAllocator);
        ...
        /// Line number information in DWARF2 is conceptually stored in a matrix, with a row
        ...
        ///
        /// See the DWARF2 specification, sec 6.2, p 50.
        ///
        class EACALLSTACK_API LineSectionReader : public DWARF2SectionReader
        {
        public:
            bool Init(DWARF2File*, AbbrevSectionEntry* pAbbrevSectionEntry);
        ...
        /// DWARF2File
        ///
        /// Implements the IAddressRepLookup interface for DWARF2 records in a .elf file.
        /// DWARF2 records are the debug info records for binary executables found in .elf files.
        /// The GCC3 (and later) and CodeWarrior compilers use DWARF2 information to store debug info.
        ///
        class EACALLSTACK_API DWARF2File : public IAddressRepLookup
        {
        public:
            /// kTypeId
            ...
            /// such as IAddressRepLookup to a subclass such as DWARF2File.
            static const int kTypeId = 0x061b670f; // This is just some unique value.

            DWARF2File(EA::Allocator::ICoreAllocator* pCoreAllocator = NULL);
           ~DWARF2File();

            void SetAllocator(EA::Allocator::ICoreAllocator* pCoreAllocator);

            bool Init(const wchar_t* pDWARF2FilePath, bool bDelayLoad = true);
            bool Shutdown();
        ...
        public:
            ...
            bool GetFunctionName(const AbbrevSectionEntry* pAbbrevSectionEntry, FixedString* pFunctionNameOut);
