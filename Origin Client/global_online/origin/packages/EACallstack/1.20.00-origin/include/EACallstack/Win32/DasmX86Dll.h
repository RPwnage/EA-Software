...
// DasmX86Dll.h
//
// This header is based on the libdisasm header file called libdis.h. We echo
// the same definitions but make a Windows DLL-exportable wrapper for them.
//
///////////////////////////////////////////////////////////////////////////////
...
//
// 
// #include "DasmX86Dll.h"
// #include <stdio.h>
// 
// int main(int, char**)
// {
//     unsigned char data[1024]; // Assume this is filled with instructions
// 
//     DasmX86_init(opt_none, NULL, NULL);
// 
//     for(int pos = 0; pos < sizeof(data); )
//     {
//         x86_insn_t insn;
//         char       str[512];
// 
//         const int instructionSize = DasmX86_disasm(data, sizeof(data), 0, pos, &insn);
// 
//         if(instructionSize)
//         {
//             DasmX86_format_insn(&insn, str, sizeof(str), intel_syntax);
//             printf("%s\n", str);
//             pos += instructionSize;
//         }
//         else
...
// from a DLL simpler. All files within this DLL are compiled with the DASMX86DLL_EXPORTS
// symbol defined on the command line. This symbol should not be defined on any project
// that uses this DLL. This way any other project whose source files include this file see 
// DASMX86DLL_API functions as being imported from a DLL, whereas this DLL sees symbols
// defined with this macro as being exported.

#ifdef DASMX86DLL_EXPORTS
    #define DASMX86DLL_API __declspec(dllexport)
#else
    #define DASMX86DLL_API __declspec(dllimport)
#endif
...
typedef void (*DISASM_REPORTER)( enum x86_report_codes code, void *data, void *arg );



/* x86_report_error : Call the register reporter to report an error */
DASMX86DLL_API void DasmX86_report_error( enum x86_report_codes code, void *data );
...
DASMX86DLL_API int              DasmX86_init( enum x86_options options, DISASM_REPORTER reporter, void *arg);
DASMX86DLL_API void             DasmX86_set_reporter( DISASM_REPORTER reporter, void *arg);
DASMX86DLL_API void             DasmX86_set_options( enum x86_options options );
DASMX86DLL_API enum x86_options DasmX86_get_options( void );
DASMX86DLL_API int              DasmX86_cleanup(void);
...
typedef struct {
    ...
    union {
        ...
        unsigned long  off32;    /* loaded directly into EIP */
    } offset;    
} x86_absolute_t;
...
typedef struct {
    ...
    union {
        ...
        unsigned short  word;
        unsigned long   dword;
        //qword           qword;  // This was in the original libdisasm but is bad code.
        float           sreal;
        double          dreal;
...
DASMX86DLL_API int DasmX86_insn_is_valid( x86_insn_t *insn );
 ...
 *      should be returned. */
typedef long (*DISASM_RESOLVER)( x86_op_t *op, x86_insn_t * current_insn, void *arg );
 ...
 */
DASMX86DLL_API unsigned int DasmX86_disasm( unsigned char *buf, unsigned int buf_len,
 ...
 */
DASMX86DLL_API unsigned int DasmX86_disasm_range( unsigned char *buf, unsigned long buf_rva,
 ...
 */
DASMX86DLL_API unsigned int DasmX86_disasm_forward( unsigned char *buf, unsigned int buf_len,
                                                    unsigned long buf_rva, unsigned int offset,
                                                    DISASM_CALLBACK func, void *arg,
...
void DasmX86_oplist_free( x86_insn_t *insn );
 ...
 * criteria. */
DASMX86DLL_API int DasmX86_operand_foreach( x86_insn_t *insn, x86_operand_fn func, void *arg, enum x86_op_foreach_type type);


/* convenience routine: returns count of operands matching 'type' */
DASMX86DLL_API size_t DasmX86_operand_count( x86_insn_t *insn, enum x86_op_foreach_type type );


/* accessor functions for the operands */
DASMX86DLL_API x86_op_t * DasmX86_operand_1st( x86_insn_t *insn );
DASMX86DLL_API x86_op_t * DasmX86_operand_2nd( x86_insn_t *insn );
DASMX86DLL_API x86_op_t * DasmX86_operand_3rd( x86_insn_t *insn );



/* get size of operand data in bytes */
DASMX86DLL_API unsigned int DasmX86_operand_size( x86_op_t *op );
...
DASMX86DLL_API unsigned long DasmX86_get_address( x86_insn_t *insn );
...
DASMX86DLL_API long DasmX86_get_rel_offset( x86_insn_t *insn );
...
DASMX86DLL_API x86_op_t * DasmX86_get_branch_target( x86_insn_t *insn );
...
DASMX86DLL_API x86_op_t * DasmX86_get_imm( x86_insn_t *insn );
...
DASMX86DLL_API unsigned char * DasmX86_get_raw_imm( x86_insn_t *insn );



/* More accessor fuctions, this time for user-defined info... */
/* set the address (usually RVA) of the insn */
DASMX86DLL_API void DasmX86_set_insn_addr( x86_insn_t *insn, unsigned long addr );



/* set the offset (usually offset into file) of the insn */
DASMX86DLL_API void DasmX86_set_insn_offset( x86_insn_t *insn, unsigned int offset );
...
DASMX86DLL_API void DasmX86_set_insn_function( x86_insn_t *insn, void * func );
...
DASMX86DLL_API void DasmX86_set_insn_block( x86_insn_t *insn, void * block );
 ...
 * the tag field.*/ 
/* set insn->tag to 1 */
DASMX86DLL_API void DasmX86_tag_insn( x86_insn_t *insn );


/* set insn->tag to 0 */
DASMX86DLL_API void DasmX86_untag_insn( x86_insn_t *insn );


/* return insn->tag */
DASMX86DLL_API int DasmX86_insn_is_tagged( x86_insn_t *insn );
...
DASMX86DLL_API int DasmX86_format_operand(x86_op_t *op, char *buf, int len, enum x86_asm_format format);



/* format (sprintf) an instruction mnemonic into 'buf' using specified syntax */
DASMX86DLL_API int DasmX86_format_mnemonic(x86_insn_t *insn, char *buf, int len, enum x86_asm_format format);



/* format (sprintf) an instruction into 'buf' using specified syntax;
 * this includes formatting all operands */
DASMX86DLL_API int DasmX86_format_insn(x86_insn_t *insn, char *buf, int len, enum x86_asm_format);



/* fill 'buf' with a description of the format's syntax */
DASMX86DLL_API int DasmX86_format_header( char *buf, int len, enum x86_asm_format format);



/* Endianness of an x86 CPU : 0 is big, 1 is little; always returns 1 */
DASMX86DLL_API unsigned int DasmX86_endian(void);



/* Default address and operand size in bytes */
DASMX86DLL_API unsigned int DasmX86_addr_size(void);
DASMX86DLL_API unsigned int DasmX86_op_size(void);



/* Size of a machine word in bytes */
DASMX86DLL_API unsigned int DasmX86_word_size(void);



/* maximum size of a code instruction */
DASMX86DLL_API unsigned int DasmX86_max_insn_size(void);



/* register IDs of Stack, Frame, Instruction pointer and Flags register */
DASMX86DLL_API unsigned int DasmX86_sp_reg(void);
DASMX86DLL_API unsigned int DasmX86_fp_reg(void);
DASMX86DLL_API unsigned int DasmX86_ip_reg(void);
DASMX86DLL_API unsigned int DasmX86_flag_reg(void);



/* fill 'reg' struct with details of register 'id' */
DASMX86DLL_API void DasmX86_reg_from_id( unsigned int id, x86_reg_t * reg );
...
DASMX86DLL_API size_t DasmX86_invariant_disasm( unsigned char *buf, int buf_len, x86_invariant_t *inv );
...
DASMX86DLL_API size_t DasmX86_size_disasm( unsigned char *buf, unsigned int buf_len );
