...
namespace EA
{
    namespace Callstack
    {
        ...
        /// DLL has a module handle.
            ...
            typedef int32_t          ModuleHandle;  // sys_prx_id_t, from prx.h
        #elif defined(EA_PLATFORM_REVOLUTION)
            typedef RSOObjectHeader* ModuleHandle;  // RSOObjectHeader*, from rso.h
        ...
        struct EACALLSTACK_API AddressRepEntry
        {
            ...
            int       mARTCheckFlags : kARTCount; 
            int       mFunctionOffset: 12;
            int       mFileOffset    : 16;
        ...
        enum SymbolInfoType
        {
            ...
            kSymbolInfoTypeMapCW,       /// Used by CodeWarrior linker.
            kSymbolInfoTypeMapGHS,      /// Used by Green Hills Software linker.
            ...
            kSymbolInfoTypeDwarf2,      /// Used by GCC 3.x and later and by Metrowerks. Embedded in .elf files.
            kSymbolInfoTypeGHS,         /// Used by the Green Hills Software linker.
            kSymbolInfoTypeStabs        /// Used by GCC 2.x and earlier. Embedded in .elf files.
        };
        ...
        enum TargetOS
        {
            ...
            kTargetOSAndroid,
            kTargetOSPalm,          // Mobile Linux variant
            kTargetOSPlaybook,      // Blackberry Unix-like tablet.
        ...
        /// Returns the strlen of the copied path.
        ...
        /// stored in the .map or .pdb symbol file for the module.
        /// On PS3 or Wii, the name can also be the PRX or RSO name, which is usually
        /// the same as the file name, but not necessarily so.
        ...
        ///
        /// Returns the base address for the module (e.g. exe, dll, Wii RSO, PS3 PRX)
        ...
        ///     }
        /// 
        EACALLSTACK_API uint64_t GetModuleBaseAddressByHandle(ModuleHandle moduleHandle = 0);

        /// GetModuleBaseAddressByAddress
        ///
        /// Returns the base address for the module (e.g. exe, dll, Wii RSO, PS3 PRX)
        /// that has code at the given code location.
        /// This function is useful only when run live in a running application and 
        /// not in a tool or external application.
        ...
        ///     void DoSomething()
        ///     {
        ///         GetModuleBaseAddressByAddress(DoSomething);
        ///     }
        /// 
        ...
        public:
            ...
            ///
            /// Example usage:
            ///    DWARF2File* pDwarfLookup = (DWARF2File*)pAddressRepLookup->AsInterface(DWARF2File::kTypeId);
            ///    if(pDwarfLookup)
            ///        pDwarfLookup->Blah();
        ...
        public:
           ...
           ~AddressRepLookupSet();
            ...
            /// A variety of symbol database formats are supported, including PDB, DWARF2 (contained
