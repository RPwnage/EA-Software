...
enum OSABI
{
    ELFOSABI_NONE         =   0,    // UNIX System V ABI (Linux, PS3 SPU, and Wii also use this, so it's not very useful).
    ...
    ELFOSABI_ARM          =  97,    // ARM
    ELFOSABI_PS3          = 102,    // PlayStation 3 PPU. PS3 SPU ELFs use ELFOSABI_NONE, unfortunately.
