...
#pragma warning(disable: 4365) // conversion from 'eastl::deque<T,Allocator>::size_type' to 'eastl::DequeIterator<T,Pointer,Reference,kDequeSubarraySize>::difference_type', signed/unsigned mismatch
...
namespace EA
{
    namespace Callstack
    {
        ...
        public:
            ...
            static int RunToCompletionWithOutput(const char8_t*  pCommandString, int64_t responseTimeoutSeconds, int64_t unilateralTimeoutSeconds, EA::Callstack::CAString8& sOutput);
        ...
        protected:
            ...
            typedef eastl::deque<char8_t, EA::Callstack::EASTLCoreAllocator>                    Deque8;
            #else
            typedef eastl::basic_string<char8_t, EA::Callstack::EASTLCoreAllocator>             Deque8;
            #endif
            typedef eastl::basic_string<char8_t, EA::Callstack::EASTLCoreAllocator>             String8;
