...
typedef void (VoipConnectRecvTextCbT)(int32_t iConnId, int32_t iRemoteUserIndex, const wchar_t *pText, void *pUserData);
...
typedef struct VoipConnectionT
{
    ...
    uint8_t         uOutSeqNb;          //!< seq nb to be assigned to next outbound reliable data entry on this connection
...
typedef struct VoipConnectionlistT
{
    ...
    void            *pRegUserUserData;  //!< user data to be sent to callbacks
    VoipConnectRecvVoiceCbT *pVoiceCb;  //!< callback to call when voice data is received
    void            *pVoiceUserData;    //!< user data to be sent to callbacks
    VoipConnectRecvTextCbT  *pTextCb;   //!< callback to call when transcribed text is received
    void            *pTextUserData;     //!< user data to be sent to callbacks
