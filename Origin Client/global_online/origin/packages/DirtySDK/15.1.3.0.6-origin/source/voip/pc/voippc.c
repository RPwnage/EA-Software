...
VoipRefT *VoipStartup(int32_t iMaxPeers, int32_t iData)
{
    ...
    // common startup
    if ((pVoip = VoipCommonStartup(iMaxPeers, sizeof(*pVoip), _VoipMicDataCb, NULL, _VoipStatusCb, iData)) == NULL)
    {
        return(NULL);
    }
