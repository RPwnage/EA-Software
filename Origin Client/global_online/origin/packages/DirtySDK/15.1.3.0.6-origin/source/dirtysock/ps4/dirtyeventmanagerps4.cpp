...
int32_t _DirtyEventManagerInit(bool bCheckTick);
...
int32_t _DirtyEventManagerInit(bool bCheckTick)
{
    ...
    if ((bCheckTick) && (_pgSystemEventMessageDispatcher->HasTicked()))
    {
...
extern "C" int32_t DirtyEventManagerInit(uint8_t bCheckTick)
{
    return(_DirtyEventManagerInit(bCheckTick));
}
