...
#define PROTOSSL_VERSION_SSLv3      (0x0300)
...
#define PROTOSSL_CIPHER_RSA_WITH_AES_128_CBC_SHA256         (16)
#define PROTOSSL_CIPHER_RSA_WITH_AES_256_CBC_SHA256         (32)
#define PROTOSSL_CIPHER_RSA_WITH_AES_128_GCM_SHA256         (64)
#define PROTOSSL_CIPHER_RSA_WITH_AES_256_GCM_SHA384         (128)
#define PROTOSSL_CIPHER_ECDHE_RSA_WITH_AES_128_CBC_SHA256   (256)
#define PROTOSSL_CIPHER_ECDHE_RSA_WITH_AES_256_CBC_SHA384   (512)
#define PROTOSSL_CIPHER_ECDHE_RSA_WITH_AES_128_GCM_SHA256   (1024)
#define PROTOSSL_CIPHER_ECDHE_RSA_WITH_AES_256_GCM_SHA384   (2048)
#define PROTOSSL_CIPHER_ECDHE_RSA_WITH_AES_128_CBC_SHA      (4096)
#define PROTOSSL_CIPHER_ECDHE_RSA_WITH_AES_256_CBC_SHA      (8192)

//! all cipher suites
#define PROTOSSL_CIPHER_ALL (\
    PROTOSSL_CIPHER_RSA_WITH_RC4_128_SHA|PROTOSSL_CIPHER_RSA_WITH_RC4_128_MD5|\
    PROTOSSL_CIPHER_RSA_WITH_AES_128_CBC_SHA|PROTOSSL_CIPHER_RSA_WITH_AES_256_CBC_SHA|\
    PROTOSSL_CIPHER_RSA_WITH_AES_128_CBC_SHA256|PROTOSSL_CIPHER_RSA_WITH_AES_256_CBC_SHA256|\
    PROTOSSL_CIPHER_RSA_WITH_AES_128_GCM_SHA256|PROTOSSL_CIPHER_RSA_WITH_AES_256_GCM_SHA384)
