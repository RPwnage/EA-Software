...
#define PROTOHTTP_TIMEOUT   (-7)    //!< did not receive response from server in configured time
...
DIRTYCODE_API int32_t ProtoHttpRequestCb(ProtoHttpRefT *pState, const char *pUrl, const char *pData, int64_t iDataSize, ProtoHttpRequestTypeE eRequestType, ProtoHttpWriteCbT *pWriteCb, void *pWriteCbUserData);
