...
// create new module
DIRTYCODE_API ProtoPingRefT *ProtoPingCreate(int32_t iMaxPings);

// destroy the module
DIRTYCODE_API void ProtoPingDestroy(ProtoPingRefT *pProtoPing);

// change a ping state value
DIRTYCODE_API int32_t ProtoPingControl(ProtoPingRefT *pProtoPing, int32_t iControl, int32_t iValue, void *pValue);

// send a ping request
DIRTYCODE_API int32_t ProtoPingRequest(ProtoPingRefT *pProtoPing, DirtyAddrT *pAddr, const unsigned char *pData, int32_t iDataLen, int32_t iTimeout, int32_t iTtl);

// ping server
DIRTYCODE_API int32_t ProtoPingRequestServer(ProtoPingRefT *pProtoPing, uint32_t uServerAddress, const unsigned char *pData, int32_t iDataLen, int32_t iTimeout, int32_t iTtl);

// get latest ping response
DIRTYCODE_API int32_t ProtoPingResponse(ProtoPingRefT *pProtoPing, unsigned char *pBuffer, int32_t *pBufLen, ProtoPingResponseT *pResponse);
