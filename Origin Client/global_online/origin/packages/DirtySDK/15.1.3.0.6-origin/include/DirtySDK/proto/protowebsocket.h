...
DIRTYCODE_API ProtoWebSocketRefT *ProtoWebSocketAccept(ProtoWebSocketRefT *pWebSocket);

// start listening for an incoming connection
DIRTYCODE_API ProtoWebSocketRefT *ProtoWebSocketListen(ProtoWebSocketRefT *pWebSocket);
...
DIRTYCODE_API int32_t ProtoWebSocketConnect2(ProtoWebSocketRefT *pWebSocket, int32_t iUnused0, const char *pUrl, uint32_t uUnused1, int32_t iUnused2);
