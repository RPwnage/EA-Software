...
DIRTYCODE_API VoipGroupRefT *VoipGroupCreate(void);
...
DIRTYCODE_API void VoipGroupSetTranscribedTextReceivedCallback(VoipGroupRefT *pVoipGroup, VoipTranscribedTextReceivedCallbackT *pCallback, void *pUserData);
...
DIRTYCODE_API int32_t VoipGroupConnect(VoipGroupRefT *pVoipGroup, int32_t iConnID, uint32_t uAddress, uint32_t uManglePort, uint32_t uGamePort, uint32_t uClientID, uint32_t uSessionID);

// VoipConnect, through a VoipGroup
DIRTYCODE_API int32_t VoipGroupConnect2(VoipGroupRefT *pVoipGroup, int32_t iConnId, uint32_t uAddress, uint32_t uManglePort, uint32_t uGamePort, uint32_t uClientId, uint32_t uSessionId, uint8_t bIsConnectivityHosted, uint32_t uLowLevelConnectivityId);

// resume a connection that is in supended state at the voip group level
DIRTYCODE_API void VoipGroupResume(VoipGroupRefT *pVoipGroup, int32_t iConnId, uint32_t uAddress, uint32_t uManglePort, uint32_t uGamePort, uint32_t uClientId, uint32_t uSessionID);

// resume a connection that is in supended state at the voip group level
DIRTYCODE_API void VoipGroupResume2(VoipGroupRefT *pVoipGroup, int32_t iConnId, uint32_t uAddress, uint32_t uManglePort, uint32_t uGamePort, uint32_t uClientId, uint32_t uSessionId, uint8_t bIsConnectivityHosted);
