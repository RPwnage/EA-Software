...
// stream structure
typedef struct NetGameDistStreamT NetGameDistStreamT;
...
typedef int32_t (NetGameDistStreamSendProc)(NetGameDistStreamT *pStream, int32_t iSubchan, int32_t iKind, void *pBuffer, int32_t iLen);
...
typedef void (NetGameDistStreamRecvProc)(NetGameDistStreamT *pStream, int32_t iSubchan, int32_t iKind, void *pBuffer, int32_t iLen);

typedef struct NetGameDistStreamInpT
{
    char *pInpData;                 //!< private
    int32_t iInpSize;               //!< private
    int32_t iInpProg;               //!< private
    int32_t iInpKind;               //!< private
} NetGameDistStreamInpT;

//! structure to access network stream with
struct NetGameDistStreamT
{
    NetGameDistStreamT *pNext;      //!< private
    NetGameDistRefT *pClient;       //!< private
    ...
    NetGameDistStreamSendProc *Send;//!< public
    NetGameDistStreamRecvProc *Recv;//!< public
    ...
    NetGameDistStreamInpT *pInp;    //!< private
