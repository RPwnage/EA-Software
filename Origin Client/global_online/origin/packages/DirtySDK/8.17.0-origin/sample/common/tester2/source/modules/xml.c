...
static const unsigned char _CmdXml_strData1[] =
...
static const unsigned char _CmdXml_strData2[] =
...
static const unsigned char _CmdXml_strData3[] =
#if 0
...
int32_t CmdXml(ZContext *argz, int32_t argc, char *argv[])
{
    ...
    if (iIndex == 1)
    {
        XmlContentGetString(XmlFind(_CmdXml_strData1, (unsigned char *)"get-account-info-reply.email"), (unsigned char *)strData, sizeof(strData), (unsigned char *)"");
        ZPrintf("email=%s\n", strData);
    }
    if (iIndex == 2)
    {
        pXml = XmlFind(_CmdXml_strData2, (unsigned char *)"TOURNAMENT.MATCHES");
        ZPrintf("hit=%s\n", pXml);
    }
    if (iIndex == 3)
    {
        ...
        XmlContentGetString(XmlFind((unsigned char *)strBuffer, (unsigned char *)"TestFormat1.strText"), (unsigned char *)strData, sizeof(strData), (unsigned char *)"");
        ZPrintf("test1=%s\n", strData);
        
        XmlContentGetString(XmlFind((unsigned char *)strBuffer, (unsigned char *)"TestFormat2.strText"), (unsigned char *)strData, sizeof(strData), (unsigned char *)"");
        ZPrintf("test2=%s\n", strData);
    }
