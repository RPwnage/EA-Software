...
#define ROTL64(_x, _y)     _rotl64(_x, _y)
 ...
 #define MH3_LITTLE_ENDIAN (TRUE)
#else
 #define MH3_LITTLE_ENDIAN (FALSE)
#endif
...
*/
/********************************************************************************F*/
static MH3_FORCE_INLINE uint64_t _rotl64 (uint64_t x, int8_t r)
{
    return (x << r) | (x >> (64 - r));
}
#endif
...
void MurmurHash3Init(MurmurHash3T *pContext)
{
    ...
    // borrowed init vector from MD5 $$TODO: something better here?
