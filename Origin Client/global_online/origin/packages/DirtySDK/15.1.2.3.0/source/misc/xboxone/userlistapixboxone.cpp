...
*/
/*************************************************************************************************F*/
void _UserListApiGetPriorityTitle(IVectorView<PresenceDeviceRecord^>^ presenceDeviceRecordList, PresenceDeviceRecord^& refOutDeviceRecord, PresenceTitleRecord^& refOutTitleRecord)
{
