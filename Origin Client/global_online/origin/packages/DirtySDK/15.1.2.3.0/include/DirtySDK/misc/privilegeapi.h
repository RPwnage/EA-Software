...
// todo: when we can alter the api again we should name this PrivilegeApiPrivE to comply with coding standard
typedef enum PrivilegeApiPrivT
{
...
DIRTYCODE_API int32_t PrivilegeApiCheckPrivilegesAsync(PrivilegeApiRefT *pRef, int32_t iUserIndex, const PrivilegeApiPrivT *pPrivileges, int32_t iPrivilegeCount, int32_t *pHint);
...
DIRTYCODE_API int32_t PrivilegeApiCheckPrivilegesAsyncWithUi(PrivilegeApiRefT *pRef, int32_t iUserIndex, const PrivilegeApiPrivT *pPrivileges, int32_t iPrivilegeCount, int32_t *pHint, const char *pUiMessage);
