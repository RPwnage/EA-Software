...
/*!
    ...
    \Description
        The UserList module abstracts the 1st party friends, blocked, muted and
        recently met functionality.
*/
...
#define USERLISTAPI_USERID_MAXLEN           (128)
#define USERLISTAPI_FRIENDNAME_MAXLEN       (64)
#define USERLISTAPI_AVATAR_URL_MAXLEN       (255)
...
typedef struct UserListApiUserDataT
{
    ...
    UserListApiFiltersT   *pUserListFilters;                             // filters used for this query, first Party Specific
