...
// do nothing
    ...
    #if defined(EA_WINAPI_FAMILY) && ((EA_WINAPI_FAMILY == EA_WINAPI_FAMILY_APP) || (EA_WINAPI_FAMILY == EA_WINAPI_FAMILY_PHONE_APP))
    #define DIRTYCODE_WINRT     1
    #endif
    #if defined(EA_WINAPI_FAMILY) && (EA_WINAPI_FAMILY == EA_WINAPI_FAMILY_APP)
    #define DIRTYCODE_WINRT_ONLY     1
    #elif defined(EA_WINAPI_FAMILY) && (EA_WINAPI_FAMILY == EA_WINAPI_FAMILY_PHONE_APP)
...
/*** Functions *************************************C:\tcho_stream\DirtySDK\include\DirtySDK\platform.h*******************************/
...
DIRTYCODE_API struct tm *ds_plattimetotimems(struct tm *pTm, int32_t *iMsec);
