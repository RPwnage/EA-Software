...
#define TESTER_PLATFORM_PC                  (0)     //!< PC Platform
#define TESTER_PLATFORM_XENON               (1)     //!< XENON Platform
#define TESTER_PLATFORM_PS3                 (2)     //!< PS3 Platform
#define TESTER_PLATFORM_LINUX               (3)     //!< Linux Platform
...
#define TESTERCOMM_NUMCOMMANDS_DEFAULT      (256)   //!< number of possible input/output commands outstanding
#define TESTERCOMM_COMMANDSIZE_DEFAULT      (1024)  //!< max size of each command line
#define TESTERCOMM_ARGNUM_DEFAULT           (16)    //!< max number of arguments for each command line
...
typedef struct TesterCommDataT
{
    ...
    char strBuffer[TESTERCOMM_COMMANDSIZE_DEFAULT];   //!< command data pointer
} TesterCommDataT;
...
// testercomm_xenon method to attach to host
extern void TesterCommAttachXenon(TesterCommT *pState);
