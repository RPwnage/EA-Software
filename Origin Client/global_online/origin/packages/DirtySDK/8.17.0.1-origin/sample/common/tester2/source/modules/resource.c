...
extern void NetResourceCachePrint(NetResourceT *pState);
#endif
    ...
    if(argc >= 2)
    {
        ...
        else if ((strcmp(strCmd,"fetch") == 0) && (TesterResource.pNetResource) && (argc >= 4))
        {
            ...
            if(argc >= 5)
            {
                ...
                else if(stricmp(argv[4],"keepifpossible") == 0)
                {
                    #if RESOURCE_VERBOSE
        ...
        else if ((strcmp(strCmd,"fetchstring") == 0) && (TesterResource.pNetResource) && (argc >= 3))
        {
            ...
            if(argc >= 4)
            {
                ...
                else if(stricmp(argv[3],"keepifpossible") == 0)
                {
                    #if RESOURCE_VERBOSE
                    ZPrintf("Fetching with KEEPIFPOSSIBLE priority in cache.\n");
                    #endif
