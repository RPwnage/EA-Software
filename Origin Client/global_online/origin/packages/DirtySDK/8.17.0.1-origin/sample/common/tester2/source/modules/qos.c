...
/*!
    ...
    \Description
        Reference application for QoSApi.
...
static void _QosListen(void *pCmdRef, int32_t argc, char **argv, unsigned char bHelp);
static void _QosRequest(void *pCmdRef, int32_t argc, char **argv, unsigned char bHelp);
static void _QosServiceRequest(void *pCmdRef, int32_t argc, char **argv, unsigned char bHelp);
static void _QosCancelRequest(void *pCmdRef, int32_t argc, char **argv, unsigned char bHelp);
...
static void _QosGetNatType(void *pCmdRef, int32_t argc, char **argv, unsigned char bHelp);
...
static T2SubCmdT _Qos_Commands[] =
{
    ...
    { "listen",      _QosListen          },
    { "request",     _QosRequest         },
    { "service",     _QosServiceRequest  },
    { "cancel",      _QosCancelRequest   },
    { "control",     _QosControl         },
    { "status",      _QosStatus          },
    { "nattype",     _QosGetNatType      },
    { "",            NULL                }
};
...
/*!
    ...
    \Description
        Qos subcommand - create qosapi reference
...
static void _QosCreate(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    if (pApp->pQosApi != NULL)
    {
        ZPrintf("   %s: ref has already been created\n", argv[0]);
        return;
    }

    pApp->pQosApi = QosApiCreate(NULL, "", strtol(argv[2], NULL, 10));
}
...
/*!
    ...
    \Description
        Qos subcommand - destroy qosapi reference
...
/*!
    ...
    \Description
        Qos subcommand - start listening for QoS requests
...
static void _QosListen(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiListen(pApp->pQosApi, (uint8_t *)argv[2], (int32_t)strlen(argv[2]), 0, 0);
}


/*F*************************************************************************************/
/*!
    \Function _QosRequest
    
    \Description
        Qos subcommand - issue a QoS request
...
static void _QosRequest(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    uAddr = ProtoNameSync(argv[2], 5000);
    DirtyAddrFromHostAddr(&DirtyAddr, &uAddr);

    QosApiRequest(pApp->pQosApi, &DirtyAddr, strtol(argv[3], NULL, 10), 0, 1);
}


/*F*************************************************************************************/
/*!
    \Function _QosServiceRequest
...
static void _QosServiceRequest(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    if ((bHelp == TRUE) || (argc < 6))
    {
        ZPrintf("   usage: %s service [address] [probeport] [serviceid] [probes]\n", argv[0]);
        return;
    }

    QosApiServiceRequest(pApp->pQosApi, argv[2], strtol(argv[3], NULL, 10), strtol(argv[4], NULL, 16), strtol(argv[5], NULL, 10), 0, 0);
}


/*F*************************************************************************************/
/*!
    \Function _QosCancelRequest
    
    \Description
        Qos subcommand - cancel the specified QoS request
...
static void _QosCancelRequest(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiCancelRequest(pApp->pQosApi, strtol(argv[2], NULL, 10));
}
...
static void _QosControl(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiControl(pApp->pQosApi, iCtrl, strtol(argv[3], NULL, 10), argv[4]);
}
...
static void _QosStatus(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiStatus(pApp->pQosApi, iSelect, strtol(argv[3], NULL, 10), &strBuffer, sizeof(strBuffer));
}


/*F*************************************************************************************/
/*!
    \Function _QosGetNatType
    
    \Description
        Qos subcommand - get the nat type the client is behind
...
int32_t CmdQos(ZContext *argz, int32_t argc, char *argv[])
{
    ...
    if ((pCmd->pFunc != _QosCreate) && (pApp->pQosApi == NULL))
    {
