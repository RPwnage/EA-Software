...
#if (DIRTYCODE_PLATFORM == DIRTYCODE_PS3) || (DIRTYCODE_PLATFORM == DIRTYCODE_XENON)
int32_t CmdFriendApi(ZContext *argz, int32_t argc, char *argv[]);
#endif
#if DIRTYCODE_PLATFORM == DIRTYCODE_PS3
int32_t CmdGameData(ZContext *argz, int32_t argc, char *argv[]);
...
int32_t CmdMemoryCard(ZContext *argz, int32_t argc, char *argv[]);
...
#if (DIRTYCODE_PLATFORM == DIRTYCODE_PC) || (DIRTYCODE_PLATFORM == DIRTYCODE_PS3) || (DIRTYCODE_PLATFORM == DIRTYCODE_XENON)
int32_t CmdNetPrint(ZContext *argz, int32_t argc, char *argv[]);
#endif
