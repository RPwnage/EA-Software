...
struct ProtoSSLRefT
{
    ...
    uint8_t bCertInfoSet;
    uint8_t _pad;                   //!< TRUE if cert info has been set, else FALSE
};
...
// The 1024-bit modulus for an OTG CA with an exponent of 3
const static uint8_t _ProtoSSL_LobbyServerModulus3[] =
{
...
// The 1000-bit modulus for the RSA CA used to sign EA secure web-servers:
//   C=US, O=RSA Data Security, Inc., OU=Secure Server Certification Authority
// Full certificate can be found in certs/vsignss.pem in an OpenSSL distro
const static uint8_t _ProtoSSL_RSAServerModulus[] =
{
...
// The 1024-bit modulus for a GeoTrust Equifax Cert, used for some Pogo secure web-servers
const static uint8_t _ProtoSSL_EquifaxServerModulus[] =
{
   
};

// The 2048-bit modulus for a VeriSign Cert, used for some legacy Pogo secure web-servers
const static uint8_t _ProtoSSL_VeriSignServerModulus[] =
{
    
};
...
static ProtoSSLCACertT _ProtoSSL_CACerts[] =
{
    { { "US", "California", "Redwood City", "Electronic Arts, Inc.",
      ...
      128, _ProtoSSL_LobbyServerModulus3,
      1, { 0x03 },
      0, NULL, NULL, &_ProtoSSL_CACerts[1] },
    { { "US", "", "", "RSA Data Security, Inc.",
        "Secure Server Certification Authority", "" },
      125, _ProtoSSL_RSAServerModulus,
      3, { 0x01, 0x00, 0x01 },
      0, NULL, NULL, &_ProtoSSL_CACerts[2] },
    { { "US", "", "", "Equifax",
        "Equifax Secure Certificate Authority", "" },
      128, _ProtoSSL_EquifaxServerModulus,
      3, { 0x01, 0x00, 0x01 },
    ...
    else
    {
        ...
        for (pCACert = _ProtoSSL_CACerts; pCACert != NULL; pCACert = pCACert->pNext)
        {
            ...
            if (pCACert->pX509Cert != NULL)
            {
                ...
                {
                    if ((pState != NULL) && (pState->bCertInfoSet == FALSE))
                    {
                        memcpy(&pState->CertInfo.Ident, &pCACert->pX509Cert->Issuer, sizeof(pState->CertInfo.Ident));
...
static int32_t _ProtoSSLUpdateRecvServerCert(ProtoSSLRefT *pState, const uint8_t *pData)
{
    ...
    while (iSize1 > 3)
    {
        ...
        if ((iParse == 0) || (iSize1 == (iSize2 + 3)))
        {
            ...
            if ((iCertHeight != 0) && (iResult == ST3_RECV_HELLO))
            {
