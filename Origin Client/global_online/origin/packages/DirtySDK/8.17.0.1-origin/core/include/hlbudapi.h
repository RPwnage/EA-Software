...
typedef enum HLBMsgInjectE {
                    HLB_MSGINJECT_AS_ADMIN_MSG //ignore username, and set as from an admin i.e. ea_admin
 				} HLBMsgInjectE;
...
//! Set to 1 if on XBL, PS2 and NTSC cannot play each other, but, have same title id.
