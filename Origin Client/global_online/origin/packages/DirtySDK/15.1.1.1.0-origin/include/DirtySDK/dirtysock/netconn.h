...
//! to be used with NetConnNpMgrFuncSet()
typedef void (NetConnNpMgrCbT)(int32_t iEvent, int32_t iResult, void *pArg);
typedef int32_t (NetConnNpMgrCbRegT)(NetConnNpMgrCbT *pCb, void *pUserData);
typedef int32_t (NetConnNpMgrCbUnregT)(void);
#endif

#if defined(DIRTYCODE_PS3)
typedef void (NetConnSubSigninCallbackT)(uint32_t uSlot, int32_t iResult, void *pUserData);
#endif
...
DIRTYCODE_API typedef void (UserInfoCallbackT)(NetConnUserDataT *pUserDataT, void *pData);
...
#if defined(DIRTYCODE_PS3)
// tells netconn to use the supplied functions to register/unregister NP mgr event callback instead of the NP mgr api
DIRTYCODE_API void NetConnNpMgrFuncSet(NetConnNpMgrCbRegT *pNpMgrCbReg, NetConnNpMgrCbUnregT *pNpMgrCbUnreg);
#endif
