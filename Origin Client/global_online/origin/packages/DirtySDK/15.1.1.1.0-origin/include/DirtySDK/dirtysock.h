...
/*!
    ...
    \Section intro Introduction
        ...
        PC, PC64, PS3, PS4, WinPRT, Xbox 360, and Xbox One.
    ...
    - \link Friend      Friend      \endlink - Wrappers for 1st party Friend functionality on PS3 and Xbox 360
    ...
    | PS3          | 4.x           | present      |
    | PS4          | 13.3.x        | present      |
    | WinPRT       | 8.18.x        | present      |
    | WinRT        | 8.18.x        | present      |
    | Xbox 360     | 3.x           | present      |
    ...
    \Version 14.2.x     TBD         Deprecated Freebox
