...
DIRTYCODE_API typedef VoipCodecRefT *(VoipCodecCreateT)(int32_t iNumDecoders);

//! destroy function type
DIRTYCODE_API typedef void (VoipCodecDestroyT)(VoipCodecRefT *pState);

//! encode function type
DIRTYCODE_API typedef int32_t (VoipCodecEncodeT)(VoipCodecRefT *pState, uint8_t *pOutput, const int16_t *pInput, int32_t iNumSamples);

//! decode function type
DIRTYCODE_API typedef int32_t (VoipCodecDecodeT)(VoipCodecRefT *pState, int32_t *pOutput, const uint8_t *pInput, int32_t iInputBytes, int32_t iChannel);

//! reset function type
DIRTYCODE_API typedef void (VoipCodecResetT)(VoipCodecRefT *pState);

//! control function type
DIRTYCODE_API typedef int32_t (VoipCodecControlT)(VoipCodecRefT *pState, int32_t iSelect, int32_t iValue, int32_t iValue2, void *pValue);

//! status function type
DIRTYCODE_API typedef int32_t (VoipCodecStatusT)(VoipCodecRefT *pState, int32_t iSelect, int32_t iValue, void *pBuffer, int32_t iBufSize);
...
DIRTYCODE_API int32_t VoipCodecEncode(uint8_t *pOutput, const int16_t *pInput, int32_t iNumSamples);
