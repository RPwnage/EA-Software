...
#if DIRTYCODE_XENON
// return secure ip for specified xbox360 console
int32_t DirtySessionManagerGetSecureIp(DirtySessionManagerRefT *pRef, int32_t *pAddr, const char* pMachineAddress);
#endif
