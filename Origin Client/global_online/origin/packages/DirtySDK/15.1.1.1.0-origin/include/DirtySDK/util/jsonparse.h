...
// various helper functions that don't require a full parse

// seek the end of an item in a list
DIRTYCODE_API const char* JsonGetListItemEnd(const char *pList);

// see the start of the value of a key / value pair
DIRTYCODE_API const char* JsonSeekValue(const char *key);
