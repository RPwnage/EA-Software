...
#define NETGAME_QOS_DURATION_MIN (0)
#define NETGAME_QOS_DURATION_MAX (10000)
#define NETGAME_QOS_INTERVAL_MIN (10)
#define NETGAME_QOS_PACKETSIZE_MIN (50)
...
DIRTYCODE_API typedef int32_t (NetGameLinkStreamSendProc)(NetGameLinkStreamT *pStream, int32_t iSubchan, int32_t iKind, void *pBuffer, int32_t iLen);
//! dist stream recv proc
DIRTYCODE_API typedef void (NetGameLinkStreamRecvProc)(NetGameLinkStreamT *pStream, int32_t iSubchan, int32_t iKind, void *pBuffer, int32_t iLen);
...
DIRTYCODE_API NetGameLinkRefT *NetGameLinkCreate(void *comm, int32_t owner, int32_t buflen);

// destruct the game client
DIRTYCODE_API void NetGameLinkDestroy(NetGameLinkRefT *ref);

// register a callback function
DIRTYCODE_API void NetGameLinkCallback(NetGameLinkRefT *ref, void *calldata, void (*callproc)(void *calldata, int32_t kind));
...
DIRTYCODE_API int32_t NetGameLinkSend(NetGameLinkRefT *ref, NetGamePacketT *pkt, int32_t len);

// peek into the buffer
DIRTYCODE_API int32_t NetGameLinkPeek(NetGameLinkRefT *ref, NetGamePacketT **pkt);

// peek into the buffer for specific packet types
DIRTYCODE_API int32_t NetGameLinkPeek2(NetGameLinkRefT *ref, NetGamePacketT **pkt, uint32_t mask);

// outgoing packet stream to upper layer
DIRTYCODE_API int32_t NetGameLinkRecv(NetGameLinkRefT *ref, NetGamePacketT *buf, int32_t len, uint8_t bDist);

// same as NetGameLinkRecv, but takes a mask of which GAME_PACKET types we want
DIRTYCODE_API int32_t NetGameLinkRecv2(NetGameLinkRefT *ref, NetGamePacketT *buf, int32_t len, uint32_t mask);

// control behavior
DIRTYCODE_API int32_t NetGameLinkControl(NetGameLinkRefT *ref, int32_t iSelect, int32_t iValue, void *pValue);
