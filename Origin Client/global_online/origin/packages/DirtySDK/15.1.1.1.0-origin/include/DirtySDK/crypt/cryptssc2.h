...
DIRTYCODE_API void CryptSSC2Init(CryptSSC2T *pState, const unsigned char *pKey, int32_t iKey, int32_t iIter);

// apply the cipher to the target data
DIRTYCODE_API void CryptSSC2Apply(CryptSSC2T *pState, unsigned char *pData, int32_t iData);

// easy way to encode an asciiz string
DIRTYCODE_API int32_t CryptSSC2StringEncrypt(char *pDst, int32_t iLen, const char *pSrc, const unsigned char *pKey, int32_t iKey, int32_t iIter);

// easy way to encode an asciiz string
DIRTYCODE_API int32_t CryptSSC2StringDecrypt(char *pDst, int32_t iLen, const char *pSrc, const unsigned char *pKey, int32_t iKey, int32_t iIter);
