...
#if !defined(DIRTYCODE_XBOXONE) && !defined(DIRTYCODE_PC) && !defined(DIRTYCODE_XENON) && !defined(DIRTYCODE_WINRT)
...
#include <xtl.h>
// standard definitions not covered by xtl.h
#define SOCK_RAW 3              //!< raw protocol

#else // DIRTYCODE_PC or DIRTYCODE_XBOXONE or DIRTYCODE_XBOXONEADK
...
*/
#if defined(DIRTYCODE_XBOXONE) || defined(DIRTYCODE_PC) || defined(DIRTYCODE_XENON)
...
#define DIRTY_TOKEN_PASTE(a,b) a ## b
#define DIRTY_CONCATENATE_HELPER(a,b) DIRTY_TOKEN_PASTE(a,b)
...
DIRTYCODE_API typedef int32_t (SocketSendCallbackT)(SocketT *pSocket, int32_t iType, const uint8_t *pData, int32_t iDataSize, const struct sockaddr *pTo, void *pCallref);
