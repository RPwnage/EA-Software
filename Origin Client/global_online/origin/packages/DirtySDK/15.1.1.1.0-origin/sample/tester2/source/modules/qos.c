...
static void _QosCreate(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    pApp->pQosApi = QosApiCreate(NULL, "", (int32_t)strtol(argv[2], NULL, 10));
}
...
static void _QosServiceRequest(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiServiceRequest(pApp->pQosApi, argv[2], strtol(argv[3], NULL, 10), (uint32_t)strtol(argv[4], NULL, 16), (uint32_t)strtol(argv[5], NULL, 10), 0, 0);
}
...
static void _QosCancelRequest(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiCancelRequest(pApp->pQosApi, (int32_t)strtol(argv[2], NULL, 10));
}
...
static void _QosControl(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiControl(pApp->pQosApi, iCtrl, (int32_t)strtol(argv[3], NULL, 10), argv[4]);
}
...
static void _QosStatus(void *pCmdRef, int32_t argc, char *argv[], unsigned char bHelp)
{
    ...
    QosApiStatus(pApp->pQosApi, iSelect, (int32_t)strtol(argv[3], NULL, 10), &strBuffer, sizeof(strBuffer));
}
