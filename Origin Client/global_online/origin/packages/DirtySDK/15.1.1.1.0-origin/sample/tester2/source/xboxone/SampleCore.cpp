...
void SampleRenderer::Initialize()
{
    ...
    //On WinRT and Xone you need the dxgi factory to create the swap chain
...
void SampleRenderer::InitializePipeline()
{
    ...
    HRESULT num = D3DCompileFromFile(L"Tutorial05_PS.hlsl", NULL, NULL, "PS", "ps_4_0", D3DCOMPILE_ENABLE_STRICTNESS, 0, &pPixelShaderBlob, NULL);
