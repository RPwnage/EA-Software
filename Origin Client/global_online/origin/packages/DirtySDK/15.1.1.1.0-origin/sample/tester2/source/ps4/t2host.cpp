...
int main(int32_t argc, char *argv[])
{
    ...
    memset(&s_npTitleId, 0, sizeof(s_npTitleId));
    strncpy(s_npTitleId.id, "NPXX51027_00", strlen("NPXX51027_00"));
    memset(&s_npTitleSecret, 0, sizeof(s_npTitleSecret));
    memcpy(&s_npTitleSecret.data, aDirtySdkSampleSecret, SCE_NP_TITLE_SECRET_SIZE);
