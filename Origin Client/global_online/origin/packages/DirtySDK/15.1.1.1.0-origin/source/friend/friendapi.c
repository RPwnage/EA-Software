...
/*!
    ...
    \Input *pFriendApiRef   - module reference
    \Input *pVersion        - [out] pointer to buffer to be filled with version number (cannot be NULL)
...
*/
/********************************************************************************F*/
uint32_t FriendApiIsUserRealFriend(FriendApiRefT *pFriendApiRef, uint32_t uUserIndex, void *pUserId)
{
    return(FriendApiPrivIsUserRealFriend(pFriendApiRef, uUserIndex, pUserId));
}
