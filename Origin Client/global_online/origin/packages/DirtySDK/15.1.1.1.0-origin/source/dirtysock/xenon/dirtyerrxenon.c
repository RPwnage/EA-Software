...
static DirtyErrT _DirtyErr_List[] =
{
    ...
    */
    ...
    // XHTTP errors 12000+
    DIRTYSOCK_ErrorName(ERROR_XHTTP_TIMEOUT),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_INTERNAL_ERROR),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_UNRECOGNIZED_SCHEME),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_NAME_NOT_RESOLVED),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_INVALID_OPTION),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_OPTION_NOT_SETTABLE),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_INCORRECT_HANDLE_TYPE),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_INCORRECT_HANDLE_STATE),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_CONNECTION_ERROR),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_HEADER_NOT_FOUND),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_INVALID_SERVER_RESPONSE),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_REDIRECT_FAILED),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_NOT_INITIALIZED),
    DIRTYSOCK_ErrorName(ERROR_XHTTP_SECURE_FAILURE),
