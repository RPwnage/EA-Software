...
static DirtyErrT _DirtyErr_List[] =
{
    ...
    */
    ...
    // NP Trophy Utility errors
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_ALREADY_INITIALIZED),               // 0x80022901
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_NOT_INITIALIZED),                   // 0x80022902
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_NOT_SUPPORTED),                     // 0x80022903
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_CONTEXT_NOT_REGISTERED),            // 0x80022904
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_OUT_OF_MEMORY),                     // 0x80022905
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_ARGUMENT),                  // 0x80022906
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_EXCEEDS_MAX),                       // 0x80022907
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_MEMORY_CONTAINER),          // 0x80022908
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INSUFFICIENT),                      // 0x80022909
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNKNOWN_CONTEXT),                   // 0x8002290a
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_FORMAT),                    // 0x8002290b
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_BAD_RESPONSE),                      // 0x8002290c
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_GRADE),                     // 0x8002290d
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_CONTEXT),                   // 0x8002290e
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_PROCESSING_ABORTED),                // 0x8002290f
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_ABORT),                             // 0x80022910
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNKNOWN_HANDLE),                    // 0x80022911
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_LOCKED),                            // 0x80022912
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_HIDDEN),                            // 0x80022913
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_CANNOT_UNLOCK_PLATINUM),            // 0x80022914
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_ALREADY_UNLOCKED),                  // 0x80022915
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_TYPE),                      // 0x80022916
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_HANDLE),                    // 0x80022917
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_NP_COMM_ID),                // 0x80022918
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNKNOWN_NP_COMM_ID),                // 0x80022919
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_DISC_IO),                           // 0x8002291a
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_CONF_DOES_NOT_EXIST),               // 0x8002291b
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNSUPPORTED_FORMAT),                // 0x8002291c
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_ALREADY_INSTALLED),                 // 0x8002291d
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_BROKEN_DATA),                       // 0x8002291e
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_VERIFICATION_FAILURE),              // 0x8002291f
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_TROPHY_ID),                 // 0x80022920
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNKNOWN_TROPHY_ID),                 // 0x80022921
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNKNOWN_TITLE),                     // 0x80022922
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNKNOWN_FILE),                      // 0x80022923
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_DISC_NOT_MOUNTED),                  // 0x80022924
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_SHUTDOWN),                          // 0x80022925
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_TITLE_ICON_NOT_FOUND),              // 0x80022926
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_TROPHY_ICON_NOT_FOUND),             // 0x80022927
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INSUFFICIENT_DISK_SPACE),           // 0x80022928
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_INVALID_SIGNATURE),                 // 0x80022929
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_ILLEGAL_UPDATE),                    // 0x8002292a
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_SAVEDATA_USER_DOES_NOT_MATCH),      // 0x8002292b
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_TROPHY_ID_DOES_NOT_EXIST),          // 0x8002292c
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_SERVICE_UNAVAILABLE),               // 0x8002292d
    DIRTYSOCK_ErrorName(SCE_NP_TROPHY_ERROR_UNKNOWN),                           // 0x800229ff

    // NP Commerce2 error (0x80023000 - 0x800230ff)
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_NOT_INITIALIZED),                // 0x80023001
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_ALREADY_INITIALIZED),            // 0x80023002
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_ARGUMENT),               // 0x80023003
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_UNSUPPORTED_VERSION),            // 0x80023004
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_CTX_MAX),                        // 0x80023005
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_INDEX),                  // 0x80023006
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_SKUID),                  // 0x80023007
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_SKU_NUM),                // 0x80023008
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_MEMORY_CONTAINER),       // 0x80023009
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INSUFFICIENT_MEMORY_CONTAINER),  // 0x8002300a
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_OUT_OF_MEMORY),                  // 0x8002300b
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_CTX_NOT_FOUND),                  // 0x8002300c
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_CTXID_NOT_AVAILABLE),            // 0x8002300d
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_REQ_NOT_FOUND),                  // 0x8002300e
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_REQID_NOT_AVAILABLE),            // 0x8002300f
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_ABORTED),                        // 0x80023010
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_REQUEST_BUF_TOO_SMALL),          // 0x80023011
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_RESPONSE_BUF_TOO_SMALL),         // 0x80023012
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_COULD_NOT_RECV_WHOLE_RESPONSE_DATA),// 0x80023013
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_RESULT_DATA),            // 0x80023014
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_UNKNOWN),                        // 0x80023015
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_SERVER_MAINTENANCE),             // 0x80023016
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_SERVER_UNKNOWN),                 // 0x80023017
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INSUFFICIENT_BUF_SIZE),          // 0x80023018
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_REQ_MAX),                        // 0x80023019
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_TARGET_TYPE),            // 0x8002301a
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_TARGET_ID),              // 0x8002301b
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_INVALID_SIZE),                   // 0x8002301c
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_ERROR_DATA_NOT_FOUND),                 // 0x80023087

    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SC_ERROR_INVALID_RESPONSE),            // 0x800230e1

    // NP Commerce2 server error (0x80023100 - 0x800231ff)
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_BAD_REQUEST),             // 0x80023101
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_UNKNOWN_ERROR),           // 0x80023102
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_SESSION_EXPIRED),         // 0x80023105
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_ACCESS_PERMISSION_DENIED),// 0x80023107
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_NO_SUCH_CATEGORY),        // 0x80023110
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_NO_SUCH_PRODUCT),         // 0x80023111
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_NOT_ELIGIBILITY),         // 0x80023113
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_ACCOUNT_SUSPENDED1),      // 0x8002311b
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_ACCOUNT_SUSPENDED2),      // 0x8002311c
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_OVER_SPENDING_LIMIT),     // 0x80023120
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_INVALID_VOUCHER),         // 0x8002312f
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_VOUCHER_ALREADY_CONSUMED),// 0x80023130
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SERVER_ERROR_EXCEEDS_AGE_LIMIT_IN_BROWSING),// 0x80023139

    // NP Commerce2 system utility error (0x80024000 - 0x800240ff)
    DIRTYSOCK_ErrorName(SCE_NP_COMMERCE2_SYSTEM_UTIL_ERROR_INVALID_VOUCHER),    // 0x80024002
    ...
    DIRTYSOCK_ErrorName(SCE_NP_BASIC_ERROR_DOES_NOT_EXIST),                     // 0x8002a67b
    DIRTYSOCK_ErrorName(SCE_NP_BASIC_ERROR_INVALID),                            // 0x8002a67c
    DIRTYSOCK_ErrorName(SCE_NP_BASIC_ERROR_ABORT),                              // 0x8002a67d
    ...
    /* sysutil common errors */
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_INTERNAL),                      // 0x8002b000
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_COMMON),                        // 0x8002b100
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_SYSTEMPARAM),                   // 0x8002b200
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_MSGDIALOG),                     // 0x8002b300
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_SAVEDATA),                      // 0x8002b400
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_OSKDIALOG),                     // 0x8002b500
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_GAMEDATA),                      // 0x8002b600
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_AVC),                           // 0x8002b700
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_NETCTL),                        // 0x8002b800
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_WEBBROWSER),                    // 0x8002b900
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_HDDGAME),                       // 0x8002ba00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_SYSCONF),                       // 0x8002bb00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_SYSCACHE),                      // 0x8002bc00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_DISCGAME),                      // 0x8002bd00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_STORAGEDATA),                   // 0x8002be00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_IMEJP),                         // 0x8002bf00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_FILE_SELECT),                   // 0x8002c000
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_MUSIC),                         // 0x8002c100
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_PHOTO_EXPORT_UTIL),             // 0x8002c200
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_USERINFO),                      // 0x8002c300
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_PRINT),                         // 0x8002c400
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_REC),                           // 0x8002c500
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_MUSIC_EXPORT_UTIL),             // 0x8002c600
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_PHOTO_IMPORT),                  // 0x8002c700
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_SEARCH),                        // 0x8002c800
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_PHOTO_DECODE),                  // 0x8002c900
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_VIDEO_EXPORT_UTIL),             // 0x8002ca00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_GAME),                          // 0x8002cb00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_GAMEUPDATE),                    // 0x8002cc00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_AP),                            // 0x8002cd00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_BGDL),                          // 0x8002ce00
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_VIDEO_UPLOAD_UTIL),             // 0x8002d000
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_SCREENSHOT),                    // 0x8002d100
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_AUTHDIALOG),                    // 0x8002d200
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_BGMPLAYBACK_EX),                // 0x8002d300
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_SYSTEM_CHAT),                   // 0x8002d400
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BASE_PHOTO_NETWORK_SHARING),         // 0x8002d500

    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_TYPE),                               // 0x8002b101
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_VALUE),                              // 0x8002b102
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_SIZE),                               // 0x8002b103
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_NUM),                                // 0x8002b104
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_BUSY),                               // 0x8002b105
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_STATUS),                             // 0x8002b106
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_MEMORY),                             // 0x8002b107
    DIRTYSOCK_ErrorName(CELL_SYSUTIL_ERROR_3D_SUPPORT),                         // 0x8002b108
    ...
    */
    ...
    /*
     * error codes when loading and unloading modules
     */
    DIRTYSOCK_ErrorName(CELL_SYSMODULE_ERROR_UNKNOWN),  // 0x80012002 - Unknown PRX
    DIRTYSOCK_ErrorName(CELL_SYSMODULE_ERROR_UNLOADED), // 0x80012003 - PRX is not loaded
    DIRTYSOCK_ErrorName(CELL_SYSMODULE_ERROR_FATAL),    // 0x800120ff - Unexpected error (function call failed)
