...
DIRTYCODE_API void VoipSetDisplayTranscribedTextCallback(VoipRefT *pVoip, VoipDisplayTranscribedTextCallbackT *pCallback, void *pUserData);
...
DIRTYCODE_API void VoipDisconnect(VoipRefT *pVoip, int32_t iConnID, int32_t bSendDiscMsg);
