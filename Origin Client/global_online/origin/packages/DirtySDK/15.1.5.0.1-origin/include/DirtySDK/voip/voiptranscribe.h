...
#define VOIPTRANSCRIBE_PROFILE_IBMWATSON_HTTP_XFLOAT        VOIPTRANSCRIBE_PROFILE_CONSTRUCT(VOIPTRANSCRIBE_PROVIDER_IBMWATSON, VOIPTRANSCRIBE_FORMAT_XFLOAT, VOIPTRANSCRIBE_TRANSPORT_HTTP)
...
#define VOIPTRANSCRIBE_PROFILE_IBMWATSON_WEBSOCKETS_XFLOAT  VOIPTRANSCRIBE_PROFILE_CONSTRUCT(VOIPTRANSCRIBE_PROVIDER_IBMWATSON, VOIPTRANSCRIBE_FORMAT_XFLOAT, VOIPTRANSCRIBE_TRANSPORT_WEBSOCKETS)
// bing profiles
...
typedef enum VoipTranscribeFormatE
{
    ...
    VOIPTRANSCRIBE_FORMAT_XFLOAT,           //!< ORIGIN PATCH X Float Array
