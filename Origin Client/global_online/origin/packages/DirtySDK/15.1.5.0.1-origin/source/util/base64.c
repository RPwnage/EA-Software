...
*/
/*******************************************************************F*/
static int32_t _Base64Encode(const char *pInput, int32_t iInputLen, char *pOutput, int32_t iOutputLen, const char *pEncode)
{
    int32_t iInp, iOut;
...
{
    return(_Base64Encode(pInput, iInputLen, pOutput, iOutputLen, _Base64_strEncode));
}
...
{
    return(_Base64Encode(pInput, iInputLen, pOutput, iOutputLen, _Base64_strEncodeUrl));
}
