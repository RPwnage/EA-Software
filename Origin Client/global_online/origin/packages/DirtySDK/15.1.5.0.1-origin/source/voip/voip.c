...
/*F*************************************************************************************************/
/*!
    \Function VoipSetDisplayTranscribedTextCallback
...
*/
/*************************************************************************************************F*/
void VoipSetDisplayTranscribedTextCallback(VoipRefT *pVoip, VoipDisplayTranscribedTextCallbackT *pCallback, void *pUserData)
{
    VoipCommonRefT *pVoipCommon = (VoipCommonRefT *)pVoip;
...
*/
/********************************************************************************F*/
void VoipDisconnect(VoipRefT *pVoip, int32_t iConnID, int32_t bSendDiscMsg)
{
    VoipCommonRefT *pVoipCommon = (VoipCommonRefT *)pVoip;
...
{
#if defined(DIRTYCODE_PC) || defined(DIRTYCODE_PS4)
    VoipCommonRefT *pVoipCommon = (VoipCommonRefT *)pVoip;
