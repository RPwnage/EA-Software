...
void WebOfferGetAlert(WebOfferT *pOffer, WebOfferAlertT *pAlert);

// Extract the busy message for a web transfer
void WebOfferGetBusy(WebOfferT *pOffer, WebOfferBusyT *pBusy);

// Extract the busy message for a web transfer, providing a default message to use
void WebOfferGetBusy2(WebOfferT *pOffer, WebOfferBusyT *pBusy, char *strDefaultMessage);
