...
/*!
    \Moduledef Buddy Buddy

    \Description
        The Buddy module provides routines for interacting with a buddy server.

        <b>Overview</b>

        <b>Module Dependency Graph</b>
    
            <img alt="" src="buddy.png">
...
BuddyApiUserT  *BuddyApiUserFound(BuddyApiRefT *pState, int32_t item);
...
void BuddyApiPresExtra (BuddyApiRefT *pState, const char *strExtraPres);
