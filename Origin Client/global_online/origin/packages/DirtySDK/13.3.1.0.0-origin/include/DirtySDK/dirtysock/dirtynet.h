...
#if !defined(DIRTYCODE_PC) && !defined(DIRTYCODE_WINRT) && !defined(DIRTYCODE_WINPRT) && !defined(DIRTYCODE_XENON) && !defined(DIRTYCODE_PSP2)
...
#elif defined(DIRTYCODE_PSP2) || defined(DIRTYCODE_WINRT) || defined(DIRTYCODE_WINPRT)
