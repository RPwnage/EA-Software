...
*/
/********************************************************************************F*/
static int32_t _PrivilegeApiConvertToNativePriv(PrivilegeApiPrivT iPrivilege, uint32_t *pNativePrivilege, int32_t *pAdditionalChecksRequired)
{
...
int32_t PrivilegeApiCheckPrivilegesAsyncWithUi(PrivilegeApiRefT *pRef, int32_t iUserIndex, const PrivilegeApiPrivT *pPrivileges, int32_t iPrivilegeCount, int32_t *pHint, const char *pUiMessage)
{
    ...
    if (refPrivileges->Size != 0)
    {
        ...
        {
            NetPrintf(("privilegeapixboxone: an exception was caught attempting to check privileges, code 0x%08x.\n", e->HResult));
