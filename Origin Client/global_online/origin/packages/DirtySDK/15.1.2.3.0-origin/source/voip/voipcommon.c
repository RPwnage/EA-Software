...
static void _VoipCommonComputeDefaultSharedChannelConfig(VoipCommonRefT *pVoipCommon)
{
    ...
    memset(&pVoipCommon->iDefaultSharedChannels, 0, sizeof(pVoipCommon->iDefaultSharedChannels));
    memset(&pVoipCommon->uDefaultSharedModes, 0, sizeof(pVoipCommon->uDefaultSharedModes));
...
VoipRefT *VoipCommonStartup(int32_t iMaxPeers, int32_t iVoipRefSize, VoipHeadsetMicDataCbT *pMicDataCb, VoipHeadsetStatusCbT *pStatusCb, int32_t iData)
{
    ...
    pVoipCommon->pHeadset = VoipHeadsetCreate(iMaxPeers, pMicDataCb, pStatusCb, pVoipCommon, iData);
