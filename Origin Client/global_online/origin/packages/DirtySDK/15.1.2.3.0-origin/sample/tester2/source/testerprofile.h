...
#define TESTERPROFILE_PLATFORM_SIZEDEFAULT          (16)                //!< size of the file log location
#define TESTERPROFILE_PLATFORM_VALUEDEFAULT         ("<empty>")         //!< location to create a logfile at
#define TESTERPROFILE_PLATFORM_TAGVALUE             ("PLATFORM")        //!< the tag the data will be stored under
...
typedef struct TesterProfileEntryT
{
    ...
    char strPlatform[TESTERPROFILE_PLATFORM_SIZEDEFAULT];            //!< platform type
...
// return a specifically indexed profile into a tagfield buffer
