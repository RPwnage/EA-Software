...
#define USERAPI_GAMERTAG_MAXLEN       (16)
...
DIRTYCODE_API int32_t UserApiPostRecentlyMetAsync(UserApiRefT *pRef, uint32_t uUserIndex, DirtyUserT *pPlayerMet, UserApiPostCallbackT *pCallback, void *pUserData);
