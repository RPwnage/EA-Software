...
//! PSP2 requires 64-bit alignment for critical section data
#if defined(DIRTYCODE_PSP2)
 #define NETCRIT_ALIGN __attribute__((aligned(8)))
#else
 #define NETCRIT_ALIGN
#endif
...
#if defined(DIRTYCODE_WINRT) || defined(DIRTYCODE_WINPRT)
