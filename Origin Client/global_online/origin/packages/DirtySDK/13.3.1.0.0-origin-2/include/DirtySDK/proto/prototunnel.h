...
{
    PROTOTUNNEL_MODE_GENERIC,       //!< generic implementation with encryption
    PROTOTUNNEL_MODE_XENON,         //!< xenon-specific implementation, no encryption
    PROTOTUNNEL_MODE_NOCRYPT        //!< generic implementation with no encryption
} ProtoTunnelModeE;
...
{
    uint32_t uLastUpdate;        //!< last update tick
