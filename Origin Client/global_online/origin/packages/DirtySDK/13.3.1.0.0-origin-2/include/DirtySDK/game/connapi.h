...
typedef struct ConnApiClientInfoT
{
    ...
    ConnApiUserInfoT    UserInfo[NETCONN_MAXLOCALUSERS];    //!< info about user
} ConnApiClientInfoT;
...
int32_t ConnApiAddClient(ConnApiRefT *pConnApi, ConnApiClientInfoT *pClientInfo, int32_t iClientIdx);
...
void ConnApiRemoveClient(ConnApiRefT *pConnApi, int32_t iClientIdx);
