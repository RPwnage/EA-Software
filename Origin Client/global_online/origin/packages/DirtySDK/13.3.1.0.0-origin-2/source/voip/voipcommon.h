...
typedef struct VoipCommonRefT
{
    ...
    uint32_t            uRemoteChannelSelection[VOIP_MAX_LOW_LEVEL_CONNS][VOIP_MAXLOCALUSERS]; //<! coded, per remote user, channel selection
    uint32_t            uLocalChannelSelection[VOIP_MAXLOCALUSERS];     //<! coded, per local user, channel selection

    int32_t             iLocalChannels[VOIP_MAXLOCALUSERS][VOIP_MAX_CONCURRENT_CHANNEL];         //<! channels selected locally
    uint32_t            uLocalModes[VOIP_MAXLOCALUSERS][VOIP_MAX_CONCURRENT_CHANNEL];            //<! channel modes selected locally
