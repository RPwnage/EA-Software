...
/*F********************************************************************************/
/*!
    \Function ds_timetostr (timetostr) [DEPRECATED]
    ...
    \Input *pStrBuf   - user-provided buffer to be filled with datetime string (needs to be at least 18 bytes large to receive null-terminated yyyy-MM-ddTHH:mm:ssZ
...
*/
/********************************************************************************F*/
char *ds_timetostr(const struct tm *tm, TimeToStringConversionTypeE eConvType, uint8_t bLocalTime, char *pStrBuf)
{
    return(ds_timetostr2(tm, eConvType, bLocalTime, pStrBuf, 20));
}

/*F********************************************************************************/
/*!
    \Function ds_timetostr2 (timetostr2)
...
*/
/********************************************************************************F*/
char *ds_timetostr2(const struct tm *pTm, TimeToStringConversionTypeE eConvType, uint8_t bLocalTime, char *pStrBuf, int32_t iBufSize)
{
    switch(eConvType)
    {
