...
VoipMixerRefT *VoipMixerCreate(uint32_t uMixBuffers, uint32_t uFrameSamples)
{
    ...
    memset(pMixerRef, 0, sizeof(*pMixerRef));
    ...
    memset(pMixerRef->MixBuffers[0].pMixBuffer, 0, iMixBufferSize);
...
/*!
    ...
    \Input  iMixBufferUnused    - Unused. Deprecated. TODO: remove in V9.
...
*/
/********************************************************************************F*/
int32_t VoipMixerAccumulate(VoipMixerRefT *pMixerRef, uint8_t *pInputData, int32_t iDataSize, int32_t iMixBufferUnused, int32_t iMixMask, int32_t iChannel)
{
    int32_t iNumSamples;
...
int32_t VoipMixerProcess(VoipMixerRefT *pMixerRef, uint8_t *pFrameData)
{
    ...
    memset(pMixBuffer, 0, pMixerRef->iMixBufferSize*sizeof(int32_t));
