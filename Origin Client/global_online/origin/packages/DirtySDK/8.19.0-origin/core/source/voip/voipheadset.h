...
typedef void (VoipHeadsetMicDataCbT)(const void *pVoiceData, int32_t iDataSize, uint32_t uLocalIdx, uint8_t uSendSeqn, void *pUserData);

//! headset status change callback
typedef void (VoipHeadsetStatusCbT)(int32_t iHeadset, uint32_t uStatus, void *pUserData);
