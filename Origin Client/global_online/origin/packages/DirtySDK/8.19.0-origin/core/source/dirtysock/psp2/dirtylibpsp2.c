...
/*!
    ...
    \Input iParam  - index of CPU to start NetLib thread on
...
void NetLibCreate(int32_t iParam)
{
    ...
    if ((g_idlethread = sceKernelCreateThread("NetLib Idle", _NetLibThread, SCE_KERNEL_HIGHEST_PRIORITY_USER, (16 *1024), 0, iParam, NULL)) < 0)
    {
