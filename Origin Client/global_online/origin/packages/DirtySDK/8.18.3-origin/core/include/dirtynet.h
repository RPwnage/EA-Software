...
#if !defined(DIRTYCODE_PC) && !defined(DIRTYCODE_XENON) && !defined(DIRTYCODE_REVOLUTION) && !defined(DIRTYCODE_PSP2)
...
#elif defined(DIRTYCODE_REVOLUTION) || defined(DIRTYCODE_PSP2)
...
#ifndef _WINSOCKAPI_ // if <winsock.h> was included, skip
#include <winsock2.h>
#endif // _WINSOCKAPI_

#endif /* !defined(DIRTYCODE_PC) && !defined(DIRTYCODE_XENON) && !defined(DIRTYCODE_REVOLUTION) && !defined(DIRTYCODE_PSP2) */
...
// define if a given platform has async read support implemented
 ...
 #elif defined(DIRTYCODE_XENON)
   #define SOCKET_ASYNCRECVTHREAD 1
 #elif defined(DIRTYCODE_ANDROID) || defined(DIRTYCODE_APPLEIOS) || defined(DIRTYCODE_APPLEOSX) || defined(DIRTYCODE_LINUX) || defined(DIRTYCODE_PLAYBOOK)
   #define SOCKET_ASYNCRECVTHREAD 1
 #else
   #define SOCKET_ASYNCRECVTHREAD 0
 #endif
...
int32_t SocketCreate(int32_t iParam);
