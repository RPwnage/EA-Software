...
/* https://docs.microsoft.com/en-us/windows/uwp/xbox-live/multiplayer/chat/using-game-chat-2
  ...
  end user will be. The audio is coalesced into 40 ms data frames; this is the suggested polling period. */
#define VOIP_THREAD_SLEEP_DURATION        (40)
...
{
    int32_t iResult = 0;
    Windows::Xbox::System::User ^refLocalUser = nullptr;
