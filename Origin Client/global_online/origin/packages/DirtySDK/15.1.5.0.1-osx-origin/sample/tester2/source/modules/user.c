...
static void _CmdUaCb(UserApiRefT *pRef, UserApiEventDataT *pUserApiEventData, void *pUserData)
{
    ...
    {
#if defined(DIRTYCODE_PS4)
        DirtyUserToNativeUser(&AccountId, sizeof(AccountId), &(pUserApiEventData->EventDetails.UserData.DirtyUser));
...
static void _CmdUaUpdateCb(UserApiRefT *pRef, UserApiNotifyTypeE eNotifyType, UserApiNotifyDataT *pData, void *pUserData)
{
    ...
    {
#if defined(DIRTYCODE_PS4)
        DirtyUserToNativeUser(&AcountId, sizeof(AcountId), &(pData->PresenceData.DirtyUser));
    ...
    {
#if defined(DIRTYCODE_PS4)
        DirtyUserToNativeUser(&AcountId, sizeof(AcountId), &(pData->TitleData.DirtyUser));
    ...
    {
#if defined(DIRTYCODE_PS4)
        DirtyUserToNativeUser(&AcountId, sizeof(AcountId), &(pData->RichPresenceData.DirtyUser));
...
static void _UaGetProfiles(void *_pApp, int32_t argc, char **argv, unsigned char bHelp)
{
    ...
    {
#if defined(DIRTYCODE_PS4)
        AcountId = strtoull(pch, NULL, 10);
        DirtyUserFromNativeUser(&aDirtyUsers[uNumUsers++], &AcountId);
#elif defined (DIRTYCODE_XBOXONE)
