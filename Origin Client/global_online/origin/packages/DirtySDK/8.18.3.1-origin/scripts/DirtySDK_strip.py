...
try:
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
        name = 'xenon',
        alwaysDefines = ['DIRTYCODE_XENON', 'XBOX'],
        possibleDefines = [],
        possibleFolder = []
        ))
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
    ...
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
        name = 'ps3',
        alwaysDefines = ['DIRTYCODE_PS3'],
        possibleDefines = [],
        possibleFolder = []
        ))
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
        name = 'psp2',
        alwaysDefines = ['DIRTYCODE_PSP2', '__SNC__', '__psp2__'],
        possibleDefines = [],
        possibleFolder = []
        ))
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
        name = 'rev',
        alwaysDefines = ['DIRTYCODE_REVOLUTION'],
        possibleDefines = [],
        possibleFolder = []
        ))
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
    ...
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
        name = 'playbook',
        alwaysDefines = ['DIRTYCODE_PLAYBOOK', '__QNX__'],
        possibleDefines = [],
        possibleFolder = []
        ))
    UpdatePlatformInfo(PlatformInfo.PlatformInfo(
    ...
    if 'psp2' in platformList and not 'ps3' in platformList:
        if codeStripper.ShouldIncludeSource():
            srcFilesToFilter.add(includedSubDirectories[0] + '\core\source\dirtysock\ps3\dirtyaddrps3.c')
            srcFilesToCopy.add(includedSubDirectories[0] + '\core\source\dirtysock\ps3\dirtyaddrps3.c')
