...
typedef enum VoipGroupChanModeE
{
    VOIPGROUP_CHANNONE = 0, //<! (provided as a helper and so debuggers show the proper enum value.)
    VOIPGROUP_CHANSEND = 1, //<! Indicates a channel is used for sending
    VOIPGROUP_CHANRECV = 2, //<! Indicates a channel is used for receiving
    VOIPGROUP_CHANSENDRECV = (VOIPGROUP_CHANSEND | VOIPGROUP_CHANRECV) //<! (also has a helper)
} VoipGroupChanModeE;
