...
{
    // image info
    uint8_t     *pImageData;    //!< pointer to start of png bits
    uint8_t     *pImageEnd;     //!< pointer to end of png bits
...
int32_t DirtyPngParse(DirtyPngStateT *pState, DirtyPngHdrT *pPngHdr, const uint8_t *pImageData, const uint8_t *pImageEnd);
