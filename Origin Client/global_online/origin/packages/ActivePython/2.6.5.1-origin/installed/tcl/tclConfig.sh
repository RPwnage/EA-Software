...
# installed.
TCL_PREFIX='C:/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcltk'

# Top-level directory in which Tcl's platform-specific files (e.g.
# executables) are installed.
TCL_EXEC_PREFIX='C:/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcltk'
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/c/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcl/win -ltcl85'

# String to pass to linker to pick up the Tcl library from its
# installed directory.
TCL_LIB_SPEC='-LC:/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcltk/lib -ltcl85'

# String to pass to the compiler so that an extension can
# find installed Tcl headers.
TCL_INCLUDE_SPEC='-IC:/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcltk/include'
...
# compiled.
TCL_SRC_DIR='/c/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcl'

# List of standard directories in which to look for packages during
# "package require" commands.  Contains the "prefix" directory plus also
# the "exec_prefix" directory, if it is different.
TCL_PACKAGE_PATH='C:/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcltk/lib'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/c/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcl/win -ltclstub85'

# String to pass to linker to pick up the Tcl stub library from its
# installed directory.
TCL_STUB_LIB_SPEC='-LC:/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcltk/lib -ltclstub85'

# Path to the Tcl stub library in the build directory.
TCL_BUILD_STUB_LIB_PATH='/c/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcl/win/tclstub85.lib'

# Path to the Tcl stub library in the install directory.
TCL_STUB_LIB_PATH='C:/HOME/as/apy/trunk/build/py2_6_5-win32-x86-apy26-rrun/tcltk/lib/tclstub85.lib'
