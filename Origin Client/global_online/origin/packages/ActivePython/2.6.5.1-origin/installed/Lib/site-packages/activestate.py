...
version_info = {'bsddb_ver': None,
 ...
 'build_time': 'Sat Mar 20 14:48:46 2010',
 'bzip2_ver': (1, 0, 5),
 'compiler': 'vc9-x86',
 'configuration': ['-f',
                   'apyconfig-apy26-rrun.py',
                   '-p',
                   'apy26',
                   '--build-tag',
                   'rrun'],
...
prefixes = set([
    ...
    'C:\\HOME\\as\\apy\\trunk\\build\\py2_6_5-win32-x86-apy26-rrun\\ExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIxExTAcTiVePyThOnPrEfIx',
    # Prefix to which Python sources were built.
    'C:\\HOME\\as\\apy\\trunk\\build\\py2_6_5-win32-x86-apy26-rrun\\CoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIxCoReAcTiVePyThOnPrEfIx',
    # Prefix to the Python image (sys.prefix)
    # (relied by pypm -- for relocation)
    'C:\\HOME\\as\\apy\\trunk\\build\\py2_6_5-win32-x86-apy26-rrun\\image\\feature-core\\INSTALLDIR',
])
shortest_original_prefix_length = 266
