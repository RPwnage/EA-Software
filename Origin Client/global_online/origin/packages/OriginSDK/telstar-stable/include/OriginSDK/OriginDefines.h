...
/// Because of the new Denuvo licensing architecture, we're now required to turn off the trial thread by default, hence this flag
/// is no longer necessary.
/// Should the trial thread be enabled, use ORIGIN_FLAG_ENABLE_TRIAL_THREAD.
#ifdef ORIGIN_FLAG_DISABLE_TRAIL_THREAD_DEPRECATED
/// \ingroup defs
/// \brief (DEPRECATED) Specify this flag when you don't want the Origin SDK to start a trial thread when the content is a free trial.
/// 
/// Prevent the Origin SDK to start a trial thread.
#define ORIGIN_FLAG_DISABLE_TRIAL_THREAD	    (1<<13)
#endif

/// \ingroup defs
/// \brief If you're not using Denuvo, specify this flag when you want the Origin SDK to start a trial thread when the content is a free trial.
/// 
/// Tells the Origin SDK to start a trial thread, provided that the content is indeed a free trial.
#define ORIGIN_FLAG_ENABLE_TRIAL_THREAD	    (1<<14)
