...
#include "OriginPlatformOverlaySupport.h"
...
/// \ingroup sdk
/// \brief Gets the default userId. (The userid  currently maps to the Nucleus User Id, of the Origin User)
/// \return The unique user id for the current user.
OriginUserT ORIGIN_SDK_API OriginGetDefaultUser();

/// \ingroup sdk
/// \brief Gets the default personaId for the user. (The personaId maps to the first Nucleus persona for the user in the cem_ea_id namespace.)
/// \return The unique persona id for the current user. 
OriginPersonaT ORIGIN_SDK_API OriginGetDefaultPersona();

/// \ingroup sdk
/// \brief Gets the userId for the given userIndex. (The userid  currently maps to the Nucleus User Id, of the Origin User)
/// \return The unique userId of user.
OriginUserT ORIGIN_SDK_API OriginGetUser(int userIndex);

/// \ingroup sdk
/// \brief Gets the personaId for the given userIndex. (The personaId maps to the first Nucleus persona for the user in the cem_ea_id namespace.)
/// \return The unique personaId of the user. 
OriginPersonaT ORIGIN_SDK_API OriginGetPersona(int userIndex);
...
/// \param[in] flags Zero, or a bitwise OR combination of ORIGIN_FLAG_* values. If you are not using Denuvo and want to run the trial thread, use the flag ORIGIN_FLAG_ENABLE_TRIAL_THREAD.
