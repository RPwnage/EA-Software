...
def main():
    ...
    for child in masterconfig.getroot().findall('./masterversions/package'):
        ...
        if 'TOOLSET_VISUALSTUDIO' in os.environ and child.attrib['name'] == 'VisualStudio':
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v141':
                child.attrib['version'] = '15.4.27004.2002-proxy'
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v140':
                child.attrib['version'] = '14.0.25123-proxy'
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v120':
        ...
        if 'TOOLSET_VISUALSTUDIO' in os.environ and child.attrib['name'] == 'WindowsSDK':
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v141':
                child.attrib['version'] = '10.0.16299-proxy'
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v140':
                child.attrib['version'] = '10.0.10240-1-proxy'
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v120':
                child.attrib['version'] = '8.1.51641-proxy'
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v110':
                child.attrib['version'] = '8.0.50727-proxy'
            if os.environ['TOOLSET_VISUALSTUDIO'] == 'v100':
                child.attrib['version'] = '7.1.7600.0.30514'
