...
namespace EA
{
    namespace Patch
    {
        ...
        public:
            ...
            static bool GenerateBuiltFileInfo(const DiffData& diffData, BuiltFileInfo& builtFileInfo, Error& error, GenerateBuiltFileInfoEventCallback* pEventCallback = NULL, intptr_t userContext = 0, EA::Thread::ThreadPool* thPool = nullptr);
        ...
        protected:
            ...
            using BlockInfoMap = absl::flat_hash_map<uint32_t, absl::InlinedVector<BlockInfo, 4>>;

            struct LocalSegmentInfo
            {
                uint64_t localPos;
                uint64_t patchPos;
                uint64_t patchSize;
        ...
        public:
            struct JobArgs
            {
                ...
                BuiltFileInfo* mBfi;
                Error mError;
                intptr_t mUserContext;
                GenerateBuiltFileInfoEventCallback* mEventCallback;
                uint64_t mStartOffset;
                uint64_t mEndOffset;
                BlockInfoMap& mBlockInfoMap;
                static EA::Thread::Futex mFutext;
                static EA::Thread::Futex mResultFlushFutex;

            };
            static void GenerateBuiltFileInfoJob(JobArgs*);
