    ...
    namespace Patch
    {
        ...
        public:
           ...
           ~File();
            ...
            #else
                static const EA::IO::size_type kReadBufferSizeDefault  = 4096;
                static const EA::IO::size_type kWriteBufferSizeDefault = 4096;
            #endif
        ...
        public:
            ...
            bool GoToFirstByte(uint32_t& checksum, bool& bDone);
            ...
            /// Gets the HashValueMD5Brief for the currentl block (the one last moved to with GoToFirstBlock or GoToNextBlock).
