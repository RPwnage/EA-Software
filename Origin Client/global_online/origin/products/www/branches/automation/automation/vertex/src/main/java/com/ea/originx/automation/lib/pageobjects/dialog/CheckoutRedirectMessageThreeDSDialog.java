...
/**
 * ThreeDS (additional authorization) Redirect Message Dialog
 *
 * @author Seanli
 */
public class CheckoutRedirectMessageThreeDSDialog extends Dialog {

    private final static By DIALOG_CONTENT_LOCATOR = By.cssSelector(".origin-dialog-content");
    private final static By TITLE_LOCATOR = By.cssSelector(".origin-dialog-content[redirect-message-type='threeDS'] .otkmodal-header .otkmodal-title");
    private final static String REDIRECT_MESSAGE_TYPE_ATTR = "redirect-message-type";
    private final static String REDIRECT_MESSAGE_TYPE = "threeDS";

    /**
     * Constructor for threeDS type dialog instance.
     *
     * @param driver WebDriver instance
     */
    public CheckoutRedirectMessageThreeDSDialog(WebDriver driver){
