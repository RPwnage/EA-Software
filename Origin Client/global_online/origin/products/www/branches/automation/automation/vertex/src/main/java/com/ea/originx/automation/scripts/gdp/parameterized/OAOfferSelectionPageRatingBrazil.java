 ...
 * @author alcervantes
 */
public class OAOfferSelectionPageRatingBrazil extends OAOfferSelectionPageRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testOfferSelectionPageRatingBrazil(ITestContext context) throws Exception {
        testOfferSelectionPageRating(context, CountryInfo.CountryEnum.BRAZIL);
    }
}