...
How to mock Feed of type feedType:
	1. Add feedType to list of feedTypes in create_mockup_data.ini
	
How to mock searching in the store:
	1. Add search string to storeSearch in create_mockup_data.ini