...
/**
 * Tests wishlist privacy setting Friends of Friends
 *
 * @author cvanichsarn
 */
public class OAWishlistPrivacyFriendsOfFriends extends OAWishlistPrivacy {

    @TestRail(caseId = 158307)
    @Test(groups = {"wishlist_smoke", "wishlist", "full_regression", "allfeaturesmoke", "release_smoke"})
    public void testWishlistPrivacyFriendsOfFriends(ITestContext context) throws Exception {
        testWishlistPrivacy(context, PrivacySetting.FRIENDS_OF_FRIENDS);
    }
}
