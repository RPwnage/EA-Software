 ...
 * @author alcervantes
 */
public class OAOfferSelectionPageRatingSouthAfrica extends OAOfferSelectionPageRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testOfferSelectionPageRatingSouthAfrica(ITestContext context) throws Exception {
        testOfferSelectionPageRating(context, CountryInfo.CountryEnum.SOUTH_AFRICA);
    }
}