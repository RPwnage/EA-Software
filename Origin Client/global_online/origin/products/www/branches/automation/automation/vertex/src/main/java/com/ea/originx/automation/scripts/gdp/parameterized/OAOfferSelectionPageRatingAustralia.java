 ...
 * @author alcervantes
 */
public class OAOfferSelectionPageRatingAustralia extends OAOfferSelectionPageRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testOfferSelectionPageRatingAustralia(ITestContext context) throws Exception {
        testOfferSelectionPageRating(context, CountryInfo.CountryEnum.AUSTRALIA);
    }
}