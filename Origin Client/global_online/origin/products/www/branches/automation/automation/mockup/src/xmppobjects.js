...
var Friend = function(jid, name, personaid, eaid) {
    ...
    var currentGameOfferId = null;
    var currentGameState = null;
    var currentTwitchPresence = null;
    var currentShaKeyToPlay = null;
    ...
    this.setCurrentGameTitle = function(gameTitle) {
        currentGameTitle = gameTitle;
    };

    this.setCurrentGameOfferId = function(offerId) {
        currentGameOfferId = offerId;
    };

    this.setCurrentGameState = function(gameState) {
        currentGameState = gameState;
    };

    this.setCurrentTwitchPresence = function(twitchPresence) {
        currentTwitchPresence = twitchPresence;
    };

    this.setCurrentShaKeyToPlay = function(shaKeyToPlay) {
        currentShaKeyToPlay = shaKeyToPlay;
    };

    this.getCurrentGameTitle = function() {
        return currentGameTitle;
    };

    this.getCurrentGameOfferId = function() {
        return currentGameOfferId;
    };
    ...
    this.getCurrentTwitchPresence = function() {
        return currentTwitchPresence;
    };

    this.getCurrentShaKeyToPlay = function() {
        return currentShaKeyToPlay;
    };

    this.stopPlaying = function() {
        this.setCurrentGameTitle( null );
        this.setCurrentGameOfferId( null );
        this.setCurrentGameState( null );
        this.setCurrentTwitchPresence( null );
        this.setCurrentShaKeyToPlay( null );
    };
};
