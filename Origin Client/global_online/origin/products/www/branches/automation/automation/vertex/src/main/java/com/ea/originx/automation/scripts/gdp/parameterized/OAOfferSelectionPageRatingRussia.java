 ...
 * @author alcervantes
 */
public class OAOfferSelectionPageRatingRussia extends OAOfferSelectionPageRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testOfferSelectionPageRatingRussia(ITestContext context) throws Exception {
        testOfferSelectionPageRating(context, CountryInfo.CountryEnum.RUSSIA);
    }
}