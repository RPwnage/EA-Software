 ...
 * @author alcervantes
 */
public class OAOfferSelectionPageRatingGermany extends OAOfferSelectionPageRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testOfferSelectionPageRatingGermany(ITestContext context) throws Exception {
        testOfferSelectionPageRating(context, CountryInfo.CountryEnum.GERMANY);
    }
}
