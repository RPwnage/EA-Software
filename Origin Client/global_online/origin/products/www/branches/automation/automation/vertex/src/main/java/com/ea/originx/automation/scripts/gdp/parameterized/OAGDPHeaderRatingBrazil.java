 ...
 * @author cbalea
 */
public class OAGDPHeaderRatingBrazil extends OAGDPHeaderRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testGDPHeaderRatingBrazil(ITestContext context) throws Exception {
        testGDPHeaderRating(context, CountryInfo.CountryEnum.BRAZIL);
    }
