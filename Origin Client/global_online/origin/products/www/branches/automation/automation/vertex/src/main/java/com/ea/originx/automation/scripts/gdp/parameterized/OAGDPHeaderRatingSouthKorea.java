 ...
 * @author cbalea
 */
public class OAGDPHeaderRatingSouthKorea extends OAGDPHeaderRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testGDPHeaderRatingSouthKorea(ITestContext context) throws Exception {
        testGDPHeaderRating(context, CountryInfo.CountryEnum.SOUTH_KOREA);
    }
