...
/**
 * Tests that a discount is applied to wishlisted access games
 *
 * @author jmittertreiner
 */
public class OAAddToWishlistOGDAccess extends OAAddToWishlistOGD {

    @TestRail(caseId = 11708)
    @Test(groups = {"ogd", "wishlist", "full_regression"})
    public void testAddToWishlistOGDAccess(ITestContext c) throws Exception {
        testAddToWishlistOGD(c, TEST_TYPE.ACCESS);
    }
}
