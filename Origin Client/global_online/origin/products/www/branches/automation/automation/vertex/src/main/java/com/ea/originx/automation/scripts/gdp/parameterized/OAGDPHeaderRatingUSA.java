 ...
 * @author cbalea
 */
public class OAGDPHeaderRatingUSA extends OAGDPHeaderRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testGDPHeaderRatingUSA(ITestContext context) throws Exception {
        testGDPHeaderRating(context, CountryInfo.CountryEnum.USA);
    }
