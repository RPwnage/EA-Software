 ...
 * @author cbalea
 */
public class OAGDPHeaderRatingUK extends OAGDPHeaderRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testGDPHeaderRatingUK(ITestContext context) throws Exception {
        testGDPHeaderRating(context, CountryInfo.CountryEnum.UK);
    }
