 ...
 * @author alcervantes
 */
public class OAOfferSelectionPageRatingNewZealand extends OAOfferSelectionPageRating {

    @TestRail(caseId = 3001994)
    @Test(groups = {"gdp", "full_regression"})
    public void testOfferSelectionPageRatingNewZealand(ITestContext context) throws Exception {
        testOfferSelectionPageRating(context, CountryInfo.CountryEnum.NEW_ZEALAND);
    }
}
