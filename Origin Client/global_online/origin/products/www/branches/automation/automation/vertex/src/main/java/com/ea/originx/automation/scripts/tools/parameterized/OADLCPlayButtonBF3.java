 ...
 * parameters:<br>
 * gameFamilyType: BF3<br>
 *
 * @author palui
 */
public class OADLCPlayButtonBF3 extends OADLCPlayButton {

    @Test(groups = {"personalization", "client_only"})
    public void testDLCPlayButtonBF3(ITestContext context) throws Exception {
        testDLCPlayButton(context, GameFamilyType.BF3);
    }
}
