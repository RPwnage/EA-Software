...
/**
 * Test clicking on Description Nav bar link scrolls page to 'Description' section
 */
public class OADescription extends EAXVxTestTemplate {

    @TestRail(caseId = 3086510)
    @Test(groups = {"gdp", "full_regression"})
    public void testDescription(ITestContext context) throws Exception {
        ...
        logFlowPoint("Click on the 'Description' nav bar link and verify page scrolls to 'Description' section"); // 3
        ...
        // 3
        new GDPNavBar(driver).clickDescriptionNavLink();
        logPassFail(new GDPSections(driver).verifyDescriptionSectionVisible(), false);
