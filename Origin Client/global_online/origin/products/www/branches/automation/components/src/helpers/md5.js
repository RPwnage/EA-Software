...
(function() {
    ...
    function Md5Factory() {
         ...
         *
         * @param {String|Array|ArrayBuffer} the input message
         * @return {String} the MD5 digest
         */
        function md5(message) {
            if (typeof(message) === 'object' && typeof(message.join) === 'function'){
                return _md5(message.join(''));
            } else {
                return _md5(message);
            }
        }
        ...
        /**
         * Create a cryptographic key to identify a cached record
         * @param {String} prefix a prefix to add to the hash to identify the storage group eg. (product)
         * @param {Array} content an ordered array of content to digest eg. ['abc123', 'foobazbat']
         * @return {String} an MD5 hash with prefix eg. product15fcbd8a46bdb881a3b87a1e0ed671ad
         */
        function createStorageKey(prefix, content) {
            return [prefix, md5(content)].join('');
        }
     ...
     */
    function Md5FactorySingleton(LocFactory, ComponentsLogFactory, $http, SingletonRegistryFactory) {
        return SingletonRegistryFactory.get('Md5Factory', Md5Factory, this, arguments);
    }

    /**
     * @ngdoc service
     * @name origin-components.factories.Md5Factory
    ...
    angular.module('origin-components')
        .factory('Md5Factory', Md5FactorySingleton);
})();
