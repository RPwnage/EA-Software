(function () {
    ...
    * The controller
    */
    function OriginSocialChatwindowConversationInputCtrl($scope, ConversationFactory, RosterDataFactory, AuthFactory, ObserverFactory) {
            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    $textInput.keydown(function (event) {
                        ...
                        if ((event.keyCode || event.which) === 13) {
                            ...
                            if (text.length) {
                                ...
                                $textInput.val('');
                                scope.conversation.pendingText = '';
                    ...
                    $textInput.keyup(function (event) {
                        ...
                        //
                        // ***************************************************
                        // We shoudn't need this because we are using ng-model
                        // Adding this back in to fix ORPLAT-8008
                        // NOTE this will cause ORPLAT-7660 to return
                        // ***************************************************
                        //
