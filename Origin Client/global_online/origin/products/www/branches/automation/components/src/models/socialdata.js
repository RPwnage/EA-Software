(function() {
    ...
    function SocialDataFactory($filter, DialogFactory, UtilFactory, AuthFactory, ComponentsLogFactory) {
...
*/
        ...
        */
        ...
        function onXmppUserConflict() {
            DialogFactory.openAlert({
                id: 'web-xmpp-user-conflict',
                title: UtilFactory.getLocalizedStr(null, CONTEXT_NAMESPACE, 'xmppuserconflicttitle'),
                description: UtilFactory.getLocalizedStr(null, CONTEXT_NAMESPACE, 'xmppuserconflictdesc'),
        ...
        function onJSSDKlogin() {
            ...
            if (Origin.xmpp.isConnected()) {
                ...
                //setup listening for the connection first
     ...
     */
    function SocialDataFactorySingleton($filter, DialogFactory, UtilFactory, AuthFactory, ComponentsLogFactory, SingletonRegistryFactory) {
