(function () {
    ...
    * The controller
    */
    function OriginSocialChatwindowConversationHistoryitemTimestampCtrl($scope, UtilFactory, moment)
    {
        $scope.time = moment($scope.timestampEvent.time).format('LT');
     ...
     * @element ANY
     * @scope
     * @param {Object} timestamp-event Javascript object representing the timestamp event
     * @description
     *
     ...
     *            timestamp-event="timestampEvent"
     *         ></origin-social-chatwindow-conversation-historyitem-timestamp>
     *     </file>
     * </example>
     *
