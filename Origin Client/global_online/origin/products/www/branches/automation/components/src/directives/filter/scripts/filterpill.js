...
(function() {
     ...
     * @param {boolean} is-active flag indicating whether to display the filter or not
     * @param {function} on-dismiss callback to call when the user closes the filter element
     * @description
     *
