...
describe('MD5 Factory', function() {
    ...
    describe('Create Storage Key', function() {
        it('Will create a prefixed key', function () {
            var content = ['abc123', 'foobazbat'];
            var prefix = 'product';
            expect(md5.createStorageKey(prefix, content)).toEqual('product15fcbd8a46bdb881a3b87a1e0ed671ad');
        });
    });
});