/**
 * @file store/pdp/scripts/overview-wrapper.js
 */
(function(){
    'use strict';
    ...
    /**
     * @ngdoc directive
     * @name origin-components.directives:originStorePdpOverviewWrapper
     * @restrict E
     * @element ANY
     * @scope
     ...
     * @example
     * <origin-store-row>
     *     <origin-store-pdp-overview-wrapper></origin-store-pdp-overview-wrapper>
     * </origin-store-row>
     */
}());
