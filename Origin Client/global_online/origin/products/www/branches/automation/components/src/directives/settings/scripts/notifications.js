...
(function() {
     ...
     * @element ANY
     * @scope
     * @param {LocalizedString} achievementstr *Update in Defaults
     * @param {LocalizedString} chatstr *Update in Defaults
     * @param {LocalizedString} downloadstr *Update in Defaults
     * @param {LocalizedString} failurestr *Update in Defaults
     * @param {LocalizedString} friendbroadstr *Update in Defaults
     * @param {LocalizedString} friendinstr *Update in Defaults
     * @param {LocalizedString} friendoutstr *Update in Defaults
     * @param {LocalizedString} friendquitstr *Update in Defaults
     * @param {LocalizedString} friendsactivitystr *Update in Defaults
     * @param {LocalizedString} friendstartstr *Update in Defaults
     * @param {LocalizedString} friendstopbroadstr *Update in Defaults
     * @param {LocalizedString} gameinvitestr *Update in Defaults
     * @param {LocalizedString} gamesstr *Update in Defaults
     * @param {LocalizedString} groupinvitestr *Update in Defaults
     * @param {LocalizedString} incomingstr *Update in Defaults
     * @param {LocalizedString} incomingvoipstr *Update in Defaults
     * @param {LocalizedString} installstr *Update in Defaults
     * @param {LocalizedString} notificationstr *Update in Defaults
     * @param {LocalizedString} soundstr *Update in Defaults
     *
     * @description
     *
     * Settings section
     ...
     *         <origin-settings-notifications titlestr="Looking for more?" descriptionstr="The more you play games and the more you add friends, the better your recommendations will become."></origin-settings-notifications>
     *     </file>
     * </example>
     */
