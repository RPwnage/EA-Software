...
(function(){
    ...
    var CONTEXT_NAMESPACE = 'origin-store-promo-release',
    ...
    function originStorePromoRelease(ComponentsConfigFactory, UtilFactory, moment) {
        function originStorePromoReleaseLink(scope) {
            ...
            if (scope.startDate || scope.endDate) {
                ...
                scope.aText = UtilFactory.getLocalizedStr(scope.availableText, CONTEXT_NAMESPACE, 'available-text', {'%startDate%': sDate, '%endDate%': eDate});
            }
        }
     ...
     *
     * @param {LocalizedString} available-text available text
     *
     * @example
