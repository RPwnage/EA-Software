    ...
    */
    function OriginStoreCarouselImageCtrl($scope, UtilFactory, DialogFactory) {
       ...
       $scope.order = [];
        var jsonData = {
            name: DIRECTIVE_NAME,
            data:{'title-str': $scope.titleStr, version: VersionEnumeration.MODAL },
     ...
     * @description
     *
     * @param {LocalizedString} title-str - How the carousel text should be aligned affects every slide
     ...
     *     <origin-store-carousel-image title-str="Image/Video Slider"></origin-store-carousel-image>
     *     </file>
     * </example>
     */
