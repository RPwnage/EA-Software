/**
 * @file store/pdp/systemrequirements-wrapper.js
 */
(function(){
    'use strict';
    ...
    /**
     * @ngdoc directive
     * @name origin-components.directives:originStorePdpSystemrequirementsWrapper
     * @restrict E
     * @element ANY
     * @scope
     ...
     * @example
     * <origin-store-row>
     *     <origin-store-pdp-systemrequirements-wrapper></origin-store-pdp-systemrequirements-wrapper>
     * </origin-store-row>
     */
}());
