    ...
    return {
        bowerOrigin: {
            files: [
                ...
                'dist/bower_components/eax-experiments/dist/scripts/*.js',
                'dist/bower_components/eax-experiments/dist/directives/views/*.html',
                'dist/bower_components/eax-experimentsdk/dist/*.js'
            ],
            options: {
