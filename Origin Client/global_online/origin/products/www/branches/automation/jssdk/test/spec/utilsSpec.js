describe('Origin Utils API', function() {
    ...
    it('Origin.utils.replaceTemplatedValuesInConfig()', function() {
        ...
        var configObject_no_overrides = {
            'hostname':{
                'base':'origin.com',
                'basedata':'https://{version}{env}api1.{base}/',
                'baseapi':'https://{version}{env}api2.{base}/'
            },
            'urls':{
        ...
        var configObject_with_overrides = {
            ...
            'hostname':{
                'base':'origin.com',
                'basedata':'https://{version}{env}api1.{base}/{cmsstage}',
                'baseapi':'https://{version}{env}api2.{base}/{cmsstage}'
            },
            'urls':{
                'abaseGameEntitlementsTEST':'{basedata}ecommerce2/basegames/{userId}?machine_hash=1',
                'abaseapiGameEntitlementsTEST':'{baseapi}ecommerce2/basegames/{userId}?machine_hash=1'
        ...
        var expected_configObject_with_overrides_result = {
            ...
            'hostname':{
                'base':'origin.com',
                'basedata':'https://version.env.api1.origin.com/cmsstage/',
                'baseapi':'https://version.env.api2.origin.com/cmsstage/'
            },
            'urls':{
                'abaseGameEntitlementsTEST':'https://version.env.api1.origin.com/cmsstage/ecommerce2/basegames/{userId}?machine_hash=1',
                'abaseapiGameEntitlementsTEST':'https://version.env.api2.origin.com/cmsstage/ecommerce2/basegames/{userId}?machine_hash=1'
            }
        }
