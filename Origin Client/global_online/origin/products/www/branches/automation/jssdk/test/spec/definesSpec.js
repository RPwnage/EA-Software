describe('Origin Defines API', function() {
    ...
    it('Origin.defines.showPersona', function() {

        var showPersonaCodesObject = Origin.defines.showPersona;

        expected_showPersonaCodesObject = Object({
            EVERYONE: 'EVERYONE',
            FRIENDS: 'FRIENDS',
        ...
        expect(showPersonaCodesObject).toEqual(expected_showPersonaCodesObject);
