describe('Origin Client Voice API', function() {
    ...
    it('Origin.client.voice.audioInputDevices()', function(done) {
        ...
        Origin.client.voice.audioInputDevices().then(function(result) {
    ...
    it('Origin.client.voice.audioOutputDevices()', function(done) {
        ...
        Origin.client.voice.audioOutputDevices().then(function(result) {
            expect(result).toEqual(expected);
            asyncTicker.clear(done);
    ...
    it('Origin.client.voice.networkQuality()', function(done) {

        var asyncTicker = new AsyncTicker();

        asyncTicker.tick(1000, done, 'Expect onResolve() to be executed');

        Origin.client.voice.networkQuality().then(function(result) {
    ...
    it('Origin.client.voice.selectedAudioInputDevice()', function(done) {

        var asyncTicker = new AsyncTicker();

        asyncTicker.tick(1000, done, 'Expect onResolve() to be executed');

        Origin.client.voice.selectedAudioInputDevice().then(function(result) {
    ...
    it('Origin.client.voice.selectedAudioOutputDevice()', function(done) {
        var asyncTicker = new AsyncTicker();

        asyncTicker.tick(1000, done, 'Expect onResolve() to be executed');

        Origin.client.voice.selectedAudioOutputDevice().then(function(result) {
            expect(result).toEqual('device');
            asyncTicker.clear(done);
