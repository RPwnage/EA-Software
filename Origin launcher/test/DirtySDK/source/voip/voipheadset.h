...
#define VOIPHEADSET_DESTROY_RETRY (-1)
...
#if defined(DIRTYCODE_XBOXONE)|| defined(DIRTYCODE_PS4) || defined (DIRTYCODE_PC) || defined(DIRTYCODE_GDK)
// set callback to be invoked by voipheadset when inbound transcribed text has passed communication permission check
