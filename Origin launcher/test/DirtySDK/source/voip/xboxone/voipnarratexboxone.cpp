...
static void _VoipNarrateStart(VoipNarrateRefT *pVoipNarrate, VoipNarrateRequestT *pRequest)
{
    ...
    pVoipNarrate->pVoiceDataCb(pVoipNarrate, pRequest->iUserIndex, NULL, VOIPNARRATE_STREAM_START, VOIPNARRATE_CBFLAG_NONE, pVoipNarrate->pUserData);
...
static void _VoipNarrateProcessResult(VoipNarrateRefT *pVoipNarrate, VoipNarrateRequestT *pRequest)
{
    ...
    if (pVoipNarrate->iDataLen > 0)
    {
        ...
        while (pVoipNarrate->iDataOff < pVoipNarrate->iDataLen)
        {
            ...
            if ((iRead = pVoipNarrate->pVoiceDataCb(pVoipNarrate, pRequest->iUserIndex, (const int16_t *)(pVoipNarrate->pData+pVoipNarrate->iDataOff), iLength, VOIPNARRATE_CBFLAG_NONE, pVoipNarrate->pUserData)) > 0)
            {
...
static void _VoipNarrateRequestTransition(VoipNarrateRefT *pVoipNarrate, VoipNarrateRequestT *pRequest, bool bAnnounceEnd)
{
    ...
    if (bAnnounceEnd)
    {
        pVoipNarrate->pVoiceDataCb(pVoipNarrate, pRequest->iUserIndex, NULL, VOIPNARRATE_STREAM_END, VOIPNARRATE_CBFLAG_NONE, pVoipNarrate->pUserData);
    }
