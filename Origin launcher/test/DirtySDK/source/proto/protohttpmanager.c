...
/*!
    ...
    \Todo
        Possible issues with _HttpManagerRequestDelCmdFromQueue that need to be considered:
            - out-of-order command deletion may not be handled correctly
...
*/
/********************************************************************************F*/
static int32_t _HttpManagerCustomHeaderCb(ProtoHttpRefT *pState, char *pHeader, uint32_t uHeaderSize, void *pUserRef)
{
    ...
    return(pHttpCmd->pHttpManager->pCustomHeaderCb(pState, pHeader, uHeaderSize, pHttpCmd->pCallbackRef));
}
...
static int32_t _HttpManagerReceiveHeaderCb(ProtoHttpRefT *pState, const char *pHeader, uint32_t uHeaderSize, void *pUserRef)
{
    ...
    if ((pHttpCmd == NULL) || ((pHttpManager = pHttpCmd->pHttpManager) == NULL))
    {
