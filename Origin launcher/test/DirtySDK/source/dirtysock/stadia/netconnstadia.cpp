...
static void _NetConnAddLocalUser(NetConnLocalUserRefT *pLocalUserRef, int32_t iLocalUserIndex, const EA::User::IEAUser *pIEAUser)
{
    ...
    if (pRef->aEAUsers[iLocalUserIndex] == NULL)
    {
        ...
        NetPrintf(("netconnstadia: netconn user added at local user index %d - localUserId=%llu\n",
    ...
    {
        NetPrintf(("netconnstadia: failed to add EAUser at index %d with local user id %llu because entry already used with local user id %llu\n",
...
static void _NetConnRemoveLocalUser(NetConnLocalUserRefT *pLocalUserRef, int32_t iLocalUserIndex, const EA::User::IEAUser *pIEAUser)
{
    ...
    if (pRef->aEAUsers[iLocalUserIndex] != NULL)
    {
        ...
        {
            NetPrintf(("netconnstadia: netconn user removed at local user index %d --> local user id: %llu\n",
        ...
        {
            NetPrintf(("netconnstadia: failed to remove local user at index %d - local user ids do not match (%llu vs %llu)\n",
                iLocalUserIndex, pIEAUser->GetUserID(), pRef->aEAUsers[iLocalUserIndex]->GetUserID()));
        }
    }
    else
