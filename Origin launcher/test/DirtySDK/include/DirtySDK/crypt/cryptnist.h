...
// cleanup up the crypt dh state
DIRTYCODE_API void CryptNistCleanupDh(CryptNistDhT *pState);
...
// cleanup up the crypt dsa state
DIRTYCODE_API void CryptNistCleanupDsa(CryptNistDsaT *pState);
