...
namespace EA.Tasks.Tests
{
	...
	public class EATaskTests
	{
		...
		public void GenerateWebReferencesTaskTest()
		{
			...
			OptionSet fsbuildtype = new OptionSet();
			fsbuildtype.Options.Add("build.tasks", "fsc");
			fsbuildtype.Options.Add("fsc.target", "library");
			project.NamedOptionSets["FSharpLibrary"] = fsbuildtype;
			...
			project.Properties["test.myfsmodule.buildtype"] = "FSharpLibrary";
