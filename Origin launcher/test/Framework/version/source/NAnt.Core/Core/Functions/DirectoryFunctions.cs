...
namespace NAnt.Core.Functions
{
	...
	public class DirectoryFunctions : FunctionClassBase {
		...
		public static string DirectoryIsEmpty(Project project, string path) 
		{
			...
			{
				throw new BuildException(String.Format("System Exception was thrown executing C# Directory.GetFiles() or C# Directory.GetDirectories() for path '{0}'", path), ex);
			}
		...
		public static string DirectoryGetFileCount(Project project, string path, string pattern) 
		{
			...
			{
				throw new BuildException(String.Format("System Exception was thrown executing C# Directory.GetFiles() for path '{0}'", path), ex);
			}
		}
		...
		public static string DirectoryGetDirectories(Project project, string path, string pattern, char delim) 
		{
			...
			try
			{
				directories = System.IO.Directory.GetDirectories(path, pattern);
			}
			catch (Exception ex)
			{
				throw new BuildException(String.Format("System Exception was thrown executing C# Directory.GetDirectories() for path '{0}'", path), ex);
			}
		...
		{
			String[] strNewDirectories = null;
			try
			{
				strNewDirectories = System.IO.Directory.GetDirectories(strCurrentPath, strPattern);
			}
			catch (Exception ex)
			{
				throw new BuildException(String.Format("System Exception was thrown executing C# Directory.GetDirectories() for path '{0}'", strCurrentPath), ex);
			}
		...
		public static string DirectoryGetDirectoriesRecursive(Project project, string path, string pattern, char delim) 
		{
			...
			System.Collections.ArrayList directoriesArrayList = DirectoriesGetDirectoryListHelper(path, pattern);
		...
		public static string DirectoryGetLastAccessTime(Project project, string path, string pattern) 
		{
			...
			{
				throw new BuildException(String.Format("System Exception was thrown executing C# Directory.GetLastAccessTime() for path '{0}'", path), ex);
			}
		}
		...
		public static string DirectoryGetLastWriteTime(Project project, string path, string pattern) 
		{
			...
			{
				throw new BuildException(String.Format("System Exception was thrown executing C# Directory.GetLastWriteTime() for path '{0}'", path), ex);
			}
		}
		...
		/// <include file='Examples/Directory/DirectoryMove.example' path='example'/>
		[Function()]
		public static string DirectoryMove(Project project, string source, string dest)
		{
			...
			{
				throw new BuildException(String.Format("System Exception was thrown executing C# Directory.Move() for source path '{0}' and dest path '{1}'", source, dest), ex);
			}
			return dest;
		}
	}
