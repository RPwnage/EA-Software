...
namespace EA.Eaconfig.Structured
{
	...
	/// </summary>
	[TaskName("spu", XmlSchema = false)]
	public class SpuSubsystemGroupPublicData : TaskContainer
	{
		public SpuSubsystemGroupPublicData() : base() { }

		public override void Initialize(XmlNode elementNode)
		{
			// override base to do nothing because this is deprecated and we want to ignore these
		}
