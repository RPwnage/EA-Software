...
{
	internal abstract class VSFSProject : VSDotNetProject
	{
		internal VSFSProject(VSSolutionBase solution, IEnumerable<IModule> modules)
		...
		protected override void WriteImportStandardTargets(IXmlWriter writer)
		{
			...
			writer.WriteAttributeString("Condition", "'$(MinimumVisualStudioVersion)' == ''");
			...
			writer.WriteAttributeString("Condition", @"(!Exists('$(MSBuildExtensionsPath32)\..\Microsoft SDKs\F#\3.0\Framework\v4.0\Microsoft.FSharp.Targets')) And (Exists('$(MSBuildExtensionsPath32)\..\Microsoft F#\v4.0\Microsoft.FSharp.Targets'))");
			writer.WriteEndElement();

			writer.WriteStartElement("Import");
			writer.WriteAttributeString("Project", @"$(MSBuildExtensionsPath32)\FSharp\1.0\Microsoft.FSharp.Targets");
			writer.WriteAttributeString("Condition", @"(!Exists('$(MSBuildExtensionsPath32)\..\Microsoft SDKs\F#\3.0\Framework\v4.0\Microsoft.FSharp.Targets')) And (!Exists('$(MSBuildExtensionsPath32)\..\Microsoft F#\v4.0\Microsoft.FSharp.Targets')) And (Exists('$(MSBuildExtensionsPath32)\FSharp\1.0\Microsoft.FSharp.Targets'))");
			writer.WriteEndElement();
		}
	}
}