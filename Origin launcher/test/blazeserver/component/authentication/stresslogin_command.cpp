...
private:
    ...
    StressLoginCommandStub::Errors execute() override
    {
        ...
        if (loginErr == Blaze::ERR_OK)
        {
            ...
            convertToPlatformInfo(userData.getPlatformInfo(), INVALID_EXTERNAL_ID, nullptr, mRequest.getAccountId(), mRequest.getAccountId(), mRequest.getPersonaName(), servicePlatform);
