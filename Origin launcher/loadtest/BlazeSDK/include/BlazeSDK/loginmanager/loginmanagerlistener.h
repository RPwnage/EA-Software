...
public:
    ...
    /*! \brief The attempt to login to the Blaze servers failed.
        ...
        <td>For Nucleus 2.0 logins, the supplied AuthCode was invalid. Should launch WebKit with portalUrl to present user with correct Nucleus Portal flow to proceed. i.e. account creation</td>
        </tr>
