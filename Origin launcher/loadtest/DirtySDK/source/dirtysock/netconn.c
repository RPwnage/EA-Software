...
/*F********************************************************************************/
/*!
    \Function NetConnTranslateIANAIfType

    \Description
        Translate IANA iftypes into NETCONN_IFTYPE_*
        IANA values taken from https://www.iana.org/assignments/ianaiftype-mib/ianaiftype-mib
        On Xbox One, wired returns 6 & wireless returns 71

    \Input  uIANAiftype -   interface adapter type as defined by the IANA

    \Output
        uint32_t interface type bitfield (NETCONN_IFTYPE_*)

    \Version 09/16/2019 (migallant)
*/
/********************************************************************************F*/
uint32_t NetConnTranslateIANAIfType(uint32_t uIANAiftype)
{
    uint32_t uIfType;
    ...
    switch (uIANAiftype)
    {
        ...
        case 7:   // iso88023-csmacd
        case 11:  // starLan
        case 26:  // ethernet3Mbit
        case 62:  // fastEther
        case 69:  // fastEtherFX
        ...
        case 71:  // ieee80211
        case 157: // propWirelessP2P
        case 180: // propDocsWirelessMaclayer
        case 181: // propDocsWirelessDownstream
        case 182: // propDocsWirelessUpstream
        case 183: // hiperlan
        case 184: // propBWAp2Mp
        case 281: // xboxWireless
            uIfType = NETCONN_IFTYPE_WIRELESS;
            break;

        case 48: //modem
            uIfType = NETCONN_IFTYPE_MODEM;
            break;

        case 237: // ieee80216WMAN
        case 243: // wwanPP
        case 244: // wwanPP2
    ...
    NetPrintf(("netconn: IANA iftype %u translated to netconn iftype %u\n", uIANAiftype, uIfType));
    return(uIfType);
}
