...
namespace NAnt.Shared.Properties
{
	...
	public static class PackageProperties
	{
		...
		public const string PackageGenDirectoryPropertyName = "package.gendir";
		public const string PackageConfigBinDir = "package.configbindir";
		public const string PackageConfigLibDir = "package.configlibdir";
		public const string PackageConfigBuildDir = "package.configbuilddir";
		public const string PackageConfigGenDir = "package.configgendir";
		...
		public const string PackageRootPropertyName = "package.root";
	...
	public static class FrameworkProperties
	{
		...
		public const string BulkBuildAlwaysPropertyName = "bulkbuild.always";
		public const string BulkBuildPropertyName = "bulkbuild";
		public const string CredStoreFilePropertyName = "nant.credentialstore";
	}
}
