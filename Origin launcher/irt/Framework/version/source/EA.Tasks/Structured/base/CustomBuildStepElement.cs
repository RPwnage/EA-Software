...
namespace EA.Eaconfig.Structured
{
	...
	[ElementName("custom-build-step", StrictAttributeCheck = true, NestedElementsCheck = true)]
	public class CustomBuildStepElement : ConditionalElementContainer
	{
		/// <summary>
		...
		public ConditionalPropertyElement Script { get; set; } = new ConditionalPropertyElement();

		/// <summary>A list of files that are added to the step's output dependencies.</summary>
		[Property("custom-build-outputs", Required = false)]
		public ConditionalPropertyElement OutputDependencies { get; } = new ConditionalPropertyElement();
		...
		public StructuredFileSet InputDependencies { get; } = new StructuredFileSet();
	}
}
