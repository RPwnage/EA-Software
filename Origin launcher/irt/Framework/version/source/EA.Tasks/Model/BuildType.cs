...
namespace EA.Eaconfig
{
	public class BuildType
	{
		public enum Types
		{
			...
			CSharp = 1 << 4,
			Managed = 1 << 5,
			EASharp = 1 << 6, // DAVE-FUTURE-REFACTOR-TODO remove ea# support
			MakeStyle = 1 << 7,
			FSharp = 1 << 8, // DAVE-FUTURE-REFACTOR-TODO remove f# support
		...
		public bool IsCLR { get { return IsCSharp || IsFSharp || IsManaged; } }
		...
		public bool IsFSharp { get { return (m_type & Types.FSharp) == Types.FSharp; } } // DAVE-FUTURE-REFACTOR-TODO remove f# support
