...
namespace NAnt.PerforceTasks
{
	...
	/// </example>
	[TaskName("p4have")]
	public class P4HaveTask : P4Base 
	{
		public P4HaveTask() : base("p4have") { }
		...
		public override string ProgramArguments		{ get { return GlobalOptions + " have " + Files; } }
   }	// end class P4HaveTask
}
