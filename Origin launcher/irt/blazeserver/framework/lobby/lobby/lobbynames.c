...
*/
/************************************************************************************************F*/
int32_t LobbyNameCmp(const char *pName1, const char *pName2)
{
    int32_t iCmp;
...
*/
/************************************************************************************************F*/
int32_t LobbyNameSubstr ( const char *pSrc, const char *pMatch )
{
    int32_t iSrcIdx;
    int32_t iMatchIdx1;
    int32_t iMatchIdx2;
...
/*F************************************************************************************************/
/*!
    \Function   LobbyNameCreateCanonical
...
*/
/************************************************************************************************F*/
int32_t LobbyNameCreateCanonical(const char *pName, char * pCanonical, size_t uLen)
{
    unsigned char cCh;
...
*/
/************************************************************************************************F*/
uint32_t LobbyNameHash(const char *pName)
{
    unsigned char cCh;
