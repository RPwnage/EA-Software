...
COMMON:
    ALTER TABLE `accountinfo`
      ADD COLUMN `primarypersonaidstadia` bigint(20) unsigned DEFAULT NULL COMMENT 'steam persona id' AFTER `primarypersonaidsteam`,
      ADD COLUMN `primaryexternalidstadia` bigint(20) unsigned DEFAULT NULL COMMENT 'steam externalid' AFTER `primaryexternalidsteam`,
      ADD UNIQUE KEY (`primarypersonaidstadia`),
      ADD UNIQUE KEY (`primaryexternalidstadia`);
