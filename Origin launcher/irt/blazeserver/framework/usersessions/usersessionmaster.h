...
public:
    ...
    BlazeRpcError addUser(BlazeId blazeId, bool sendImmediately = true);
    BlazeRpcError addUsers(const BlazeIdList& blazeIds, bool sendImmediately = true);
    void addUsersAsync(const BlazeIdList& blazeIds);
    static void finish_addUsersAsync(UserSessionId userSessionId, EA::TDF::tdf_ptr<BlazeIdList> _blazeIds);

    BlazeRpcError removeUser(BlazeId blazeId, bool sendImmediately = true);
    BlazeRpcError removeUsers(const BlazeIdList& blazeIds, bool sendImmediately = true);
    void removeUsersAsync(const BlazeIdList& blazeIds);
    static void finish_removeUsersAsync(UserSessionId userSessionId, EA::TDF::tdf_ptr<BlazeIdList> _blazeIds);
