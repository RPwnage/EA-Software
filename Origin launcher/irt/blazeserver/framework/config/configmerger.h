...
private:
    ...
    void clearIsSetMemberIfRefUnset() 
    {
#if EA_TDF_INCLUDE_CHANGE_TRACKING
        if (mInTdf)
        {
            ...
            {
                EA_FAIL_MSG("[ConfigMerger].clearIsSetMemberIfRefUnset: mReferenceItr or mMemberItr is nullptr");
            }
