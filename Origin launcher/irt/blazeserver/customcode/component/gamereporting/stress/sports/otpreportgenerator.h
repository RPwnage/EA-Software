...
#ifndef BLAZE_STRESS_CUSTOM_OTP_REPORT_GENERATOR_H
#define BLAZE_STRESS_CUSTOM_OTP_REPORT_GENERATOR_H
...
namespace Blaze
{
    ...
    {
    ///////////////////////////////////////////////////////////////////////////////
    //    class SportsOTPGameReporter
    //    
    //    
        class SportsOTPGameReporter : public CustomGameReporter
        {
            NON_COPYABLE(SportsOTPGameReporter);
            ...
            public:
                SportsOTPGameReporter(GameReporting::GameReport& report);
                ~SportsOTPGameReporter() override;
