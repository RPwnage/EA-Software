...
namespace GameManager { class ExternalSessionUtilPs4; class ExternalSessionUtilPs5; class ExternalSessionUtilXboxOne; struct ExternalSessionChangeableBinaryDataHead; }
...
public:
    ...
    Blaze::BlazeRpcError getXblExternalSessionParams(EA::TDF::ObjectType entityType, Blaze::EntityId gameId, const UserIdentification& ident,
    ...
    DEFINE_ASYNC(retrieveExternalSessionXbox(const Blaze::XblScid& scid, const Blaze::XblSessionTemplateName& sessionTemplateName, const Blaze::XblSessionName& sessionName, const Blaze::XblContractVersion& contractVersion, Arson::GetXblMultiplayerSessionResponse &arsonResponse));
    DEFINE_ASYNC(getExternalSessionXbox(const Blaze::XblScid& scid, const Blaze::XblContractVersion& contractVersion, const char8_t* sessionTemplateName, const char8_t* sessionName, ArsonXBLServices::ArenaMultiplayerSessionResponse& result));
...
private:
    ...
    static void blazeXblMultiplayerSessionResponseToArsonResponse(const ArsonXBLServices::ArenaMultiplayerSessionResponse& mpsdResult, Arson::GetXblMultiplayerSessionResponse &arsonResponse);
