...
namespace GameManager
{
    ...
    *************************************************************************************************/
    ...
    public:
        ...
        void sendNotifyGameListUpdateToUserSessionById(UserSessionId ownerSessionId, NotifyGameListUpdate* notifyGameListUpdate, bool sendImmediately, uint32_t msgNum);
    ...
    private:
        ...
        Blaze::BlazeRpcError createGameList(GetGameListRequest& request, ListType listType,
            GameBrowserList*& newList, MatchmakingCriteriaError &error, uint32_t msgNum, uint32_t& numGamesToBeDownloaded, FitScore& maxPossibleFitScore, 
        ...
        BlazeRpcError getNextUniqueSessionId(uint64_t& listId) const;
    ...
    private:
        ...
        BlazeRpcError terminateGameBrowserList(GameBrowserList& list, bool terminateRemoteList = true);
