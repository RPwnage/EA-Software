...
typedef struct NetConnRefT
{
    ...
    uint8_t bChatRestricted;    //!< whether user is chat restricted or not
...
/*!
    ...
    \Notes
        ...
        \verbatim
            chat: set underage flag for user
...
int32_t NetConnControl(int32_t iControl, int32_t iValue, int32_t iValue2, void *pValue, void *pValue2)
{
    ...
    if (iControl == 'chat')
    {
        pRef->bChatRestricted = (uint8_t)iValue;
        return(0);
    }
...
/*!
    ...
    \Notes
        ...
        \verbatim
            ...
            chat: TRUE if local user is chat restricted, else FALSE
