...
/*F********************************************************************************/
/*!
    \Function ds_gmtoffset

    \Description
        This function returns the current system time as its offset from GMT in
        seconds. There is no direct equivilent function in the standard C libraries.

    \Output int32_t - local timezone offset from GMT in seconds

    \Notes
        This is like ds_timezone but takes daylight savings time into account

    \Version 06/10/2020 (eesponda)
*/
/********************************************************************************F*/
int32_t ds_gmtoffset(void)
{
    time_t iGmt, iLoc;
    static int32_t iZone = -1;
    int32_t iDst;
