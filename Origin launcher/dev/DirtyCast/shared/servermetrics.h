...
#define SERVERMETRICS_ERR_UNSUPPORTED_VALUETYPE     (-4)
#define SERVERMETRICS_ERR_UNSUPPORTED_SAMPLERATE    (-5)
#define SERVERMETRICS_ERR_INCORRECT_DATA            (-6)
#define SERVERMETRICS_ERR_OUT_OF_MEMORY             (-7)
#define SERVERMETRICS_ERR_ENTRY_TOO_LARGE           (-8)
#define SERVERMETRICS_ERR_ACCUMULATION_OVERFLOW     (-9)
...
typedef enum ServerMetricsValuesE
{
    SERVERMETRICS_VALUES_UINT64 = 0,
    SERVERMETRICS_VALUES_FLOAT
} ServerMetricsValuesE;
