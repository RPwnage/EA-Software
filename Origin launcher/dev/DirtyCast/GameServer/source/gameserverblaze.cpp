...
void GameServerBlazeGameListenerC::GameReset(Blaze::BlazeError iError, Blaze::GameManager::Game *pGame)
{
    ...
    DirtyCastLogPrintfVerbose(_GetDebugLevel(iError), 0, "gameserverblaze: GameReset (err=%d/%s)\n", iError, pBlazeServer->pBlazeHub->getErrorName(iError));
...
void GameServerBlazeGameListenerC::HostEjected(Blaze::BlazeError iError, Blaze::GameManager::Game *pGame, Blaze::JobId Id)
{
    ...
    DirtyCastLogPrintfVerbose(_GetDebugLevel(iError), 0, "gameserverblaze: HostEjected (err=%d/%s)\n", iError, pBlazeServer->pBlazeHub->getErrorName(iError));
...
{
    GameServerBlazeT *pBlazeServer = _pGameServerBlaze;
    DirtyCastLogPrintfVerbose(_GetDebugLevel(iError), 0, "gameserverblaze: GameEnded (err=%d/%s)\n", iError, pBlazeServer->pBlazeHub->getErrorName(iError));
...
{
    GameServerBlazeT *pBlazeServer = _pGameServerBlaze;
    DirtyCastLogPrintfVerbose(_GetDebugLevel(iError), 0, "gameserverblaze: InitGameComplete (err=%d/%s)\n", iError, pBlazeServer->pBlazeHub->getErrorName(iError));
}
...
void GameServerBlazeGameListenerC::PlayerKicked(Blaze::BlazeError iError, Blaze::GameManager::Game *pGame, const Blaze::GameManager::Player *pPlayer)
{
    ...
    GameServerBlazeT *pBlazeServer = _pGameServerBlaze;
    DirtyCastLogPrintfVerbose(_GetDebugLevel(), DIRTYCAST_DBGLVL_BLAZE, "gameserverblaze: PlayerKicked (err=%d/%s)\n", iError, pBlazeServer->pBlazeHub->getErrorName(iError));
}
...
void GameServerBlazeGameListenerC::onGameEnded(Blaze::GameManager::Game *pGame)
{
    ...
    DirtyCastLogPrintfVerbose(_GetDebugLevel(), 0, "gameserverblaze: onGameEnded\n");
...
void GameServerBlazeGameListenerC::onGameReset(Blaze::GameManager::Game *pGame)
{
    ...
    DirtyCastLogPrintfVerbose(_GetDebugLevel(), 0, "gameserverblaze: onGameReset\n");
...
{
    DirtyCastLogPrintfVerbose(_GetDebugLevel(), 0, "gameserverblaze: onReturnDServerToPool\n");
}
