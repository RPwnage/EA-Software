...
//mapped error codes from blazeserver\framework\oauth\nucleus\error_codes.h
bool OAuthUtil::is4xxError(const BlazeRpcError rpcError)
{
    switch (rpcError)
    {
        case OAUTH_ERR_INVALID_REQUEST:
        case OAUTH_ERR_INVALID_CODE:
        case OAUTH_ERR_CODE_ALREADY_USED:
        case OAUTH_ERR_CODE_ALREADY_DISABLED:
        case OAUTH_ERR_NO_ASSOCIATED_PRODUCT:
        case OAUTH_ERR_INVALID_USER:
        case OAUTH_ERR_GROUP_NAME_DOES_NOT_MATCH:
        case OAUTH_ERR_NO_SUCH_GROUP:
        case OAUTH_ERR_PERSONA_NOT_FOUND:
        case OAUTH_ERR_ENTITLEMENT_TAG_MISSING:
        case OAUTH_ERR_INVALID_FIELD:
        case OAUTH_ERR_INVALID_PRODUCT_CONFIGURATION:
        case OAUTH_ERR_MULTIPLE_WALLET_ACCOUNTS_FOUND:
        case OAUTH_ERR_RESTRICTION_VIOLATION:
        case OAUTH_ERR_USER_DOES_NOT_MATCH_PERSONA:
        case OAUTH_ERR_FIELD_MISSING:
        case OAUTH_ERR_NO_XBLTOKEN:
        case OAUTH_ERR_EXPIRED_1PTOKEN:
        case OAUTH_ERR_INVALID_SANDBOX_ID:
            return true;
        default:
            return false;
    }
