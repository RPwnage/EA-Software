...
private:
    ...
    // Used to support writing logs after forking when writing a core file (see class CoreFileWriter)
    static bool isLogToStdOutEnabled() { return mMainLogToStdout; }
    static bool isLogToFileEnabled() { return mMainLogToFile; }
    static int getMainLogFd();
