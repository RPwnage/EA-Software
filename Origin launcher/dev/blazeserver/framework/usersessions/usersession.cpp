...
void UserSession::updateUsers(UserSessionId targetId, const BlazeIdList& blazeIds, SubscriptionAction action, bool includeSessionSubscription)
{
    UserSessionIdList targetIds;
    targetIds.push_back(targetId);
    updateUsers(targetIds, blazeIds, action, includeSessionSubscription);
}

void UserSession::updateUsers(const UserSessionIdList& targetIds, BlazeId blazeId, SubscriptionAction action, bool includeSessionSubscription)
{
...
void UserSession::updateUsers(const UserSessionIdList& targetIds, const BlazeIdList& blazeIds, SubscriptionAction action, bool includeSessionSubscription)
{
    NotifyUpdateUserSubscriptions update;
    update.setAction(action);
    update.setIncludeSessionSubscription(includeSessionSubscription);
...
void UserSession::mutualSubscribe(UserSessionId userSessionId, const UserSessionIdList& userSessionIds, SubscriptionAction action)
{
    ...
    case ACTION_ADD:
        ...
        updateUsers(userSessionId, blazeIds, action, true);
        ...
        updateUsers(userSessionIds, blazeId, action, true);
        break;
    case ACTION_REMOVE:
