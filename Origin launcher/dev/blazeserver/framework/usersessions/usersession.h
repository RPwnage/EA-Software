...
public:
    ...
    static void updateUsers(UserSessionId targetId, const BlazeIdList& blazeIds, SubscriptionAction action, bool includeSessionSubscription = false);
    static void updateUsers(const UserSessionIdList& targetIds, BlazeId blazeId, SubscriptionAction action, bool includeSessionSubscription);
    static void updateUsers(const UserSessionIdList& targetIds, const BlazeIdList& blazeIds, SubscriptionAction action, bool includeSessionSubscription);
