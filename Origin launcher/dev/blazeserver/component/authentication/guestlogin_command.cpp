        ...
        if (err != Blaze::ERR_OK)
        {
            ...
            if (parentSession != nullptr)
            {
                ...
                gUserSessionMaster->generateLoginEvent(err, getUserSessionId(), USER_SESSION_GUEST,
                    ...
                    getPeerInfo()->getLocale(), getPeerInfo()->getCountry(), getPeerInfo()->getClientInfo()->getBlazeSDKVersion(), getPeerInfo()->getClientType(), addrStr, serviceName, productName, geoIpData, mComponent->getProjectId(parentSession->getProductName()),
            ...
            else
            {
                ...
                gUserSessionMaster->generateLoginEvent(err, getUserSessionId(), USER_SESSION_GUEST,
                    ...
                    getPeerInfo()->getLocale(), getPeerInfo()->getCountry(), sdkVersion, getPeerInfo()->getClientType(), addrStr, serviceName, productName, geoIpData, mComponent->getProjectId(productName),
