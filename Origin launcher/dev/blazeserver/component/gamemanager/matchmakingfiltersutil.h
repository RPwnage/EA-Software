...
namespace GameManager
{
    ...
    class PropertyManager
    {
        ...
        typedef eastl::hash_map<eastl::string, eastl::string, CaseInsensitiveStringHash, CaseInsensitiveStringEqualTo> CaseInsensitiveStringMap;
    ...
    public:
        ...
        bool onReconfigure(const PropertyConfig& config);
        ...
        const PropertyNameList& getGameBrowserPackerProperties() const { return mGameBrowserPackerPropertiesList; }
        ...
        bool convertPropertiesToPackerActiveGameData(EA::TDF::TdfPtr& outActiveGameData, const PropertyNameMap& activeGameProperties) const;
...
// PACKR_TODO - Below are old functions/design:
        ...
        eastl::string getMappedCgrAttribute(const char8_t* gameProperty);
    ...
    private:
        ...
        CaseInsensitiveStringMap mCgRequestPropertyNameMapping;
        CaseInsensitiveStringMap mGqfPropertyCgrReqMapping;

        PropertyConfig mPropertyConfig;
        PropertyNameList mGameBrowserPackerPropertiesList;
