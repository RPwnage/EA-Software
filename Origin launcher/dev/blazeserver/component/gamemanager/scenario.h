...
namespace GameManager
{
    ...
    public:
        ...
        void cancelAllLegacyScenarios();
        bool loadScenarioConfigInfoFromDB();
        const ScenariosConfig* getScenariosConfig() { return mConfig; }
        ...
        ***************************************************************************************************/
        BlazeRpcError startMatchmaking(const StartMatchmakingRequest &request, StartMatchmakingInternalResponse &response, 
            ...
            const StartMatchmakingInternalRequest& subMasterRequest, bool hasBadReputation = false, PackerSessionInternalRequest* outPackerSessionReq = nullptr);

        BlazeRpcError startPackerMatchmaking(const StartPackerScenarioRequest &packerReq, StartMatchmakingScenarioResponse &response, MatchmakingCriteriaError &error);
    ...
    private:
        ...
        EA::TDF::TdfHashValue getScenarioRuleAttributesHash(const ScenarioRuleAttributes& scenarioRuleAttributes) const;
        EA::TDF::TdfHashValue getMatchmakingFilterAttributesHash(const MatchmakingFilterDefinition& filterDefinition) const;
        EA::TDF::TdfHashValue getInputSanitizerAttributesHash(const SanitizerDefinition& sanitizerDefinition) const;
        EA::TDF::TdfHashValue getGameQualityFactorsHash(const PackerConfig& templatePackerConfig) const;

        EA::TDF::TdfHashValue getTemplateAttributeTdfMappingHash(const TemplateAttributeTdfMapping& templateAttributeTdfMapping) const;
        ...
        void computeScenarioHash(const SubSessionName& subSessionName, const SubSessionConfig* subSessionConfig, 
            const ScenarioRuleMap& scenarioRuleMap, const MatchmakingFilterMap& matchmakingFilterMap, const CreateGameTemplateMap& cgTemplateMap, EA::TDF::TdfHashValue& scenarioHash);
        ...
        BlazeRpcError convertMatchmakingComponentErrorToGameManagerError(const BlazeRpcError &mmRpcError) const;
        BlazeRpcError convertGamePackerErrorToGameManagerError(const BlazeRpcError &mmRpcError) const;
    ...
    public:
        ...
        bool getIsPackerScenario() const;

    private:
        BlazeRpcError cancelPackerScenarioInternal();
    ...
    public:
        ...
        BlazeRpcError start(StartMatchmakingScenarioResponse& response, MatchmakingCriteriaError& critErr, const InetAddress& callerNetworkAddress,
                            StartMatchmakingInternalRequest& masterRequest, bool hasBadReputation, PackerSessionInternalRequest* outPackerSessionReq, CallerProperties& callerSourceProperties);
        void finish();
    ...
    public:
        ...
        bool getIsPackerSubsession() const { return mIsPackerSubsession; }

        bool mIsPackerSubsession;
