...
namespace GameManager
{
    ...
    */
    ...
    private:
        ...
        {
            BlazeRpcError err = mComponent.getGameBrowser().processCreateGameList(mRequest, GameManager::GAME_BROWSER_LIST_SNAPSHOT, mResponse, mErrorResponse, getMsgNum(), nullptr);
