...
public class TdfSymbol extends HashToken 
{
    ...
    public TdfSymbol addSymbol(TdfSymbol symbol, TdfSymbol.SymbolType symbolType) 
    {
        ...
        {
        	String err = "Duplicate Symbol Defined: " + symbol.getAttributedName();
    ...
    public static boolean isCategoryPrimitive(Category c) { return (c == Category.INT_PRIMITIVE || c == Category.FLOAT_PRIMITIVE || c == Category.ENUM || c == Category.BLAZE_OBJECT_TYPE || c == Category.BLAZE_OBJECT_ID); }
