...
typedef void (ProtoHttpServCompleteCbT)(ProtoHttpServRequestT *pRequest, ProtoHttpServResponseT *pResponse, void *pUserData);
...
// set httpserv callback function handlers (required)
DIRTYCODE_API void ProtoHttpServCallback2(ProtoHttpServRefT *pHttpServ, ProtoHttpServRequestCbT *pRequestCb, ProtoHttpServReceiveCbT *pReceiveCb, ProtoHttpServSendCbT *pSendCb, ProtoHttpServHeaderCbT *pHeaderCb, ProtoHttpServCompleteCbT *pCompleteCb, ProtoHttpServLogCbT *pLogCb, void *pUserData);
