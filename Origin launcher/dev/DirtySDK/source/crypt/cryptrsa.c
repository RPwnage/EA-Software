...
/*F********************************************************************************/
/*!
    \Function CryptRSACleanup

    \Description
        Cleans up a previously initialized RSA state.  Initialization state is not
        tracked by this module and must be managed externally.
...
*/
/********************************************************************************H*/
void CryptRSACleanup(CryptRSAT *pState)
{
    if (pState->pTable == NULL)
    {
        return;
