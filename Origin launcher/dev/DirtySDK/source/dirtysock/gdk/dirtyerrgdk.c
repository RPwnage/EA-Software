...
static DirtyErrT _DirtyErr_List[] =
{
    ...
    */
    ...
    DIRTYSOCK_ErrorName(ERROR_NOT_ENOUGH_MEMORY),   // 8
    ...
    */
    ...
    DIRTYSOCK_ErrorName(E_ABORT),                       // 0x80004004L
    DIRTYSOCK_ErrorName(E_FAIL),                        // 0x80004005L

    DIRTYSOCK_ErrorName(E_ACCESSDENIED),                // 0x80070005L
    ...
    DIRTYSOCK_ErrorName(INET_E_INVALID_URL),                    // 0x800C0002L
    DIRTYSOCK_ErrorName(INET_E_NO_SESSION),                     // 0x800C0003L
    DIRTYSOCK_ErrorName(INET_E_CANNOT_CONNECT),                 // 0x800C0004L
    DIRTYSOCK_ErrorName(INET_E_RESOURCE_NOT_FOUND),             // 0x800C0005L
    DIRTYSOCK_ErrorName(INET_E_OBJECT_NOT_FOUND),               // 0x800C0006L
    DIRTYSOCK_ErrorName(INET_E_DATA_NOT_AVAILABLE),             // 0x800C0007L
    DIRTYSOCK_ErrorName(INET_E_DOWNLOAD_FAILURE),               // 0x800C0008L
    DIRTYSOCK_ErrorName(INET_E_AUTHENTICATION_REQUIRED),        // 0x800C0009L
    DIRTYSOCK_ErrorName(INET_E_NO_VALID_MEDIA),                 // 0x800C000AL
    DIRTYSOCK_ErrorName(INET_E_CONNECTION_TIMEOUT),             // 0x800C000BL
    DIRTYSOCK_ErrorName(INET_E_INVALID_REQUEST),                // 0x800C000CL
    DIRTYSOCK_ErrorName(INET_E_UNKNOWN_PROTOCOL),               // 0x800C000DL
    DIRTYSOCK_ErrorName(INET_E_SECURITY_PROBLEM),               // 0x800C000EL
    DIRTYSOCK_ErrorName(INET_E_CANNOT_LOAD_DATA),               // 0x800C000FL
    DIRTYSOCK_ErrorName(INET_E_CANNOT_INSTANTIATE_OBJECT),      // 0x800C0010L
    DIRTYSOCK_ErrorName(INET_E_INVALID_CERTIFICATE),            // 0x800C0019L
    DIRTYSOCK_ErrorName(INET_E_REDIRECT_FAILED),                // 0x800C0014L
    DIRTYSOCK_ErrorName(INET_E_REDIRECT_TO_DIR),                // 0x800C0015L
...
void DirtyErrNameList(char *pBuffer, int32_t iBufSize, uint32_t uError, const DirtyErrT *pList)
{
    ...
    // if not found, try again with the facility code masked; see https://docs.microsoft.com/en-us/openspecs/windows_protocols/ms-erref/0642cb2f-2075-4469-918c-4441e69c548a
    for (iErr = 0; pList[iErr].uError != DIRTYSOCK_LISTTERM; iErr++)
    {
        if ((pList[iErr].uError & ~0x0eff0000) == (uError & ~0x0eff0000))
        {
            ds_snzprintf(pBuffer, iBufSize, "%s/0x%08x", pList[iErr].pErrorName, uError);
            return;
        }
