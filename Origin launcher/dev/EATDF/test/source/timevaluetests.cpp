...
// Test Daylight Savings Time date+time parsing
{
    ...
    tm tM;
    EA::TDF::TimeValue::gmTime(&tM, t1.getMicroSeconds()); int64_t v1 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, t2.getMicroSeconds()); int64_t v2 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, t3.getMicroSeconds()); int64_t v3 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, t4.getMicroSeconds()); int64_t v4 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, t5.getMicroSeconds()); int64_t v5 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, t6.getMicroSeconds()); int64_t v6 = EA::TDF::TimeValue::mkgmTime(&tM);
    ...
    EA::TDF::TimeValue::gmTime(&tM, lt1.getMicroSeconds()); int64_t lv1 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, lt2.getMicroSeconds()); int64_t lv2 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, lt3.getMicroSeconds()); int64_t lv3 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, lt4.getMicroSeconds()); int64_t lv4 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, lt5.getMicroSeconds()); int64_t lv5 = EA::TDF::TimeValue::mkgmTime(&tM);
    EA::TDF::TimeValue::gmTime(&tM, lt6.getMicroSeconds()); int64_t lv6 = EA::TDF::TimeValue::mkgmTime(&tM);
