...
namespace NAnt.Core.Logging
{
	...
	public class Log
	{
		...
		public enum DeprecationId
		{
			...
			ModuleTargetFrameworkVersion = 27   // trying to set target framework version on per module level, this is only settable by DotNet or DotNetSdk package versions
		}
		...
		public void WriteIf(bool condition, string output)
		{
		...
		public void WriteLineIf(bool condition, string output)
		{
