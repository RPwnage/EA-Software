...
namespace NAnt.Core.Tasks
{
	...
	public class DoOnce : TaskContainer
	{
		...
		/// <item><b>project</b> context means that for each unique key task is executed once for each project. 
		/// A project is typically created once per package per configuration, but more may be created if nested &lt;nant&gt; 
		/// tasks are used to create additional build graphs.</item>
		/// </list>
		/// </summary>
