	...
	public class ForEachTask : TaskContainer
	{
		...
		public string Property
		{
			...
			set
			{
				...
				{
					string msg = String.Format("Property '{0}' is readonly and can not be used in 'foreach' task.", _propertyName);
		...
		{
			Properties.Add(_propertyName, propertyValue, false, false, Local);
			base.ExecuteTask();
		}
	}
}
