...
namespace EA.Eaconfig.Structured
{
	...
	public class DotNetModuleTask : ModuleBaseTask
	{
		...
		private static readonly string[] _compilers =new string[] {"cc", "as", "csc" };
		...
		/// <summary></summary>
		[BuildElement("nugetreferences", Required = false)]
		...
		protected void SetupBuildData()
		{
			...
			SetModuleProperty("nugetreferences", NugetReferences);
		...
		public class DotNetConfigElement : ConditionalElementContainer
		{
			...
			(
				...
				"Target .NET version is now determined by .NET family and the relevant DotNet or DotNetSdk package version in masterconfig."
			);
