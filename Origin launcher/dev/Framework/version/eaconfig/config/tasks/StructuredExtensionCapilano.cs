...
{
	[TaskName("structured-extension-capilano", XmlSchema = false)]
	class StructuredExtensionCapilano : PlatformExtensionBase
	{
		/// <summary>
		...
		private void SetLayout()
		{
            ...
            {
                exclusionFilter = Properties["eaconfig.capilano.layout-exclusion-filter"] ?? "";
            }
	...
	[ElementName("CapilanoLayout", StrictAttributeCheck = true, NestedElementsCheck = true)]
	...
	[ElementName("CapilanoDeployment", StrictAttributeCheck = true, NestedElementsCheck = true)]
