...
namespace EA.CapilanoConfig
{
	...
	public class CapilanoVisualStudioExtension : IMCPPVisualStudioExtension
	{
		...
		{
			Generator.WriteUniqueTarget("GeneratePackageRuntimeMetadata", () =>
			{
			...
			Generator.WriteUniqueTarget(deployTargetName, () =>
			{
			...
			{
				Generator.WriteUniqueTarget("_InjectMakePriPath", () =>
				{
			...
			if (isGdkEnabled)
			{
				Generator.WriteUniqueTarget("Layout_Target", () =>
				{
