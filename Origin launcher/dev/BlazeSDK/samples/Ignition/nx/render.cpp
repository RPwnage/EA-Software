/*H*************************************************************************************/
/*!
    \File render.cpp (copied from DirtySDK/sample/tester2/source/nx/t2nxrender.cpp)
...
{
    return pApp->T2RenderInit();
}
void T2RenderUpdate(T2Render *pApp)
{
    pApp->T2RenderUpdate();
}
void T2RenderTerm(T2Render *pApp)
{
    pApp->T2RenderTerm();
}
...
/*!
    ...
    \Output
        void* - allocated memory, nullptr if failed
...
bool T2Render::InitializeFileSys()
{
    ...
    if (pMountRomCacheBuffer == nullptr)
    {
...
void T2Render::InitializeGraphicAllocator()
{
        ...
        nv::SetGraphicsAllocator(RenderAllocate, RenderFree, RenderReallocate, nullptr);
        ...
        nv::SetGraphicsDevtoolsAllocator(RenderAllocate, RenderFree, RenderReallocate, nullptr);
...
void T2Render::InitializeSwapChain()
{
    ...
    {
        mSwapChain.Initialize(&mDevice, swapChainInfo, nullptr, 0, 0);
    }
}
...
void T2Render::InitializeVertexState()
{
    ...
    mVertexState.Initialize(&mDevice, vertexStateInfo, nullptr);
}
...
void T2Render::InitializeVertexBuffer()
{
    ...
    {
        mVertextBuffer.Initialize(&mDevice, bufferInfo, nullptr, 0, 0);
    }
...
void T2Render::InitializeIndexBuffer()
{
    ...
    {
        mIndexBuffer.Initialize(&mDevice, bufferInfo, nullptr, 0, 0);
    }
...
void T2Render::InitializeConstantBuffer()
{
    ...
    {
        mConstantBuffer.Initialize(&mDevice, constantBufferInfo, nullptr, 0, 0);
    }
}
...
void T2Render::MakeCommand(int32_t iFrame, nn::gfx::ColorTargetView *pTarget, nn::gfx::CommandBuffer *pCommandBuffer)
{
...

    {
        ...
        pCommandBuffer->ClearColor(pTarget, 0.0f, 1.5f, 0.2f, 1.0f, nullptr);
...
void T2Render::T2RenderUpdate()
{
    ...
    // execute command
    mQueue.ExecuteCommand(pCommandBuffer, nullptr);
