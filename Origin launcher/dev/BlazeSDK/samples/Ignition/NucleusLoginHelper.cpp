...
void NucleusLoginHelper::startConsoleLogin()
{
    ...
    EA::Nucleus::Globals::SetAuthenticationSource(IGNITION_AUTH_SOURCE);
    mIdentitySession = EA::Nucleus::IIdentitySession::Create(IGNITION_CLIENT_ID, IGNITION_CLIENT_SECRET, this, nullptr);
...
void NucleusLoginHelper::initNucleusSDK(const char8_t* sonyPsnClientId)
{
    ...
    EA::Nucleus::Globals::SetClientSideRedirectUri(IGNITION_REDIRECT_URI);
