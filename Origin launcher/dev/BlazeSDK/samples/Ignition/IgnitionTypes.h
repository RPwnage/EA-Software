...
namespace Ignition
{
    ...
    enum LoginAuthenticationOption
    {
        AUTH_CODE,
        JWT_ACCESS_TOKEN
    };
...
namespace Pyro
{
    ...
    template<>
    class PyroCustomEnumValues<Ignition::LoginAuthenticationOption> : public EnumNameValueCollectionT<Ignition::LoginAuthenticationOption>
    {
    public:
        static const PyroCustomEnumValues<Ignition::LoginAuthenticationOption> &getInstance()
        {
            static PyroCustomEnumValues<Ignition::LoginAuthenticationOption> instance;
            return instance;
        }

    private:
        PyroCustomEnumValues() : EnumNameValueCollectionT<Ignition::LoginAuthenticationOption>("Ignition::LoginAuthenticationOption")
        {
            add("Auth Code", (int32_t)Ignition::AUTH_CODE);
            add("JWT Access Token", (int32_t)Ignition::JWT_ACCESS_TOKEN);
        }
    };
