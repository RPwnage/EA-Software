...
namespace GameManager
{
    ...
    ***************************************************************************************************/
        ...
        : PlayerInfo(BLAZE_NEW ReplicatedGamePlayerServer), mPlayerDataMaster(BLAZE_NEW PlayerDataMaster)
    {
        ...
        mPlayerData->setScenarioName(request.getUserJoinInfo().getScenarioInfo().getScenarioName());

        request.getUserJoinInfo().getScenarioInfo().copyInto(mPlayerDataMaster->getScenarioInfo());
