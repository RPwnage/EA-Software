    ...
    namespace GameManager
    {
        class ExternalSessionUtilXboxOne : public ExternalSessionUtil
        {
            public:
                ...
                ***************************************************************************************************/
                ExternalSessionUtilXboxOne(ClientPlatformType platform, const ExternalSessionServerConfig& config, const TimeValue& reservationTimeout, bool titleIdIsHex)
        ...
        private:
            ...
            Blaze::BlazeRpcError getExternalSession(const char8_t* sessionTemplateName, const char8_t* sessionName, XBLServices::MultiplayerSessionResponse& result);
            ...
            const char8_t* toVisibility(PresenceMode presenceMode) const;
