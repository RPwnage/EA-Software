...
#ifndef FRIENDLIESGAMESESSION_H
#define FRIENDLIESGAMESESSION_H
...
class FriendliesGameSession : public GameSession {
        NON_COPYABLE(FriendliesGameSession);

    public:
        FriendliesGameSession(StressPlayerInfo* playerData, uint32_t GameSize, GameNetworkTopology Topology, GameProtocolVersionString GameProtocolVersionString);
        virtual ~FriendliesGameSession();
