...
PLATFORM:
    ALTER TABLE `userinfo`
      MODIFY COLUMN `persona` varchar(255) DEFAULT NULL,
      MODIFY COLUMN `canonicalpersona` varchar(255) DEFAULT NULL;
...
COMMON:
    ALTER TABLE `accountinfo`
      MODIFY COLUMN `canonicalpersona` varchar(255) DEFAULT NULL COMMENT 'canonical version of origin id',
      MODIFY COLUMN `originpersonaname` varchar(255) DEFAULT NULL;
