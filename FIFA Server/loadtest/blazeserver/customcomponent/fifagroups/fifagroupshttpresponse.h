...
#ifndef BLAZE_FIFA_GROUPS_HTTP_RESPONSE_H
#define BLAZE_FIFA_GROUPS_HTTP_RESPONSE_H
	...
	namespace FifaGroups
	{
			...
			public EA::Json::IJsonDomReaderCallback
		{
			public:
				...
				int64_t mErrorCode;
				Blaze::FifaGroups::AttributeList mAttributes;
...
#endif // BLAZE_FIFA_GROUPS_HTTP_RESPONSE_H
