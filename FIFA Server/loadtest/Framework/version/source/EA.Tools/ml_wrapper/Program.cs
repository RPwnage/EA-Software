    ...
    class Program
    {
        ...
        static int Main(string[] args)
        {
            try
            {
                ...
                return EA.CPlusPlusTasks.VCCallerWithDependency.Execute(EA.CPlusPlusTasks.VCCallerWithDependency.ProgramType.ASSEMBLER, CLExePath, CLExeArguments, SrcFile, ObjFile, DepFile, Verbose);
            }
            catch (Exception e)
            {
        ...
        {
            Console.WriteLine("Usage: ml_wrapper.exe </src:<srcfile>> </obj:<objfile>> [/dep:<depfile>] [/verbose] <full_path to real assembler exe> <... real assembler exe pass through arguments ...>");
            Console.WriteLine();
        }
