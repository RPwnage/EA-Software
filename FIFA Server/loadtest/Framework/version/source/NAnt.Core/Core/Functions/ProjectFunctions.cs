...
namespace NAnt.Core.Functions
{
	...
	public class ProjectFunctions : FunctionClassBase
	{
		...
		{
            return project.LastError?.Message ?? String.Empty;
		}
		...
		{
            return project.LastError?.InnerException?.Message ?? String.Empty;
		}
		...
		{
			throw new BuildException($"ProjectGetDefaultTarget function is deprecated. If you need the project default target use property '{Project.NANT_PROPERTY_PROJECT_DEFAULT}'.");
		}
	}
}