...
namespace EA.Eaconfig.Structured
{
	...
	[ElementName("buildsteps", StrictAttributeCheck = true, NestedElementsCheck=true)]
	public class BuildStepsElement : ConditionalElementContainer
	{
		public BuildStepsElement(ModuleBaseTask module)
		{
			PackagingData = new PackagingElement(module);
		}

		/// <summary>Sets the prebuild steps for a project</summary>
		[Property("prebuild-step", Required = false)]
		public BuildTargetElement PrebuildTarget { get; } = new BuildTargetElement("prebuildtarget");

		/// <summary>Sets the postbuild steps for a project</summary>
		[Property("postbuild-step", Required = false)]
		public PostBuildTargetElement PostbuildTarget { get; set; } = new PostBuildTargetElement("postbuildtarget");
		...
		public CustomBuildStepElement CustomBuildStep { get; set; } = new CustomBuildStepElement();

		/// <summary>Sets the packaging steps for a project</summary>
		[BuildElement("packaging", Required = false)]
		public PackagingElement PackagingData { get; }

		/// <summary>Sets the run steps for a project</summary>
		[BuildElement("run", Required = false)]
		public RunDataElement RunData { get; } = new RunDataElement();
	}
}
