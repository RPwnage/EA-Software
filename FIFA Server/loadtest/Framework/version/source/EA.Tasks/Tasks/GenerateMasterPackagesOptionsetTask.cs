...
namespace EA.FrameworkTasks
{
	...
	public class GenerateMasterPackagesOptionsetTask : Task
	{
		...
		public static OptionSet Execute(Project project)
		{
			...
			foreach (string package in PackageMap.Instance.MasterPackages)
			{
				masterPackages.Options.Add(package, PackageMap.Instance.GetMasterPackage(project, package).Version);
			}
