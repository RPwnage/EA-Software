	...
	public class WriteBuildInfo : Task
	{
		...
		private string ModuleTypeToString(Module module)
		{
			var names = GetBitNames(module.Type,
				new[] { Module.Native, Module.DotNet, Module.Utility, Module.MakeStyle, Module.Managed, Module.CSharp, Module.FSharp, Module.EASharp, Module.Program, Module.Library, Module.DynamicLibrary },
				new[] { "Native", "DotNet", "Utility", "MakeStyle", "Managed", "CSharp", "FSharp", "EASharp", "Program", "Library", "DynamicLibrary" });
