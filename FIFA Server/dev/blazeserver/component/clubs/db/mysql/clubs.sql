...
COMMON:
    ...
    CREATE TABLE `clubs_clubs` (
      ...
      `lastOppo` bigint(20) unsigned DEFAULT NULL,
      `lastResult` varchar(32) NOT NULL DEFAULT '',
      `lastGameTime` datetime DEFAULT '1970-01-01 00:00:01',
      ...
      `metaData2` varbinary(4096) NOT NULL,
      ...
      `lastUpdatedBy` bigint(20) unsigned NOT NULL,
      `isNameProfane` tinyint(1) DEFAULT '0',
	  `clubNameResetCount` int(10) NOT NULL DEFAULT '0',
     PRIMARY KEY (`clubId`),
    ...
    CREATE TABLE `clubs_news` (
      ...
      `contentCreator` bigint(20) NOT NULL,
    ...
    CREATE TABLE `clubs_seasons` (
      ...
      `lastUpdated` datetime NOT NULL DEFAULT '1970-01-01 00:00:01',
      PRIMARY KEY `index_clubs_seasons_state` (`state`)
    ) ENGINE=InnoDB DEFAULT CHARSET=utf8;
    ...
    CREATE TABLE `clubs_tickermsgs` (
      `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
      `clubId` bigint(20) unsigned NOT NULL,
      `includeUserId` bigint(20) NOT NULL,
      `excludeUserId` bigint(20) NOT NULL,
      `text` varchar(2048) NOT NULL,
