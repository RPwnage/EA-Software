...
private:
    ...
    PackerCreateGameError::Error processPackerCreateGame(const Blaze::GameManager::PackerCreateGameRequest &request, Blaze::GameManager::CreateGameMasterResponse &response, const Message* message) override;
    PackerCreateGameWithPrivilegedIdError::Error processPackerCreateGameWithPrivilegedId(const Blaze::GameManager::PackerCreateGameRequest &request, Blaze::GameManager::CreateGameMasterResponse &response, const Message* message) override;
