...
namespace Matchmaker
{
    ...
    public:
        ...
        // Packer usage methods
        void clearTtmEstimates();
        void initializeTtmEstimates(const GameManager::PackerInstanceStatusResponse& packerInstanceStatusResponse);
        void initializeTtmEstimatesForPackerScenario(const Blaze::GameManager::ScenarioName& scenarioName, const TimeValue& scenarioTotalDuration);
        void updateScenarioTimeToMatch(const GameManager::ScenarioName &scenarioName, const TimeValue &scenarioDuration, const PingSiteAlias &pingSite, const GameManager::DelineationGroupType& delineationGroup,
        ...
        TimeValue getTimeToMatchEstimateForPacker(const GameManager::ScenarioName& scenarioName, const TimeValue& scenarioDuration, const PingSiteAlias &pingSite, const GameManager::DelineationGroupType& delineationGroup,
        ...
        void updateNonScenarioTimeToMatch(const TimeValue &scenarioDuration, const PingSiteAlias &pingSite, const GameManager::DelineationGroupType& delineationGroup, const TimeValue& globalMatchEstimateFalloffWindow, GameManager::MatchmakingResult result);
        ...
        const TimeToMatchEstimate* getScenarioTtmEstimate(const ScenarioTimeToMatchEstimate& scenarioTtmEstimate, const PingSiteAlias &pingSite, const GameManager::DelineationGroupType& delineationGroup) const;
    ...
    private:
        void initializeTtmEstimates(const GameManager::InstanceTimeToMatchEstimateData& globalTimeToMatchEstimateData, const GameManager::TimeToMatchEstimateDataPerScenario& scenarioTimeToMatchEstimateData);
