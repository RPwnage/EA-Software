...
#include "customcomponent/arson/rpc/arson_defines.h" //for ARSON_ERR_INVALID_PARAMETER in getMps
...
namespace Arson
{
    ArsonExternalTournamentUtilXboxOne::ArsonExternalTournamentUtilXboxOne(Blaze::ClientPlatformType platform, const ArsonTournamentOrganizerConfig& config)
        ...
        mExternalSessionUtil(BLAZE_NEW GameManager::ExternalSessionUtilXboxOne(platform, config.getExternalSessions(), 0, true, nullptr)),
    ...
    ***************************************************************************************************/
        ...
        ArsonXBLServices::ArenaMultiplayerSessionResponse& result) const
    {
        ...
        {
            ERR_LOG("[ArsonExternalTournamentUtilXboxOne].getMps: invalid sessionName(" << (sessionName != nullptr ? sessionName : "<nullptr>") << ")");
