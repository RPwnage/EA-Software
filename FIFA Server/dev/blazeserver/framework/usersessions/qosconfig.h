...
public:
    ...
    ************************************************************************************/
    bool validateAndCleanupPingSiteAliasMap(PingSiteLatencyByAliasMap &map, int32_t profileVersion) const;
    bool validatePingSiteAliasMap(const PingSiteInfoByAliasMap &map, int32_t profileVersion);
    ...
    int32_t getProfileVersion() const { return mLastRefreshProfileVersion; }
...
private:
    ...
    int32_t mLastRefreshProfileVersion;
