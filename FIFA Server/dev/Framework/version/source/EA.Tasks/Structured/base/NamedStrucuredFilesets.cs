...
namespace EA.Eaconfig.Structured
{
	...
	public class NamedStructuredFileSets : StructuredFileSet
	{
		...
		public IDictionary<string, StructuredFileSet> NamedFilesets { get; } = new Dictionary<string, StructuredFileSet>();
		...
		public override void Initialize(XmlNode elementNode)
		{
			...
			if (NamedFilesets.TryGetValue(FileSetName, out existing))
			{
				existing.Append(fileset);
			}
			else
			{
				NamedFilesets.Add(FileSetName, fileset);
			}
		}
	}
