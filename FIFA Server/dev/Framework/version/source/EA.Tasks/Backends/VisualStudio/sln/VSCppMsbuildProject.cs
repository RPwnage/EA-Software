...
namespace EA.Eaconfig.Backends.VisualStudio
{
	...
	public abstract partial class VSCppMsbuildProject : VSCppProject
	{
		...
		internal VSCppMsbuildProject(VSSolutionBase solution, IEnumerable<IModule> modules)
		...
		// backwards compatibility, IMCPPVisualStudioExtension used to have a layer of indirection,
		// x.Generator.Interace where Generator was a wrapper class for VSCppMsbuildProject and Interface
		...
		// object as generator
		public VSCppMsbuildProject Interface => this;
		...
		protected override void WriteCopyLocalFiles(IXmlWriter writer, bool isNewProjectSystem = false, bool isCsProj = false)
		{
			base.WriteCopyLocalFiles(writer, isNewProjectSystem, isCsProj);
		...
		private IDictionary<string, IList<Tuple<ProjectRefEntry, uint>>> GroupProjectReferencesByConfigConditions(IEnumerable<ProjectRefEntry> projectReferences)
		{
		...
		private void GetProjectReferenceUnreferencedConditions(
		...
		private void GetProjectReferenceConditionsForType(
			IEnumerable<Configuration> allConfigs, 
			IEnumerable<ProjectRefEntry.ConfigProjectRefEntry> projRefConfigEntries, 
			uint requiredType,
		...
		private void WriteReferences(IXmlWriter writer, IEnumerable<ProjectRefEntry> projectReferences, IDictionary<PathString, FileEntry> references, IDictionary<PathString, FileEntry> comreferences, IDictionary<Configuration, ISet<PathString>> referencedAssemblyDirs)
		{
		...
		internal override void WriteComReferences(IXmlWriter writer, ICollection<FileEntry> comreferences)
		{
		...
		internal override void WriteFilesWithFilters(IXmlWriter writer, FileFilters filters)
		{
			// tuple meaning: 
		...
		internal void WriteFile(IXmlWriter writer, FileEntry fileEntry, out string outFileToolName)
		{
		...
		private bool WriteResXFile(IXmlWriter writer, FileEntry fileEntry, out string fileToolName, out PathString filePath)
		{
		...
		private void WriteFilters(string baseFileName, FileFilters filters, List<Tuple<string, PathString, string, bool>> toolFileFilter)
		{
		...
		private void GetReferences(out IEnumerable<ProjectRefEntry> projectReferences, out IDictionary<PathString, FileEntry> references, out IDictionary<PathString, FileEntry> comreferences, out IDictionary<Configuration, ISet<PathString>> referencedAssemblyDirs)
		{
		...
		internal string GetToolMapping(FileEntry.ConfigFileEntry configentry, out OptionSet toolproperties)
		{
			var toolname = "None";
			toolproperties = null;
			if (configentry != null)
