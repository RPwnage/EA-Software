---
title: < WindowsProgram > Task
weight: 1072
---
## Syntax
```xml
<WindowsProgram outputdir="" outputname="" debug="" comment="" name="" group="" frompartial="" buildtype="">
...
## Full Syntax
```xml
<WindowsProgram outputdir="" outputname="" debug="" comment="" name="" group="" frompartial="" buildtype="" failonerror="" verbose="" if="" unless="">
