---
title: < DynamicLibrary > Task
weight: 1055
---
## Syntax
```xml
<DynamicLibrary outputdir="" outputname="" debug="" comment="" name="" group="" frompartial="" buildtype="">
...
## Full Syntax
```xml
<DynamicLibrary outputdir="" outputname="" debug="" comment="" name="" group="" frompartial="" buildtype="" failonerror="" verbose="" if="" unless="">
