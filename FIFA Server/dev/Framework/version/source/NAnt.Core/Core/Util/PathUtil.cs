...
namespace NAnt.Core.Util
{
	public static partial class PathUtil
	{
		...
		/// <summary>
		/// Replaces the directory separators in the path with ones that are correct for the current platform
		/// </summary>
		public static string ReplaceDirectorySeparators(string path)
		{
			return path.Replace(PathNormalizer.AltDirectorySeparatorChar, Path.DirectorySeparatorChar);
		}
	}
}
