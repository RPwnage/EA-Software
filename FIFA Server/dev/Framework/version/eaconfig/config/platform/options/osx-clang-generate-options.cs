...
{
	[TaskName("osx-arm64-clang-generate-options")]
	public class ClangArm64GenerateOptions : ClangGenerateOptions
	{
	}
	...
	public class ClangGenerateOptions : GeneratePlatformOptions
	{
		protected override void SetPlatformOptions()
		{
			...
			AddOptionIf("generatedll", "on", OptionType.link_Options, "-Wl,-install_name,\"@rpath/" + Project.Properties["lib-prefix"] + "%outputname%" + Project.Properties["dll-suffix"] + "\"");
