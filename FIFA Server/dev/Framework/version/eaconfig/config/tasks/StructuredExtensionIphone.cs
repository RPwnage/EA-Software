...
namespace EA.Eaconfig
{
	...
	class StructuredExtensionIPhone : PlatformExtensionBase
	{
		...
		protected override void ExecuteTask()
		{
            ...
            {
				Module.SetModuleProperty("iphone-codesign-entitlements", CodeSignEntitlements.Value.TrimWhiteSpace());
            }

			if (XcodeBuildSettings.Options.Any())
            {
				Module.SetModuleOptionSet("iphone-xcode-buildsettings", XcodeBuildSettings);
            }
		}
	}
