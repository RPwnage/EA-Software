...
struct FieldValueColumn {
    ...
    int16_t mAddTableRefCount = 0; // number of times this column was added as part of a table addition (includes uncommitted additions)
    int16_t mRemoveTableRefCount = 0; // number of times this column was marked for removal as part of a table eviction (cleared to 0 upon commit)
    int16_t mCommittedAddTableRefCount = 0; // number of times this column was added as part of a committed table addition
...
struct FieldValueTable
{
    ...
    void addTable(const FieldValueTable& otherTable, bool intersect);

    void markTableForRemoval(const FieldValueTable& otherTable);
