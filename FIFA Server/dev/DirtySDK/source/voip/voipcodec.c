...
/*F********************************************************************************/
/*!
    \Function VoipCodecResample    

    \Description
        Resample input data to codec default sampling rate

    \Input *pOutBytes       - pointer to output buffer
    \Input uOutBuffSize     - output buffer size in bytes
    \Input pInput           - pointer to input samples
...
*/
/********************************************************************************F*/
int32_t VoipCodecResample(uint8_t *pOutBytes, uint32_t uOutBuffSize, const int16_t *pInput, int32_t iNumSamples)
{
    VoipCodecRegT *pRegEntry;
    int32_t iResult;
    ...
    return(iResult = pRegEntry->pCodecDef->pResample(pRegEntry->pCodecRef, pOutBytes, uOutBuffSize, pInput, iNumSamples));
}
