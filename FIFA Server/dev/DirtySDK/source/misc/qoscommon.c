...
enum 
{
    ...
    CLIENT_TO_COORDINATOR_REQUEST_CLIENT_VERSION
...
enum 
{
    ...
    COORDINATOR_TO_CLIENT_RESPONSE_PROFILE_VERSION
...
uint8_t* QosCommonClientToCoordinatorRequestEncode(const QosCommonClientToCoordinatorRequestT *pClientToCoordinatorRequest, uint8_t *pBuffer, uint32_t uBuffSize, uint32_t *pOutSize)
{
    ...
    if (pEncoder)
    {
        ...
        iError |= ProtobufWriteVarint(pEncoder, pClientToCoordinatorRequest->uClientVersion, CLIENT_TO_COORDINATOR_REQUEST_CLIENT_VERSION);
...
void QosCommonClientToCoordinatorPrint(const QosCommonClientToCoordinatorRequestT *pClientToCoordinatorRequest, uint32_t uLogLevel)
{
    ...
    NetPrintfVerbose((uLogLevel, 1, "qoscommon: cl2co.uClientVersion:               %u\n", pClientToCoordinatorRequest->uClientVersion));
...
int32_t QosCommonCoordinatorToClientResponseDecode(QosCommonCoordinatorToClientResponseT *pResponse, const uint8_t *pBuffer, uint32_t uBuffSize)
{
    ...
    if (pBuffer)
    {
        ...
        pResponse->results.iProfileVersion = (int32_t)ProtobufReadVarint(&Reader, ProtobufReadFind(&Reader, COORDINATOR_TO_CLIENT_RESPONSE_PROFILE_VERSION));
...
void QosCommonCoordinatorToClientPrint(const QosCommonCoordinatorToClientResponseT *pResponse, uint32_t uLogLevel)
{
    ...
    NetPrintfVerbose((uLogLevel, 1, "qoscommon: co2cl.results.iProfileVersion:                    %d\n", pResponse->results.iProfileVersion));
