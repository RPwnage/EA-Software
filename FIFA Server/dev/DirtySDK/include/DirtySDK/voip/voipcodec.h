...
//! resample function type
typedef int32_t (VoipCodecResampleT)(VoipCodecRefT *pState, uint8_t *pOutBytes, uint32_t uOutBuffSize, const int16_t *pInput, int32_t iNumSamples);
...
// resample using active codec (resample to codec default sampling rate)
DIRTYCODE_API int32_t VoipCodecResample(uint8_t *pOutBytes, uint32_t uOutBuffSize, const int16_t *pInput, int32_t iNumSamples);
