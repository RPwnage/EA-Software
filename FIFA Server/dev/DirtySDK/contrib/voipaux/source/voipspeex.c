...
static int32_t _VoipSpeexResample(VoipCodecRefT *pState, uint8_t *pOutBytes, uint32_t uOutBuffSize, const int16_t *pInput, int32_t iNumSamples);
...
/*F*************************************************************************************/
/*!
     \Function _VoipSpeexResample

    \Description
        Resampling is not supported for Speex
