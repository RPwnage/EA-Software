...
namespace NAnt.Core.Functions
{
	...
	public class MathFunctions : FunctionClassBase
	{
		...
		/// <include file='Examples/Math/MathLT.example' path='example'/>
		[Function()]
		...
		/// <include file='Examples/Math/MathLTEQ.example' path='example'/>
		[Function()]
		...
		/// <include file='Examples/Math/MathGT.example' path='example'/>
		[Function()]
		...
		/// <include file='Examples/Math/MathGTEQ.example' path='example'/>
		[Function()]
