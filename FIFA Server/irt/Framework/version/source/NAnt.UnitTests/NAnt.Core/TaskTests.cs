...
namespace NAnt.Core.Tests
{
	...
	public class TaskTests
	{
		...
		public void ScriptTaskTest()
		{
			...
			PackageMap.Instance.SetBuildRoot(project, TestUtil.CreateTestDirectory("scripttest")); // required for visual package init, needed for script compiler, we don't expect anything to be written there
			{
