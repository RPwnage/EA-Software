...
namespace EA.FrameworkTasks.Model
{
	...
	{
		public Configuration(string name, string system, string compiler, string platform, string type, string processor="")
		{
			Name = name;
			System = system;
			Compiler = compiler;
		...
		/// Variation (spu, etc)
		/// </summary>
		public readonly string SubSystem = String.Empty; // Deprecated: left for a small amount of temporary backward compatibility
		/// <summary>
		/// Compiler
		/// </summary>
