      ...
      mLoginParameters(nullptr)
{
    ...
    getActions().add(&getActionConnectAndLogin());
...
void Connection::onDisconnected()
{
    ...
    getActionConnectAndLogin().setIsVisible(true);
...
void Connection::initActionConnectAndLogin(Pyro::UiNodeAction &action)
{
    action.setText("Connect and Login");
    action.setDescription("Connect to the Blaze server and login");
...
void Connection::actionConnectAndLogin(Pyro::UiNodeAction *action, Pyro::UiNodeParameterStructPtr parameters)
{
