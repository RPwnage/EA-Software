/*************************************************************************************************/
/*!
    \file   fifah2horganizedtournamentreportslave.h
...
#ifndef BLAZE_CUSTOM_FIFAH2HORGANIZEDTOURNAMENT_REPORT_SLAVE_H
#define BLAZE_CUSTOM_FIFAH2HORGANIZEDTOURNAMENT_REPORT_SLAVE_H
...
/*!
    class FifaH2HOrganizedTournamentReportSlave
*/
class FifaH2HOrganizedTournamentReportSlave: public FifaH2HBaseReportSlave
{
public:
	FifaH2HOrganizedTournamentReportSlave(GameReportingSlaveImpl& component);
    static GameReportProcessor* create(GameReportingSlaveImpl& component);

    virtual ~FifaH2HOrganizedTournamentReportSlave();
...
#endif  // BLAZE_CUSTOM_FIFAH2HORGANIZEDTOURNAMENT_REPORT_SLAVE_H
