    ...
    *************************************************************************************************/
    ...
    public:
        ...
        GameBrowserList(GameBrowser& gameBrowser, GameBrowserListId gameBrowserListId, ListType listType, 
            ...
            UserSessionId ownerSessionId, uint32_t msgNum = 0);
        ...
        *************************************************************************************************/
        ...
        /*! ************************************************************************************************/
        /*! \brief returns the UserSessionId of the user who owns the list
        *************************************************************************************************/
        ...
        *************************************************************************************************/
        ...
        bool sendListUpdateNotifications(uint32_t maxGameUpdatesPerNotification, uint32_t maxListUpdateNotifications, GameBrowser::NotifyGameListReason notifyReason, uint32_t msgNum=0);
        ...
        *************************************************************************************************/
        uint32_t getListCreateMsgNum() const { return mMsgNum; }
    ...
    private:
        ...
        // create list rpc's message number
        uint32_t mMsgNum;
    ...
    public:
        UserSetGameBrowserList(GameBrowser& gameBrowser, GameBrowserListId gameBrowserListId,
            ...
            TimeValue maxUpdateInterval, UserSessionId ownerSessionId, uint32_t msgNum)
            : GameBrowserList(gameBrowser, gameBrowserListId, GAME_BROWSER_LIST_SUBSCRIPTION, listConfigName, gameBrowser.getUserSetListCapacity(), maxUpdateInterval, ownerSessionId, msgNum),
