/*! ************************************************************************************************/
/*!
    \file   totalplayerslotsruledefinition.h
...
#ifndef BLAZE_MATCHMAKING_TOTAL_PLAYER_SLOTS_RULE_DEFINITION
#define BLAZE_MATCHMAKING_TOTAL_PLAYER_SLOTS_RULE_DEFINITION
...
namespace Matchmaker
{
    ...
    /*! ************************************************************************************************/
    /*!
        \brief The rule definition for a matchmaking session's desired total slots.
        ...
        The TotalPlayerSlotsRule prioritizes matches via a fitPercent with a fit formula function that's clipped by min/max values
        (E.g. see http://en.wikipedia.org/wiki/Gaussian_function).  For Gaussian, instead of specifying the variance of the curve,
        we specify the 'fiftyPercentFitValueDifference'.  This is the totalPlayerSlots difference that produces a 50% fit,
    ...
    ***************************************************************************************************/
    class TotalPlayerSlotsRuleDefinition : public RuleDefinition
    {
        NON_COPYABLE(TotalPlayerSlotsRuleDefinition);
        DEFINE_RULE_DEF_H(TotalPlayerSlotsRuleDefinition, TotalPlayerSlotsRule);

    public:
        static const char8_t* TOTALPLAYERSLOTSRULE_CAPACITY_RETE_KEY;

        TotalPlayerSlotsRuleDefinition();

        ~TotalPlayerSlotsRuleDefinition() override;
        ...
        /*! ************************************************************************************************/
        /*!
            \brief given two desired total slots values, determine the difference, and plug that value into
                the fit formula function, returning a fitPercent between 0 and 1.
    ...
    private:
        TotalPlayerSlotsRuleConfig mTotalPlayerSlotsRuleConfigTdf;
...
#endif // BLAZE_MATCHMAKING_TOTAL_PLAYER_SLOTS_RULE_DEFINITION
