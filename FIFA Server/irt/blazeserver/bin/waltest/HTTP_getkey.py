...
comp = unitTest.ComponentTest("authentication",hostname,port,None,0,verbose);

# Run expressLogin
cmd = unitTest.CommandTest("expressLogin","GET","expressLogin?mail=geoffreyh@ea.com&pass=geoff");
