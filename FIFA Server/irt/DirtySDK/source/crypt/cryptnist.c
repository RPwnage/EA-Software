...
/*F********************************************************************************/
/*!
    \Function CryptNistCleanupDh

    \Description
        Cleanup the DH state
...
*/
/********************************************************************************F*/
void CryptNistCleanupDh(CryptNistDhT *pState)
{
    if (pState->Ecc.pTable == NULL)
    {
        return;
    }
    DirtyMemFree(pState->Ecc.pTable, CRYPTNIST_MEMID, pState->Ecc.iMemGroup, pState->Ecc.pMemGroupUserdata);
    pState->Ecc.pTable = NULL;
}
...
/*F********************************************************************************/
/*!
    \Function CryptNistCleanupDsa

    \Description
        Cleanup the DSA state
...
*/
/********************************************************************************F*/
void CryptNistCleanupDsa(CryptNistDsaT *pState)
{
    if (pState->Ecc.pTable == NULL)
    {
        return;
