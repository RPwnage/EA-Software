...
namespace GameManager
{
    ...
    public:
        ...
        static void buildMatchJoinForFailedUserSessionInfo(const GameManager::StartMatchmakingInternalRequest& internalRequest, const GameManager::UserJoinInfo& initiatorJoinInfo,
