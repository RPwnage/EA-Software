...
static int32_t _NetTimeStamp(char *pBuffer, int32_t iLen)
{
    ...
    if (_NetLib_bEnableTimeStamp == TRUE)
    {
        ...
        iTimeStampLen = ds_snzprintf(pBuffer, iLen,"%d/%02d/%02d-%02d:%02d:%02d.%03.3d%+03d ", tm.tm_year + 1900, tm.tm_mon + 1, tm.tm_mday, tm.tm_hour, tm.tm_min, tm.tm_sec, iMsec, iGmtOffset);
    }
