...
// set extended event notification callback
DIRTYCODE_API void VoipGroupSetEventCallbackEx(VoipGroupRefT *pVoipGroup, VoipCallbackExT *pCallbackEx, void *pUserData);
...
// connect to a peer
DIRTYCODE_API int32_t VoipGroupConnect(VoipGroupRefT *pVoipGroup, int32_t iConnId, uint32_t uAddress, uint32_t uManglePort, uint32_t uGamePort, uint32_t uClientId, uint32_t uSessionId, uint8_t bIsConnectivityHosted, uint32_t uRemoteLowLevelConnectivityId, uint32_t uLocalLowLevelConnectivityId);

// listen for connections
DIRTYCODE_API int32_t VoipGroupListen(VoipGroupRefT *pVoipGroup, uint32_t uListenPort);
...
// return information about remote peer
DIRTYCODE_API int32_t VoipGroupRemoteUserStatus2(VoipGroupRefT *pVoipGroup, int32_t iConnID, int32_t iRemoteUserIndex, int32_t *pFirstPartyChatIndicator);
...
// VoipLocalUserStatus2, through a VoipGroup
DIRTYCODE_API int32_t VoipGroupLocalUserStatus2(VoipGroupRefT *pVoipGroup, int32_t iLocalUserIndex, int32_t *pFirstPartyChatIndicator);
