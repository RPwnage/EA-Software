...
// do nothing
    ...
    #define DIRTYCODE_PS4           1
        ...
        #define DIRTYCODE_PS4_CROSSGEN 1
    #endif
...
//For Building as a dll
    ...
    #else 
        #define DIRTYCODE_API __attribute__ ((visibility("default")))
    #endif
 #endif
#else
...
DIRTYCODE_API int32_t ds_gmtoffset(void);
...
DIRTYCODE_API uint8_t *ds_fmtoctstring2(uint8_t *pOutput, int32_t iOutLen, const char *pInput, int32_t iInpLen);
