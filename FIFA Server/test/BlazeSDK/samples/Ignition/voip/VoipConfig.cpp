...
void VoipConfig::onAuthenticatedPrimaryUser()
{
    ...
    getActionToggleLoopback().getParameters().addBool("forTextChat", false, "For Text Chat", "", Pyro::ItemVisibility::ADVANCED);
...
void VoipConfig::actionToggleLoopback(Pyro::UiNodeAction *action, Pyro::UiNodeParameterStructPtr parameters)
{
    ...
    bool bForTextChat = parameters["forTextChat"];
    ...
    VoipControl(pVoip, bForTextChat ? 'txta' : 'loop', bValue, nullptr);
