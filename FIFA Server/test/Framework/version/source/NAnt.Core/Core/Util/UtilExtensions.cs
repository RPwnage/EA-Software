...
namespace NAnt.Core.Util
{
	public static class UtilExtensions
	{
		...
		public static void AddIfTrue(this IDictionary<string, string> target, string name, bool value)
		{
			if (target != null && value)
			{
				target.Add(name, value.ToString().ToLowerInvariant());
			}
		}

		public static void Add(this IDictionary<string, string> target, string name, bool value)
		{
			if (target != null)
			{
				target.Add(name, value.ToString().ToLowerInvariant());
...
#if NETFRAMEWORK
		public static string GetValueOrDefault(this IDictionary<string, string> target, string key, string default_value)
		{
			return target.ContainsKey(key) ? target[key] : default_value;
		}
#endif
