...
namespace NAnt.Core.Functions
{
	...
	public class PathFunctions : FunctionClassBase
	{
		...
		/// <include file='Examples/Path/PathToUnix.example' path='example'/>  
		[Function()]
		public static string PathToNativeOS(Project project, string path)
		{
			switch (PlatformUtil.Platform)
			{
				case PlatformUtil.Unix:
				case PlatformUtil.OSX:
					return PathToUnix(project, path);
				case PlatformUtil.Windows:
					return PathToWindows(project, path);
				default:
					return path;
			}
		}
		...
		[Function()]
		public static string PathToWsl(Project project, string path)
		{
			return PathUtil.PathToWsl(path);
		}
		...
		/// <include file='Examples/Path/PathGetRandomFileName.example' path='example'/>
		[Function()]
		public static string PathGetRandomFileName(Project project)
		{
