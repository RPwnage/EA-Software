...
namespace NAnt.Core.PackageCore
{
	public sealed partial class MasterConfig
	{
		...
		public class ConfigInfo
		{
			...
			public ConfigInfo(string package = null, string defaultConfig = null, string includes = "", string excludes = "", List<ConfigExtension> extensions = null)
			{
		...
		public bool OnDemand { get { return m_onDemand == null ? false : (bool)m_onDemand; } }
		public bool PackageServerOnDemand { get { return m_packageServerOnDemand == null ? true : (bool)m_packageServerOnDemand; } }
		...
		public static MasterConfig Load(Project project, string filePath, List<string> customFragments = null)
		{
			...
			MasterConfig loadedMC = loader.Load(filePath);
