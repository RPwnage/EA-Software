...
namespace EA.Eaconfig.Structured
{
	...
	[ElementName("elementwithcondition", StrictAttributeCheck = true, Mixed = false, NestedElementsCheck = false)]
	public class ElementWithCondition : Element
	{
		bool _ifDefined = true;
		bool _unlessDefined = false;

		public ElementWithCondition()
			: base()
		{
		}
