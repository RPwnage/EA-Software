...
namespace EA.Eaconfig
{
	...
	public class Combine : EAConfigTask
	{
		...
		private void SetDefaultOptionsIfMissing()
		{
			...
			string[] managedExeNames = { "windowsprogram", "managedcppprogram", "managedcppwindowsprogram", "csharpprogram", "csharpwindowsprogram", "fsharpprogram", "fsharpwindowsprogram", "winrtcppprogram" };
			string[] managedLibraryNames = { "managedcppassembly", "csharplibrary", "fsharplibrary", "winrtcpplibrary", "winrtcppdynamiclibrary" };
