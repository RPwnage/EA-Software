---
title: < SPUProgram > Task
weight: 1231
---
## Syntax
```xml
<SPUProgram outputdir="" outputname="" debug="" comment="" name="" group="" frompartial="" buildtype="">
...
## Full Syntax
```xml
<SPUProgram outputdir="" outputname="" debug="" comment="" name="" group="" frompartial="" buildtype="" failonerror="" verbose="" if="" unless="">
