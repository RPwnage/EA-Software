...
namespace NAnt.Core.Attributes
{
	...
	public class XmlElementAttribute : Attribute
	{
		...
		public ContainerType Container { get; set; } = ContainerType.None;
		...
		{
			return (Container & ContainerType.Container) != 0 || (Container & ContainerType.ConditionalContainer) != 0;
		}

		public bool IsConditionalContainer()
		{
			return (Container & ContainerType.ConditionalContainer) != 0;
		}


		public bool IsRecursive()
		{
			return (Container & ContainerType.Recursive) != 0;
		}
