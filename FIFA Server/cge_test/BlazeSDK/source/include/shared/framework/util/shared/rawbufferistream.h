...
private:
    ...
    EA::IO::off_type GetPosition(EA::IO::PositionType positionType = EA::IO::kPositionTypeEnd) const override { return (EA::IO::off_type) (mBuf.size()); }
    bool SetPosition(EA::IO::off_type position, EA::IO::PositionType positionType = EA::IO::kPositionTypeEnd) override
    {
        ...
        mBuf.put((size_t)(position)); // Set the tail to the new position relative to the head
        return true;
    }
