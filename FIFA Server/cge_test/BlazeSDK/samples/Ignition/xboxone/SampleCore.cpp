...
#include "ProtocolActivation.h" // for ProtocolActivationInfo in OnActivated
...
#if defined(EA_PLATFORM_XBOXONE) && (_XDK_VER >= __XDK_VER_2015_MP)
    if (args->Kind == Windows::ApplicationModel::Activation::ActivationKind::Protocol)
    {
        // parse the activation url
        IProtocolActivatedEventArgs^ proArgs = static_cast< IProtocolActivatedEventArgs^>(args);
        if (!Ignition::ProtocolActivationInfo::initProtocolActivation(proArgs))
        {
...
*/
/********************************************************************************F*/
void Ignition::SampleRenderer::Initialize()
{
...
*/
/********************************************************************************F*/
void Ignition::SampleRenderer::InitializePipeline()
{
...
*/
/********************************************************************************F*/
void Ignition::SampleRenderer::InitializeGraphics()
{
...
*/
/********************************************************************************F*/
void Ignition::SampleRenderer::Render()
{
