...
#ifndef BLAZE_CUSTOM_FIFACLUBREPORT_SLAVE_H
#define BLAZE_CUSTOM_FIFACLUBREPORT_SLAVE_H
...
/*!
    class FifaClubReportSlave
*/
class FifaClubReportSlave: public FifaClubBaseReportSlave
{
public:
    FifaClubReportSlave(GameReportingSlaveImpl& component);
    static GameReportProcessor* create(GameReportingSlaveImpl& component);

    virtual ~FifaClubReportSlave();
...
private:
	...
	ClubEloExtension			mEloRpgHybridSkillExtension;
	...
	ClubsLastOpponent			mClubsLastOpponentExtension;

	FifaClubTagUpdater          mFifaClubsTagUpdater;
};
...
#endif  // BLAZE_CUSTOM_FIFACLUBREPORT_SLAVE_H
