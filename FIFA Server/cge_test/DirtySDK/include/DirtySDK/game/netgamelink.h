...
typedef struct NetGameLinkStatT
{
    ...
    uint32_t jitter;        //!< inter-packet delay variation (currently involving sync packets only, flowing twice a second)
    ...
    uint32_t lnaksent;      //!< number of NAKs sent to peer since start
